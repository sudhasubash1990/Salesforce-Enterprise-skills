...
keywords: [issue log template]
tags: ['issue-log']
template-id: issue-log
...
| ID | Description | Severity | Status | Resolution | Owner | Target date |
...
- **Previous:** [Go Live Checklist Template](go-live-checklist-template.md)
