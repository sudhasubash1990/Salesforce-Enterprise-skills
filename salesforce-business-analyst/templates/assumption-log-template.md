...
keywords: [assumption log template]
tags: ['assumption-log']
template-id: assumption-log
...
| ID | Assumption | Validation method | Owner | Review date | Status |
...
- **Previous:** [Api Catalogue Template](api-catalogue-template.md)
