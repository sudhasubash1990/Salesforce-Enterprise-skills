...
keywords: [decision log template]
tags: ['decision-log']
template-id: decision-log
...
| ID | Decision | Rationale | Alternatives | Date | Owner | Impact |
|----|----------|-----------|--------------|------|-------|--------|
...
- **Previous:** [Data Dictionary Template](data-dictionary-template.md)
- **Next:** [Dependency Log Template](dependency-log-template.md)
