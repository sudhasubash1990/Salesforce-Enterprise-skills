...
keywords: [risk register template]
tags: ['risk-register']
...
| ID | Description | Probability | Impact | Severity | Mitigation | Contingency | Owner | Status |
...
- **Previous:** [Raid Log Template](raid-log-template.md)
- **Next:** [Rtm Template](rtm-template.md)
