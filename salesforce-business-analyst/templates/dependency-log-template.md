...
keywords: [dependency log template]
tags: ['dependency-log']
template-id: dependency-log
...
| ID | Dependency | Type | Critical path | Owner | Needed by | Status |
...
- **Previous:** [Decision Log Template](decision-log-template.md)
- **Next:** [Deployment Checklist Template](deployment-checklist-template.md)
