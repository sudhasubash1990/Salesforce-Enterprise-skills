...
keywords: [data dictionary template]
tags: ['data-dictionary']
template-id: data-dictionary
...
| Object | Field | Description | Type | Source | Validation | Owner |
...
- **Previous:** [Current State Template](current-state-template.md)
- **Next:** [Decision Log Template](decision-log-template.md)
