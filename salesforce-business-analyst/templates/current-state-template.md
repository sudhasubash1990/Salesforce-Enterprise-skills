...
keywords: [current state template]
tags: ['current-state']
template-id: current-state
...
- **Previous:** [Competency Assessment Template](competency-assessment-template.md)
- **Next:** [Data Dictionary Template](data-dictionary-template.md)
