...
keywords: [solution scope template]
tags: ['solution-scope']
template-id: solution-scope
...
- **Previous:** [Rtm Template](rtm-template.md)
- **Next:** [Stakeholder Matrix Template](stakeholder-matrix-template.md)
