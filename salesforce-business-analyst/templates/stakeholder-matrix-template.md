...
category: Template
document_type: Stakeholder Matrix
version: 0.4.0
...
keywords: [stakeholder matrix template]
tags: ['stakeholder-matrix']
template-id: stakeholder-matrix
...
- **Previous:** [Solution Scope Template](solution-scope-template.md)
- **Next:** [Traceability Matrix Template](traceability-matrix-template.md)
