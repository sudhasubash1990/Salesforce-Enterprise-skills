...
keywords: [api catalogue template]
tags: ['api-catalogue']
template-id: api-catalogue
...
Standardized enterprise deliverable scaffold for Salesforce BA programs.

## When to Use

When producing this artifact type during discovery, design, delivery, or governance.

## Intended Audience

BA, architect, integration
...
| API | Purpose | Method | Auth | Source | Target | Error handling |
...
- **Previous:** [Acceptance Criteria Template](acceptance-criteria-template.md)
- **Next:** [Assumption Log Template](assumption-log-template.md)
