...
category: Template
document_type: Go-Live Checklist
version: 0.4.0
...
keywords: [go live checklist template]
tags: ['go-live-checklist']
template-id: go-live-checklist
...
- **Previous:** [Future State Template](future-state-template.md)
- **Next:** [Issue Log Template](issue-log-template.md)
