...
keywords: [discovery workshop playbook]
...
- Execute discovery workshop with consistent quality and governance
...
Initiate engagement; identify stakeholders; define objectives and scope.
...
4. MoSCoW draft
5. Close with decisions

## Deliverables

| Discovery summary | Stakeholder list | Initial scope | Objectives | RAID |
...
- **Previous:** [Discovery Playbook](discovery-playbook.md)
