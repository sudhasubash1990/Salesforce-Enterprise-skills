...
keywords: [executive presentation playbook]
tags: ['executive']
...
- Execute executive presentation with consistent quality and governance
...
Prepare executive messaging and decision requests.
...
| Executive deck | Decision summary | Actions |
...
- **Next:** [Fit Gap Analysis](fit-gap-analysis.md)
