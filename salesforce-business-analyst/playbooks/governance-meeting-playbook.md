...
keywords: [governance meeting playbook]
tags: ['governance']
...
- Execute governance meeting with consistent quality and governance
...
Run architecture/governance forum.
...
- **Previous:** [Gap Analysis Playbook](gap-analysis-playbook.md)
- **Next:** [Production Readiness Playbook](production-readiness-playbook.md)
