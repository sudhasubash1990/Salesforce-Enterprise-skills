...
keywords: [gap analysis playbook]
tags: ['fit-gap', 'gap']
...
- Execute gap analysis with consistent quality and governance
...
AS-IS vs TO-BE gap and fit-gap classification.
...
| Gap list | Fit-gap matrix | Recommendations |
...
- **Previous:** [Fit Gap Analysis](fit-gap-analysis.md)
- **Next:** [Governance Meeting Playbook](governance-meeting-playbook.md)
