...
keywords: [solution recommendation playbook]
...
- Execute solution recommendation with consistent quality and governance
...
Options analysis and Salesforce recommendation.
...
| Recommendation report | Decision matrix | Roadmap |
...
- **Previous:** [Requirements Elicitation](requirements-elicitation.md)
- **Next:** [Sprint Planning Playbook](sprint-planning-playbook.md)
