...
keywords: [backlog grooming playbook]
...
- Execute backlog grooming with consistent quality and governance
...
Refine backlog ordering and story readiness.

## Detailed Activities

1. Review epic map
2. Split large stories
3. Update WSJF/MoSCoW

## Deliverables

| Refined backlog | Split stories | Priority updates |
...
- **Next:** [Business Capability Assessment Playbook](business-capability-assessment-playbook.md)
