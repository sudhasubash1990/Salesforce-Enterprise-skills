...
keywords: [value stream mapping playbook]
tags: ['value-stream']
...
- Execute value stream mapping with consistent quality and governance
...
End-to-end value stream and waste identification.
...
| VSM diagram | Improvements | KPI baseline |
...
- **Previous:** [Uat Playbook](uat-playbook.md)
