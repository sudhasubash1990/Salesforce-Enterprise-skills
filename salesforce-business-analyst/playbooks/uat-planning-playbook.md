...
keywords: [uat planning playbook]
tags: ['uat', 'testing']
...
- Execute uat planning with consistent quality and governance
...
Plan business UAT scope, data, and sign-off.

## Detailed Activities

1. Map RTM
2. Draft scenarios
3. Schedule business testers

## Deliverables

| UAT plan | Scenarios | Entry/exit | Sign-off template |
...
- **Previous:** [Story Refinement Playbook](story-refinement-playbook.md)
- **Next:** [Uat Playbook](uat-playbook.md)
