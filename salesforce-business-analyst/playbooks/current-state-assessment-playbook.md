...
keywords: [current state assessment playbook]
tags: ['as-is', 'discovery']
...
- Execute current state assessment with consistent quality and governance
...
Document AS-IS processes and systems.
...
| AS-IS maps | Pain list | Systems landscape |
...
- **Next:** [Discovery Playbook](discovery-playbook.md)
