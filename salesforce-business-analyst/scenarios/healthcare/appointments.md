...
tags: [healthcare, appointments, scenario]
business-domain: appointments
...
Synthetic healthcare scenario: Healthcare Appointments.
...
**EP-202 Scheduling** — measurable business outcome.
...
**US-202 As patient I want book appointment online**

## Acceptance Criteria

**Given slot When book Then confirmation sent**
...
- **Previous:** —
- **Next:** [Care Management](care-management.md)
