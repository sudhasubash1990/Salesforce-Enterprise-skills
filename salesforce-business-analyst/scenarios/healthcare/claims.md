...
keywords: [claims]
tags: [healthcare, claims, scenario]
business-domain: claims
salesforce-cloud: Health Cloud, Platform
...
Synthetic healthcare scenario: Healthcare Claims.
...
Faster adjudication visibility
...
**EP-203 Claims** — measurable business outcome.
...
**US-203 As member I want claim status**

## Acceptance Criteria

**Given claim filed When update Then portal shows status**
...
- **Previous:** [Care Management](care-management.md)
- **Next:** [Patient Onboarding](patient-onboarding.md)
