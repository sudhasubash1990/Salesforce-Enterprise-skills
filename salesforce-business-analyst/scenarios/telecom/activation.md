...
keywords: [activation]
tags: [telecom, activation, scenario]
business-domain: activation
...
Synthetic telecom scenario: Telecom Activation.
...
**EP-402 Activation** — measurable business outcome.
...
**US-402 As ops I want activation status**

## Acceptance Criteria

**Given order When paid Then activate**
