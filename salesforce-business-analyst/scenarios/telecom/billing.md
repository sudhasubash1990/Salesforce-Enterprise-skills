...
keywords: [billing]
tags: [telecom, billing, scenario]
business-domain: billing
salesforce-cloud: Service Cloud, Revenue Cloud
...
Synthetic telecom scenario: Telecom Billing.
...
Usage, rating, billing integration
...
**EP-404 Billing** — measurable business outcome.
...
**US-404 As customer I want usage on bill**

## Acceptance Criteria

**Given cycle When close Then usage rated**
...
- **Next:** [Order Capture](order-capture.md)
