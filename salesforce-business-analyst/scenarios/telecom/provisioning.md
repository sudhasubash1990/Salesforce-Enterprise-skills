...
tags: [telecom, provisioning, scenario]
business-domain: provisioning
salesforce-cloud: Platform, MuleSoft pattern
...
Synthetic telecom scenario: Telecom Provisioning.
...
**EP-403 Provision** — measurable business outcome.
...
**US-403 As provisioner I want work order to OSS**

## Acceptance Criteria

**Given activation When trigger Then OSS job created**
...
- **Previous:** [Order Capture](order-capture.md)
- **Next:** —
