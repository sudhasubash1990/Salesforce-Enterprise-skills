...
tags: [telecom, order capture, scenario]
business-domain: order capture
...
Synthetic telecom scenario: Telecom Order Capture.
...
Product catalog, order validation

## Business Objectives

Order fallout reduction
...
**EP-401 Order** — measurable business outcome.
...
**US-401 As sales I want configure bundle**

## Acceptance Criteria

**Given catalog When select Then price calculated**
...
- **Previous:** [Billing](billing.md)
- **Next:** [Provisioning](provisioning.md)
