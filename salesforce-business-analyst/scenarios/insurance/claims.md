...
keywords: [claims]
tags: [insurance, claims, scenario]
business-domain: claims
salesforce-cloud: Service Cloud, Industries Cloud
...
Synthetic insurance scenario: Insurance Claims Management.
...
Investigation, adjustment, payment
...
**EP-303 Claims** — measurable business outcome.
...
**US-303 As adjuster I want task queue**

## Acceptance Criteria

**Given claim When assign Then tasks created**
