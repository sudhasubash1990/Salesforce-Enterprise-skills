...
keywords: [fnol]
tags: [insurance, fnol, scenario]
business-domain: fnol
salesforce-cloud: Service Cloud, Experience Cloud
...
Synthetic insurance scenario: Insurance FNOL.
...
**EP-302 FNOL** — measurable business outcome.
...
**US-302 As policyholder I want file claim online**

## Acceptance Criteria

**Given incident When submit FNOL Then claim created**
...
- **Next:** [Quote To Bind](quote-to-bind.md)
