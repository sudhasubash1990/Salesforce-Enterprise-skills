...
tags: [insurance, underwriting, scenario]
business-domain: underwriting
salesforce-cloud: Industries Cloud, Platform
...
Synthetic insurance scenario: Insurance Underwriting.
...
Risk evaluation, rules, referral
...
**EP-304 UW** — measurable business outcome.
...
**US-304 As underwriter I want risk dashboard**

## Acceptance Criteria

**Given submission When rules pass Then auto-approve**
...
- **Previous:** [Quote To Bind](quote-to-bind.md)
- **Next:** —
