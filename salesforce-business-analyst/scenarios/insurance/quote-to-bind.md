...
keywords: [quote to bind]
tags: [insurance, quote to bind, scenario]
business-domain: quote to bind
salesforce-cloud: Sales Cloud, Industries Cloud
review-cycle: semi-annual
implementation-size: enterprise
---

# Insurance Quote to Bind

## Executive Summary

Synthetic insurance scenario: Insurance Quote to Bind.
...
**EP-301 Quote-Bind** — measurable business outcome.
...
**US-301 As agent I want generate quote**

## Acceptance Criteria

**Given risk data When rate Then premium shown**
...
- **Previous:** [Fnol](fnol.md)
- **Next:** [Underwriting](underwriting.md)
