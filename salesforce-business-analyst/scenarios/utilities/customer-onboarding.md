---
title: Utilities Customer Onboarding
...
keywords: [customer onboarding]
tags: [utilities, customer onboarding, scenario]
business-domain: customer onboarding
salesforce-cloud: Service Cloud, Experience Cloud, Platform
review-cycle: semi-annual
implementation-size: enterprise
---

# Utilities Customer Onboarding

## Executive Summary

Synthetic utilities scenario: Utilities Customer Onboarding.
...
Customer registration, property validation, meter assignment, welcome comms

## Business Objectives

Reduce onboarding time 30%
...
**EP-001 Onboarding** — measurable business outcome.
...
**US-001 As a new customer I want to complete registration online so that service starts on time**

## Acceptance Criteria

**Given valid address When submit Then account created**
...
- **Previous:** [Complaints](complaints.md)
- **Next:** [Field Service](field-service.md)
