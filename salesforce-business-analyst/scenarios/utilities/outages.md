...
keywords: [outages]
tags: [utilities, outages, scenario]
business-domain: outages
salesforce-cloud: Service Cloud, Experience Cloud, Marketing Cloud
...
Synthetic utilities scenario: Utilities Outages.
...
Incident, impact, comms, restoration
...
**EP-006 Outages** — measurable business outcome.
...
**US-006 As customer I want outage notifications**

## Acceptance Criteria

**Given outage When registered Then SMS sent**
...
- **Previous:** [Meter To Cash](meter-to-cash.md)
- **Next:** —
