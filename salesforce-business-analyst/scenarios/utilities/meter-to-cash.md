...
keywords: [meter to cash]
tags: [utilities, meter to cash, scenario]
business-domain: meter to cash
salesforce-cloud: Service Cloud, Revenue Cloud, Platform
...
Synthetic utilities scenario: Utilities Meter-to-Cash.
...
Meter read through billing and payment
...
**EP-002 Meter-to-Cash** — measurable business outcome.
...
**US-002 As billing ops I want validated reads ingested so that bills are accurate**

## Acceptance Criteria

**Given estimated read When actual received Then bill recalculated**
...
- **Previous:** [Field Service](field-service.md)
- **Next:** [Outages](outages.md)
