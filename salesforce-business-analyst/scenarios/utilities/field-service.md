...
tags: [utilities, field service, scenario]
business-domain: field service
salesforce-cloud: Field Service, Service Cloud
...
Synthetic utilities scenario: Utilities Field Service.
...
Work orders, dispatch, mobile workforce

## Business Objectives

First-time fix rate up
...
**EP-005 Field Service** — measurable business outcome.
...
**US-005 As dispatcher I want optimized schedule**

## Acceptance Criteria

**Given emergency When dispatch Then nearest tech assigned**
...
- **Previous:** [Customer Onboarding](customer-onboarding.md)
- **Next:** [Meter To Cash](meter-to-cash.md)
