...
tags: [utilities, collections, scenario]
business-domain: collections
salesforce-cloud: Service Cloud, Platform
...
Synthetic utilities scenario: Utilities Collections.
...
**EP-007 Collections** — measurable business outcome.
...
**US-007 As agent I want payment plan offers**

## Acceptance Criteria

**Given overdue When contact Then plan options shown**
