...
keywords: [complaints]
tags: [utilities, complaints, scenario]
business-domain: complaints
salesforce-cloud: Service Cloud, Omni-Channel
...
Synthetic utilities scenario: Utilities Complaints.
...
Complaint intake, investigation, SLA, escalation
...
**EP-004 Complaints** — measurable business outcome.
...
**US-004 As customer I want to log complaint and track status**

## Acceptance Criteria

**Given complaint submitted When SLA breached Then escalate**
...
- **Next:** [Customer Onboarding](customer-onboarding.md)
