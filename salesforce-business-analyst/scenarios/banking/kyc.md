...
keywords: [kyc]
tags: [banking, kyc, scenario]
business-domain: kyc
salesforce-cloud: Financial Services Cloud, Platform
...
Synthetic banking scenario: Banking KYC.
...
Customer verification, AML screening
...
|------------|------------|
| Core process | Financial Services Cloud |
...
**EP-501 KYC** — measurable business outcome.
...
**US-501 As onboarding I want KYC checklist**

## Acceptance Criteria

**Given applicant When docs uploaded Then screening started**
...
- **Previous:** [Credit](credit.md)
- **Next:** [Loan Origination](loan-origination.md)
