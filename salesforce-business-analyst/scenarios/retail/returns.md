...
keywords: [returns]
tags: [retail, returns, scenario]
business-domain: returns
salesforce-cloud: Service Cloud, Commerce Cloud
...
Synthetic retail scenario: Retail Returns.
...
**EP-102 Returns** — measurable business outcome.
...
**US-102 As customer I want return label online**

## Acceptance Criteria

**Given return initiated When received Then refund in 3 days**
...
- **Previous:** [Promotions](promotions.md)
- **Next:** —
