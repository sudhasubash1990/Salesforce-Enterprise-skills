...
tags: [retail, order management, scenario]
business-domain: order management
salesforce-cloud: Commerce Cloud, Service Cloud, Platform
...
Synthetic retail scenario: Retail Order Management.
...
Omnichannel order capture and fulfillment
...
**EP-101 OMS** — measurable business outcome.
...
**US-101 As shopper I want buy online pickup in store**

## Acceptance Criteria

**Given order placed When ready Then notify customer**
...
- **Previous:** [Loyalty](loyalty.md)
- **Next:** [Promotions](promotions.md)
