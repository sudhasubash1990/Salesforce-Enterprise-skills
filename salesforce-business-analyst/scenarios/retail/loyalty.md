...
keywords: [loyalty]
tags: [retail, loyalty, scenario]
business-domain: loyalty
salesforce-cloud: Marketing Cloud, Sales Cloud
...
Synthetic retail scenario: Retail Loyalty.
...
**EP-103 Loyalty** — measurable business outcome.
...
**US-103 As member I want see points balance**

## Acceptance Criteria

**Given purchase When complete Then points credited**
...
- **Previous:** [Inventory](inventory.md)
