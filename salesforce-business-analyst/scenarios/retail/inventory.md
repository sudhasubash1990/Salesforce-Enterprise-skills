---
title: Retail Inventory Visibility
...
keywords: [inventory]
tags: [retail, inventory, scenario]
business-domain: inventory
salesforce-cloud: Commerce Cloud, Data Cloud
...
Synthetic retail scenario: Retail Inventory Visibility.
...
**EP-105 Inventory** — measurable business outcome.
...
**US-105 As associate I want real-time stock**

## Acceptance Criteria

**Given SKU When query Then ATP returned**
