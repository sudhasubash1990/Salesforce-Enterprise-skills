...
keywords: [promotions]
tags: [retail, promotions, scenario]
business-domain: promotions
salesforce-cloud: Marketing Cloud, Commerce Cloud
...
Synthetic retail scenario: Retail Promotions.
...
**EP-104 Promotions** — measurable business outcome.
...
**US-104 As marketer I want segment promotions**

## Acceptance Criteria

**Given segment When campaign runs Then offer applied**
...
- **Previous:** [Order Management](order-management.md)
- **Next:** [Returns](returns.md)
