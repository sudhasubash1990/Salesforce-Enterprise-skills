...
keywords: [test-data-strategy, template, documentation-generator]
tags: [template, sprint-5]
---

# Test Data Strategy

**Template ID:** TPL-TEST_DATA_STRATEGY  
...
Define test data approach: synthetic vs masked, personas, referential integrity, refresh.

## Business Context

Before major SIT/UAT; update when data model changes materially.
...
**Primary owner:** Test Lead / Data Lead (QE)

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before major SIT/UAT; update when data model changes materially. |
...
1. Author (Test Lead / Data Lead (QE)) → draft complete  
...
- [Test Data Request](test-data-request.md)
- [Environment Readiness Checklist](environment-readiness-checklist.md)
...
**Test Data Strategy** — Project PRJ-XXX | Sprint/Release N | Status: Draft
