...
keywords: [defect-rca-report, template, documentation-generator]
tags: [template, sprint-5]
---

# Defect RCA Report

**Template ID:** TPL-DEFECT_RCA_REPORT  
**Lifecycle phase:** Execute / Hypercare / Improve  
...
Root cause analysis for escaped or high-impact defects.

## Business Context

For production escapes, Critical defects, or recurring failure patterns.
...
**Primary owner:** Test Lead + Dev Lead

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | For production escapes, Critical defects, or recurring failure patterns. |
| **Owner** | Test Lead + Dev Lead |
| **Reviewers** | BA, SA (as applicable), Delivery Lead |
| **Approvers** | Delivery Lead / Release Manager |
| **Project phase** | Execute / Hypercare / Improve |
...
1. Author (Test Lead + Dev Lead) → draft complete  
...
**Defect RCA Report** — Project PRJ-XXX | Sprint/Release N | Status: Draft
