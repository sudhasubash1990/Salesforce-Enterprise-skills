...
keywords: [test-estimation-sheet, template, documentation-generator]
tags: [template, sprint-5]
---

# Test Estimation Sheet

**Template ID:** TPL-TEST_ESTIMATION_SHEET  
...
Capture estimation inputs (T-shirt / relative sizing)—not false precision hours as story points.

## Business Context

During planning/refinement for test effort inputs.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | During planning/refinement for test effort inputs. |
| **Owner** | Test Lead |
...
- Completed Test Estimation Sheet
...
**Test Estimation Sheet** — Project PRJ-XXX | Sprint/Release N | Status: Draft
