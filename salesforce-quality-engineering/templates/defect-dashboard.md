...
keywords: [defect-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Defect Dashboard

**Template ID:** TPL-DEFECT_DASHBOARD  
...
Defect aging, severity mix, reopen rate dashboard standard.

## Business Context

Throughout execution and hypercare.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Throughout execution and hypercare. |
| **Owner** | Test Lead |
...
**Defect Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
