...
keywords: [uat-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# UAT Checklist

**Template ID:** TPL-UAT_CHECKLIST  
**Lifecycle phase:** UAT  
...
UAT readiness and execution support checklist (partner with BA UAT process).

## Business Context

Before UAT entry and during UAT execution.
...
**Primary owner:** UAT Coordinator / Test Lead

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before UAT entry and during UAT execution. |
...
1. Author (UAT Coordinator / Test Lead) → draft complete  
...
**UAT Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
