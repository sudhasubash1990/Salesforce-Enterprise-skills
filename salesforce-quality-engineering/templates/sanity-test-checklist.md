...
keywords: [sanity-test-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Sanity Test Checklist

**Template ID:** TPL-SANITY_TEST_CHECKLIST  
...
Narrow confirmation around a specific change set.

## Business Context

After targeted fixes or small changes when full regression is not justified.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | After targeted fixes or small changes when full regression is not justified. |
| **Owner** | Tester |
...
- Completed Sanity Test Checklist
...
**Sanity Test Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
