...
keywords: [coverage-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Coverage Dashboard

**Template ID:** TPL-COVERAGE_DASHBOARD  
...
Requirement/scenario/case coverage dashboard aligned to RTM.

## Business Context

When coverage governance is required.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | When coverage governance is required. |
| **Owner** | Test Lead |
...
**Coverage Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
