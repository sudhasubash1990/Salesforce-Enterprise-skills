...
keywords: [lessons-learned, template, documentation-generator]
tags: [template, sprint-5]
---

# Lessons Learned

**Template ID:** TPL-LESSONS_LEARNED  
**Lifecycle phase:** Close / Improve  
...
Capture what worked, what failed, and actions for the next release/program.

## Business Context

After release or major incident RCA cycle.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | After release or major incident RCA cycle. |
| **Owner** | Test Manager |
| **Reviewers** | BA, SA (as applicable), Delivery Lead |
| **Approvers** | Delivery Lead / Release Manager |
| **Project phase** | Close / Improve |
...
- [Knowledge Transfer Checklist](knowledge-transfer-checklist.md)
...
**Lessons Learned** — Project PRJ-XXX | Sprint/Release N | Status: Draft
