...
keywords: [automation-candidate-matrix, template, documentation-generator]
tags: [template, sprint-5]
---

# Automation Candidate Matrix

**Template ID:** TPL-AUTOMATION_CANDIDATE_MATRIX  
...
Classify scenarios/cases: Suitable / Manual only / API / UI / Smoke / Regression automation.

## Business Context

After scenario design; before automation backlog commit.
...
**Primary owner:** QE Analyst / Automation Lead

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | After scenario design; before automation backlog commit. |
...
- Completed Automation Candidate Matrix
...
1. Author (QE Analyst / Automation Lead) → draft complete  
...
- [Automation Assessment Report](automation-assessment-report.md)
...
**Automation Candidate Matrix** — Project PRJ-XXX | Sprint/Release N | Status: Draft
