...
keywords: [quality-metrics-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Quality Metrics Dashboard

**Template ID:** TPL-QUALITY_METRICS_DASHBOARD  
...
Quality metrics pack: escape rate, defect density themes, cycle time (define formulas per program).

## Business Context

Steering and continuous improvement reviews.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Steering and continuous improvement reviews. |
| **Owner** | Test Manager |
...
- Completed Quality Metrics Dashboard
...
**Quality Metrics Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
