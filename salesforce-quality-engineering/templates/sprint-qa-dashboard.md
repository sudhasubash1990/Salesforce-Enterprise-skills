...
keywords: [sprint-qa-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Sprint Qa Dashboard

**Template ID:** TPL-SPRINT_QA_DASHBOARD  
...
Sprint-level QA dashboard: burndown of cases, pass rate, blockers.

## Business Context

Sprint reviews / daily governance.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Sprint reviews / daily governance. |
| **Owner** | Test Lead |
...
**Sprint Qa Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
