...
keywords: [release-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Release Dashboard

**Template ID:** TPL-RELEASE_DASHBOARD  
...
Release-level quality dashboard for readiness posture.

## Business Context

Release trains / cutover weeks.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Release trains / cutover weeks. |
| **Owner** | Test Manager |
...
**Release Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
