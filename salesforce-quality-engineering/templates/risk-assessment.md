...
keywords: [risk-assessment, template, documentation-generator]
tags: [template, sprint-5]
---

# Risk Assessment

**Template ID:** TPL-RISK_ASSESSMENT  
**Lifecycle phase:** Plan / Ongoing  
...
Capture quality risks (business, technical, data, security, integration, release) with mitigations and owners.

## Business Context

At planning and whenever material change increases residual risk.
...
**Primary owner:** Test Lead / QE Lead

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | At planning and whenever material change increases residual risk. |
| **Owner** | Test Lead / QE Lead |
| **Reviewers** | BA, SA (as applicable), Delivery Lead |
| **Approvers** | Delivery Lead / Release Manager |
| **Project phase** | Plan / Ongoing |
...
1. Author (Test Lead / QE Lead) → draft complete  
...
**Risk Assessment** — Project PRJ-XXX | Sprint/Release N | Status: Draft
