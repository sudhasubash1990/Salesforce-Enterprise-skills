...
keywords: [smoke-test-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Smoke Test Checklist

**Template ID:** TPL-SMOKE_TEST_CHECKLIST  
**Lifecycle phase:** Deploy / Execute  
...
Minimal critical-path checks after build/deploy.

## Business Context

After every deploy to a test or production environment.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | After every deploy to a test or production environment. |
| **Owner** | Test Lead |
| **Reviewers** | BA, SA (as applicable), Delivery Lead |
| **Approvers** | Delivery Lead / Release Manager |
| **Project phase** | Deploy / Execute |
...
- [Sanity Test Checklist](sanity-test-checklist.md)
...
**Smoke Test Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
