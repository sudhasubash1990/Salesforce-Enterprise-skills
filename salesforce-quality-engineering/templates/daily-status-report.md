...
keywords: [daily-status-report, template, documentation-generator]
tags: [template, sprint-5]
---

# Daily Status Report

**Template ID:** TPL-DAILY_STATUS_REPORT  
...
Daily QA pulse: planned vs actual, blockers, defects, risks.

## Business Context

During active execution (daily or per stand-up cadence).
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | During active execution (daily or per stand-up cadence). |
| **Owner** | Test Lead |
...
**Daily Status Report** — Project PRJ-XXX | Sprint/Release N | Status: Draft
