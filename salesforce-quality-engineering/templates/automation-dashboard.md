...
keywords: [automation-dashboard, template, documentation-generator]
tags: [template, sprint-5]
---

# Automation Dashboard

**Template ID:** TPL-AUTOMATION_DASHBOARD  
**Lifecycle phase:** Execute / Improve  
...
Automation coverage, stability, and candidate backlog view.

## Business Context

When automation program is active.
...
- Completed Automation Dashboard
...
1. Author (Automation Lead) → draft complete  
...
**Automation Dashboard** — Project PRJ-XXX | Sprint/Release N | Status: Draft
