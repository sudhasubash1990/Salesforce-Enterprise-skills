...
keywords: [exit-criteria-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Exit Criteria Checklist

**Template ID:** TPL-EXIT_CRITERIA_CHECKLIST  
...
Gate checklist to exit a test phase with residual risk stated.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before declaring a phase complete. |
| **Owner** | Test Lead |
...
**Exit Criteria Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
