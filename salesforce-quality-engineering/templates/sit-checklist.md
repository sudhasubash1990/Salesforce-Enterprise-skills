...
keywords: [sit-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# SIT Checklist

**Template ID:** TPL-SIT_CHECKLIST  
...
System Integration Testing readiness and execution checklist.

## Business Context

Before and during SIT cycles.
...
**Primary owner:** Test Lead / Integration Lead (QE)

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before and during SIT cycles. |
...
1. Author (Test Lead / Integration Lead (QE)) → draft complete  
...
**SIT Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
