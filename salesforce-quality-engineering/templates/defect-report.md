...
keywords: [defect-report, template, documentation-generator]
tags: [template, sprint-5]
---

# Defect Report

**Template ID:** TPL-DEFECT_REPORT  
...
Standard defect documentation for triage, fix, and retest.

## Business Context

When a verified failure against expected behaviour is found.
...
**Primary owner:** Tester / QE Analyst

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | When a verified failure against expected behaviour is found. |
...
1. Author (Tester / QE Analyst) → draft complete  
...
- [Defect RCA Report](defect-rca-report.md)
...
**Defect Report** — Project PRJ-XXX | Sprint/Release N | Status: Draft
