...
keywords: [exploratory-testing-charter, template, documentation-generator]
tags: [template, sprint-5]
---

# Exploratory Testing Charter

**Template ID:** TPL-EXPLORATORY_TESTING_CHARTER  
...
Time-boxed exploratory charter with mission, charter, and debrief notes.

## Business Context

For risk-based discovery beyond scripted cases.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | For risk-based discovery beyond scripted cases. |
| **Owner** | QE Analyst |
...
**Exploratory Testing Charter** — Project PRJ-XXX | Sprint/Release N | Status: Draft
