...
keywords: [test-data-request, template, documentation-generator]
tags: [template, sprint-5]
---

# Test Data Request

**Template ID:** TPL-TEST_DATA_REQUEST  
...
Request specific test data sets with acceptance criteria for readiness.

## Business Context

When data provisioning is required from ops/integration teams.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | When data provisioning is required from ops/integration teams. |
| **Owner** | Tester |
...
1. Author (Tester) → draft complete  
...
**Test Data Request** — Project PRJ-XXX | Sprint/Release N | Status: Draft
