...
keywords: [environment-readiness-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Environment Readiness Checklist

**Template ID:** TPL-ENVIRONMENT_READINESS_CHECKLIST  
**Lifecycle phase:** Plan / Deploy  
...
Confirm environment configuration, access, integrations, and data readiness.

## Business Context

Before test cycle entry and after refreshes.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before test cycle entry and after refreshes. |
| **Owner** | Test Lead |
| **Reviewers** | BA, SA (as applicable), Delivery Lead |
| **Approvers** | Delivery Lead / Release Manager |
| **Project phase** | Plan / Deploy |
...
- Completed Environment Readiness Checklist
...
**Environment Readiness Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
