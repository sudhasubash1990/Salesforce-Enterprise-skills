...
keywords: [requirement-gap-analysis, template, documentation-generator]
tags: [template, sprint-5]
---

# Requirement Gap Analysis

**Template ID:** TPL-REQUIREMENT_GAP_ANALYSIS  
...
Catalog missing rules, AC themes, security, data, integration, and NFR gaps for stakeholder closure.

## Business Context

When completeness gaps must be tracked to closure before design/build.
...
**Primary owner:** QE Analyst

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | When completeness gaps must be tracked to closure before design/build. |
| **Owner** | QE Analyst |
...
- Completed Requirement Gap Analysis
...
1. Author (QE Analyst) → draft complete  
...
- [Requirement Review Report](requirement-review-report.md)
...
**Requirement Gap Analysis** — Project PRJ-XXX | Sprint/Release N | Status: Draft
