...
keywords: [entry-criteria-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Entry Criteria Checklist

**Template ID:** TPL-ENTRY_CRITERIA_CHECKLIST  
**Lifecycle phase:** Plan / Execute  
...
Gate checklist to enter a test phase (SIT/UAT/Regression/Prod Val).

## Business Context

Before starting a named test phase.
...
- Completed Entry Criteria Checklist
...
**Entry Criteria Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
