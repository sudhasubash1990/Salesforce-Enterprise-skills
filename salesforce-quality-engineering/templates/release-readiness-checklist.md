...
keywords: [release-readiness-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Release Readiness Checklist

**Template ID:** TPL-RELEASE_READINESS_CHECKLIST  
...
Consolidate readiness evidence before Go/No-Go.

## Business Context

Prior to release decision; update as evidence lands.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Prior to release decision; update as evidence lands. |
| **Owner** | Test Lead |
...
**Release Readiness Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
