...
keywords: [regression-checklist, template, documentation-generator]
tags: [template, sprint-5]
---

# Regression Checklist

**Template ID:** TPL-REGRESSION_CHECKLIST  
...
Risk-based regression pack checklist for a release or sprint.

## Business Context

Before release or after high-impact changes.
...
| Attribute | Guidance |
|-----------|----------|
| **When to create** | Before release or after high-impact changes. |
| **Owner** | Test Lead |
...
**Regression Checklist** — Project PRJ-XXX | Sprint/Release N | Status: Draft
