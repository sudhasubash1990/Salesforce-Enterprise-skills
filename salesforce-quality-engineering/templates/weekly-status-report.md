...
keywords: [weekly-status-report, template, documentation-generator]
tags: [template, sprint-5]
---

# Weekly Status Report

**Template ID:** TPL-WEEKLY_STATUS_REPORT  
...
Weekly QA trend report for delivery governance.
...
**Primary owner:** Test Lead / Test Manager

## Document Intelligence

| Attribute | Guidance |
|-----------|----------|
| **When to create** | Weekly during delivery. |
...
- Completed Weekly Status Report
...
1. Author (Test Lead / Test Manager) → draft complete  
...
- [Executive QA Dashboard](executive-qa-dashboard.md)
...
**Weekly Status Report** — Project PRJ-XXX | Sprint/Release N | Status: Draft
