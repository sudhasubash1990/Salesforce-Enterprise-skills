---
title: Scorecard — Enterprise Advisory
version: 0.14.0
tags: [scorecard, sprint-11]
---

# Scorecard — Enterprise Advisory

## Purpose

Score **Enterprise Advisory** readiness for framework certification.

## Weight in overall framework

**10%** (see [overall-framework.md](overall-framework.md) for rollup).
