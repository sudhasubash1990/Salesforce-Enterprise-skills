---
title: Scorecard — Defect Intelligence
version: 0.14.0
tags: [scorecard, sprint-11]
---

# Scorecard — Defect Intelligence

## Purpose

Score **Defect Intelligence** readiness for framework certification.

## Weight in overall framework

**8%** (see [overall-framework.md](overall-framework.md) for rollup).
