...
version: 0.14.0
tags: [validation, sprint-11, test-design-validation]
---
...
Validate **automation candidates** within the Salesforce Quality Engineering framework.

## Validation Objective

Candidates without scripts
