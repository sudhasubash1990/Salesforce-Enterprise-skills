---
title: E2E Validation — Insurance
version: 0.13.0
tags: [validation, e2e, insurance]
---

# End-to-End Validation — Insurance

## Purpose

Exercise the QE Enterprise Orchestrator and sprint engines against a **synthetic** insurance journey (no client PII).
...
Reuse BA industry packs where present: `salesforce-business-analyst/scenarios/insurance/`  
