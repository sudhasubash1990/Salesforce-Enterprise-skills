---
title: E2E Validation — Healthcare
version: 0.13.0
tags: [validation, e2e, healthcare]
---

# End-to-End Validation — Healthcare

## Purpose

Exercise the QE Enterprise Orchestrator and sprint engines against a **synthetic** healthcare journey (no client PII).
...
Reuse BA industry packs where present: `salesforce-business-analyst/scenarios/healthcare/`  
