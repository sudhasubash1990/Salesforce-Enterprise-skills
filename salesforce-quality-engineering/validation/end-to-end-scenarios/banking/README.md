---
title: E2E Validation — Banking
version: 0.13.0
tags: [validation, e2e, banking]
---

# End-to-End Validation — Banking

## Purpose

Exercise the QE Enterprise Orchestrator and sprint engines against a **synthetic** banking journey (no client PII).
...
Reuse BA industry packs where present: `salesforce-business-analyst/scenarios/banking/`  
