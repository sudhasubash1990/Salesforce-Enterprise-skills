---
title: Banking Scenario Validation Script
version: 0.13.0
tags: [validation, e2e, banking]
---

# Banking — Scenario Validation Script

## Purpose

Executable prompt sequence for banking tabletop validation.

## Prompts (run in order)

1. **Incomplete story** — e.g. "User needs to complete a critical banking transaction in Salesforce."  
...
3. **Production symptom** — e.g. "Production users cannot complete the banking transaction."  
