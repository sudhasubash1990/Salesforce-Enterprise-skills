---
title: Retail Scenario Validation Script
version: 0.13.0
tags: [validation, e2e, retail]
---

# Retail — Scenario Validation Script

## Purpose

Executable prompt sequence for retail tabletop validation.

## Prompts (run in order)

1. **Incomplete story** — e.g. "User needs to complete a critical retail transaction in Salesforce."  
...
3. **Production symptom** — e.g. "Production users cannot complete the retail transaction."  
