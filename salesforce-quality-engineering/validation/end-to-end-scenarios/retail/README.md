---
title: E2E Validation — Retail
version: 0.13.0
tags: [validation, e2e, retail]
---

# End-to-End Validation — Retail

## Purpose

Exercise the QE Enterprise Orchestrator and sprint engines against a **synthetic** retail journey (no client PII).
...
Reuse BA industry packs where present: `salesforce-business-analyst/scenarios/retail/`  
