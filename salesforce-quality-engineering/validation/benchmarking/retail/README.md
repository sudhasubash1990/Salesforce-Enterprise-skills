---
title: Benchmark — Retail
version: 0.14.0
tags: [benchmark, sprint-11, retail]
---
...
Benchmark QE framework behaviour on a synthetic **Retail** program.

## Business Context

Omnichannel order, loyalty, returns. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical retail process in Salesforce."
