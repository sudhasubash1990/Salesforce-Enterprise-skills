...
version: 0.14.0
tags: [benchmark, sprint-11, insurance]
---
...
Benchmark QE framework behaviour on a synthetic **Insurance** program.

## Business Context

FNOL, policy servicing. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical insurance process in Salesforce."
