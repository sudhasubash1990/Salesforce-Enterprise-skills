...
version: 0.14.0
tags: [benchmark, sprint-11, utilities]
---
...
Benchmark QE framework behaviour on a synthetic **Utilities** program.

## Business Context

Meter-to-cash, outage, field service. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical utilities process in Salesforce."
