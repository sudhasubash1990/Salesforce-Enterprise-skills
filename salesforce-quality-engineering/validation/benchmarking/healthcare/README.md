---
title: Benchmark — Healthcare
version: 0.14.0
tags: [benchmark, sprint-11, healthcare]
---
...
Benchmark QE framework behaviour on a synthetic **Healthcare** program.

## Business Context

Patient/provider care coordination (overview). Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical healthcare process in Salesforce."
