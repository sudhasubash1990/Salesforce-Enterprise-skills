---
title: Benchmark — Energy
version: 0.14.0
tags: [benchmark, sprint-11, energy]
---
...
Benchmark QE framework behaviour on a synthetic **Energy** program.

## Business Context

Account/service, program enrollment overview. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical energy process in Salesforce."
