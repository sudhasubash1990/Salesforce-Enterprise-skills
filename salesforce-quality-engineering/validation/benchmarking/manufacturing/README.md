---
title: Benchmark — Manufacturing
version: 0.14.0
tags: [benchmark, sprint-11, manufacturing]
---
...
Benchmark QE framework behaviour on a synthetic **Manufacturing** program.

## Business Context

Dealer, asset, warranty. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical manufacturing process in Salesforce."
