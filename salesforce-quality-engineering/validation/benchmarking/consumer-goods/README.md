---
title: Benchmark — Consumer Goods
version: 0.14.0
tags: [benchmark, sprint-11, consumer-goods]
---
...
Benchmark QE framework behaviour on a synthetic **Consumer Goods** program.

## Business Context

Trade promotion / retail execution overview. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical consumer goods process in Salesforce."
