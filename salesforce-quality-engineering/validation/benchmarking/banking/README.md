---
title: Benchmark — Banking
version: 0.14.0
tags: [benchmark, sprint-11, banking]
---
...
Benchmark QE framework behaviour on a synthetic **Banking** program.

## Business Context

KYC onboarding, case servicing. Anonymized; no client PII. Align BA scenarios when present under `salesforce-business-analyst/scenarios/`.

## Requirements (seed)

Provide an incomplete story such as: "User must complete a critical banking process in Salesforce."
