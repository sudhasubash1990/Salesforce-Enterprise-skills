...
keywords: [defect-trend-report, defect-intelligence, quality-analytics]
---
...
Trend report standard for defects.
## Business Context
...
- Defect Trend Report supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Defect Trend Report on a Salesforce release?
...
- **Previous:** [Production Quality Report](production-quality-report.md)
- **Next:** [Executive Qa Dashboard Qi](executive-qa-dashboard-qi.md)
