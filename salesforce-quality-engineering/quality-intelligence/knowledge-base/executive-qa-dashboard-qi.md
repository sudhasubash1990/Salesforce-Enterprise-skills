---
title: Executive Qa Dashboard Qi
...
keywords: [executive-qa-dashboard-qi, defect-intelligence, quality-analytics]
---

# Executive Qa Dashboard Qi
...
Executive dashboard content from QI signals.
## Business Context
...
- Executive Qa Dashboard Qi supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Executive Qa Dashboard Qi on a Salesforce release?
- What data is required before drawing conclusions?
- How does this reduce defect leakage?
## Related Documents

- [../../templates/executive-qa-dashboard.md](../../templates/executive-qa-dashboard.md)
...
- **Previous:** [Defect Trend Report](defect-trend-report.md)
- **Next:** [Rca Report Standard](rca-report-standard.md)
