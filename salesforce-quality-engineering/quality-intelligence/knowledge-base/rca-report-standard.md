...
keywords: [rca-report-standard, defect-intelligence, quality-analytics]
---
...
Executive/technical RCA report expectations.
## Business Context
...
- Rca Report Standard supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Rca Report Standard on a Salesforce release?
- What data is required before drawing conclusions?
- How does this reduce defect leakage?
## Related Documents

- [../../templates/defect-rca-report.md](../../templates/defect-rca-report.md)
...
- **Previous:** [Executive Qa Dashboard Qi](executive-qa-dashboard-qi.md)
- **Next:** [Risk Assessment Report Qi](risk-assessment-report-qi.md)
