...
keywords: [release-risk, defect-intelligence, quality-analytics]
---
...
Score release readiness and cutover risk.
## Business Context
...
- Release Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Release Risk on a Salesforce release?
...
- **Previous:** [Security Risk](security-risk.md)
- **Next:** [Automation Risk](automation-risk.md)
