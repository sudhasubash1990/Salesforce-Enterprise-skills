...
keywords: [environment-risk, defect-intelligence, quality-analytics]
---
...
Score env/data/credential readiness risk.
## Business Context
...
- Environment Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Environment Risk on a Salesforce release?
...
- **Previous:** [Compliance Risk](compliance-risk.md)
- **Next:** [Dependency Risk](dependency-risk.md)
