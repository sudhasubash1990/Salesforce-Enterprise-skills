...
tags: [quality-intelligence, sprint-7, risk-analysis]
keywords: [compliance-risk, defect-intelligence, quality-analytics]
---
...
Flag compliance risk—confirm with Legal; do not invent regulations.
## Business Context
...
- Compliance Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Compliance Risk on a Salesforce release?
...
- **Previous:** [Performance Risk](performance-risk.md)
- **Next:** [Environment Risk](environment-risk.md)
