...
keywords: [security-risk, defect-intelligence, quality-analytics]
---
...
Score security defect and oversharing risk.
## Business Context
...
- Security Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Security Risk on a Salesforce release?
...
- **Previous:** [Data Risk](data-risk.md)
- **Next:** [Release Risk](release-risk.md)
