...
keywords: [automation-risk, defect-intelligence, quality-analytics]
---
...
Score false confidence from unstable automation.
## Business Context
...
- Automation Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Automation Risk on a Salesforce release?
...
- **Previous:** [Release Risk](release-risk.md)
- **Next:** [Regression Risk](regression-risk.md)
