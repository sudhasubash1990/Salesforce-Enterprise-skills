...
keywords: [data-risk, defect-intelligence, quality-analytics]
---
...
Score data integrity and migration risk.
## Business Context
...
- Data Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Data Risk on a Salesforce release?
...
- **Previous:** [Integration Risk](integration-risk.md)
- **Next:** [Security Risk](security-risk.md)
