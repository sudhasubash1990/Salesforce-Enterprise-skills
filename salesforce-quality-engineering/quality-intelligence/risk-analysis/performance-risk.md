...
keywords: [performance-risk, defect-intelligence, quality-analytics]
---
...
Score governor/LDV/concurrency risk.
## Business Context
...
- Performance Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Performance Risk on a Salesforce release?
...
- **Previous:** [Regression Risk](regression-risk.md)
- **Next:** [Compliance Risk](compliance-risk.md)
