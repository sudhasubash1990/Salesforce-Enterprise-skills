...
keywords: [dependency-risk, defect-intelligence, quality-analytics]
---
...
Score vendor/package/team dependency risk.
## Business Context
...
- Dependency Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Dependency Risk on a Salesforce release?
...
- **Previous:** [Environment Risk](environment-risk.md)
- **Next:** [Risk Scoring Model](risk-scoring-model.md)
