...
keywords: [regression-risk, defect-intelligence, quality-analytics]
---
...
Score likelihood of breaking prior behaviour.
## Business Context
...
- Regression Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Regression Risk on a Salesforce release?
...
- **Previous:** [Automation Risk](automation-risk.md)
- **Next:** [Performance Risk](performance-risk.md)
