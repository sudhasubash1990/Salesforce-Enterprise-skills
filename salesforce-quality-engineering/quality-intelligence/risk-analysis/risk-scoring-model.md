...
keywords: [risk-scoring-model, defect-intelligence, quality-analytics]
---
...
Probability × Impact model with monitoring and escalation thresholds.
## Business Context
...
- Risk Scoring Model supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Risk Scoring Model on a Salesforce release?
...
- **Previous:** [Dependency Risk](dependency-risk.md)
