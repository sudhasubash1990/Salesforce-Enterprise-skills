...
keywords: [integration-risk, defect-intelligence, quality-analytics]
---
...
Score integration failure and contract risk.
## Business Context
...
- Integration Risk supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Integration Risk on a Salesforce release?
...
- **Previous:** [Technical Risk](technical-risk.md)
- **Next:** [Data Risk](data-risk.md)
