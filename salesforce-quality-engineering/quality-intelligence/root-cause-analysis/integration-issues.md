...
keywords: [integration-issues, defect-intelligence, quality-analytics]
---
...
Contract, auth, and retry design failures.
## Business Context
...
- Integration Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Integration Issues on a Salesforce release?
...
- **Previous:** [Test Data Issues](test-data-issues.md)
