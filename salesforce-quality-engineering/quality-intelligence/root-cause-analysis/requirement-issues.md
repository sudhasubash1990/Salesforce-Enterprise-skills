...
keywords: [requirement-issues, defect-intelligence, quality-analytics]
---
...
Ambiguous or incomplete requirements causing defects.
## Business Context
...
- Requirement Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Requirement Issues on a Salesforce release?
...
- **Previous:** [Process Failures](process-failures.md)
- **Next:** [Design Issues](design-issues.md)
