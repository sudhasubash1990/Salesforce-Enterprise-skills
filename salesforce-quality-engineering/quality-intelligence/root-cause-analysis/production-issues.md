...
keywords: [production-issues, defect-intelligence, quality-analytics]
---
...
Volume, data, permission drift unique to production.
## Business Context
...
- Production Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Production Issues on a Salesforce release?
...
- **Previous:** [Deployment Issues](deployment-issues.md)
