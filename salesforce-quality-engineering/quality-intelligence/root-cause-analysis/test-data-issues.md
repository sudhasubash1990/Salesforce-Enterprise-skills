...
keywords: [test-data-issues, defect-intelligence, quality-analytics]
---
...
Invalid/masked/incomplete test data causing escapes or noise.
## Business Context
...
- Test Data Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Test Data Issues on a Salesforce release?
...
- **Previous:** [Environment Issues](environment-issues.md)
- **Next:** [Integration Issues](integration-issues.md)
