...
keywords: [fishbone-diagram, defect-intelligence, quality-analytics]
---
...
Structure causes across people/process/tech/data/env categories.
## Business Context
...
- Fishbone Diagram supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Fishbone Diagram on a Salesforce release?
...
- **Previous:** [5 Whys](5-whys.md)
- **Next:** [Pareto Analysis](pareto-analysis.md)
