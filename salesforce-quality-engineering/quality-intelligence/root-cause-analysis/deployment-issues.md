...
keywords: [deployment-issues, defect-intelligence, quality-analytics]
---
...
Deploy omission, sequence, or package upgrade causes.
## Business Context
...
- Deployment Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Deployment Issues on a Salesforce release?
...
- **Previous:** [Integration Issues](integration-issues.md)
- **Next:** [Production Issues](production-issues.md)
