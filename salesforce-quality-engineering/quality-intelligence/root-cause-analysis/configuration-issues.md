...
keywords: [configuration-issues, defect-intelligence, quality-analytics]
---
...
Metadata misconfiguration root causes.
## Business Context
...
- Configuration Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Configuration Issues on a Salesforce release?
...
- **Previous:** [Development Issues](development-issues.md)
- **Next:** [Environment Issues](environment-issues.md)
