...
keywords: [defect-categorization, defect-intelligence, quality-analytics]
---
...
Standardize RCA categories for analytics.
## Business Context
...
- Defect Categorization supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Defect Categorization on a Salesforce release?
...
- **Previous:** [FMEA](fmea.md)
- **Next:** [Process Failures](process-failures.md)
