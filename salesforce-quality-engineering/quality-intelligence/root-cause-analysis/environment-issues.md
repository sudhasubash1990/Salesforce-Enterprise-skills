...
keywords: [environment-issues, defect-intelligence, quality-analytics]
---
...
Env parity, data, and credential issues.
## Business Context
...
- Environment Issues supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Environment Issues on a Salesforce release?
...
- **Previous:** [Configuration Issues](configuration-issues.md)
- **Next:** [Test Data Issues](test-data-issues.md)
