...
keywords: [integration-defects, defect-intelligence, quality-analytics]
---
...
API/event/middleware defects and contract mismatches.
## Business Context
...
- Integration Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Integration Defects on a Salesforce release?
...
- **Previous:** [UI Defects](ui-defects.md)
- **Next:** [Data Defects](data-defects.md)
