...
keywords: [data-defects, defect-intelligence, quality-analytics]
---
...
Incorrect, missing, duplicated, or migrated data defects.
## Business Context
...
- Data Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Data Defects on a Salesforce release?
...
- **Previous:** [Integration Defects](integration-defects.md)
- **Next:** [Security Defects](security-defects.md)
