...
keywords: [regression-defects, defect-intelligence, quality-analytics]
---
...
Defects introduced or reopened by change—feed regression packs.
## Business Context
...
- Regression Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Regression Defects on a Salesforce release?
...
- **Previous:** [Performance Defects](performance-defects.md)
- **Next:** [Automation Defects](automation-defects.md)
