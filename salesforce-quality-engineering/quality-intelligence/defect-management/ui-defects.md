...
keywords: [ui-defects, defect-intelligence, quality-analytics]
---
...
Layout, Lightning page, and usability defects—separate from functional failure when possible.
## Business Context
...
- UI Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply UI Defects on a Salesforce release?
...
- **Previous:** [Functional Defects](functional-defects.md)
- **Next:** [Integration Defects](integration-defects.md)
