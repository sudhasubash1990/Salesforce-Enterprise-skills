...
keywords: [security-defects, defect-intelligence, quality-analytics]
---
...
CRUD/FLS/sharing/auth defects with high audit impact.
## Business Context
...
- Security Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Security Defects on a Salesforce release?
...
- **Previous:** [Data Defects](data-defects.md)
- **Next:** [Performance Defects](performance-defects.md)
