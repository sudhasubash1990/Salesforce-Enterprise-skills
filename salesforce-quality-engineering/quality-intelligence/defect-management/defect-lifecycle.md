...
keywords: [defect-lifecycle, defect-intelligence, quality-analytics]
---
...
Define defect lifecycle stages and QE evidence at each state.
## Business Context
...
- Defect Lifecycle supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Defect Lifecycle on a Salesforce release?
...
- **Next:** [Defect Workflow](defect-workflow.md)
