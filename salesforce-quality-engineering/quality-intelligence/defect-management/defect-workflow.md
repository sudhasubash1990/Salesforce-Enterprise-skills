...
keywords: [defect-workflow, defect-intelligence, quality-analytics]
---
...
Describe triage→fix→retest→close workflow and ownership.
## Business Context
...
- Defect Workflow supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Defect Workflow on a Salesforce release?
- What data is required before drawing conclusions?
- How does this reduce defect leakage?
## Related Documents

- [../../ado/governance/bug-workflow.md](../../ado/governance/bug-workflow.md)
...
- **Previous:** [Defect Lifecycle](defect-lifecycle.md)
- **Next:** [Severity](severity.md)
