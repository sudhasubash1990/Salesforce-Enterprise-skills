...
keywords: [functional-defects, defect-intelligence, quality-analytics]
---
...
Defects where functional outcomes violate acceptance criteria.
## Business Context
...
- Functional Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Functional Defects on a Salesforce release?
...
- **Previous:** [Defect Classification](defect-classification.md)
- **Next:** [UI Defects](ui-defects.md)
