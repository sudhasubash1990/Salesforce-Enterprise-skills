...
keywords: [automation-defects, defect-intelligence, quality-analytics]
---
...
Distinguish product bugs from automation false failures.
## Business Context
...
- Automation Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Automation Defects on a Salesforce release?
...
- **Previous:** [Regression Defects](regression-defects.md)
- **Next:** [Environment Defects](environment-defects.md)
