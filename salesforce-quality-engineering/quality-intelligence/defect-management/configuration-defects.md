...
keywords: [configuration-defects, defect-intelligence, quality-analytics]
---
...
Wrong VR/Flow/layout/permission configuration outcomes.
## Business Context
...
- Configuration Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Configuration Defects on a Salesforce release?
...
- **Previous:** [Environment Defects](environment-defects.md)
- **Next:** [Deployment Defects](deployment-defects.md)
