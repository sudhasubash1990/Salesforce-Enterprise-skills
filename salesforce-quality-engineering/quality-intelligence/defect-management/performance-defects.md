...
keywords: [performance-defects, defect-intelligence, quality-analytics]
---
...
Timeouts, governor-limit failures, LDV symptoms.
## Business Context
...
- Performance Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Performance Defects on a Salesforce release?
...
- **Previous:** [Security Defects](security-defects.md)
- **Next:** [Regression Defects](regression-defects.md)
