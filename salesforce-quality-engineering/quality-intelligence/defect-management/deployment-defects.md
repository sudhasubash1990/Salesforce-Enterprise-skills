...
keywords: [deployment-defects, defect-intelligence, quality-analytics]
---
...
Post-deploy failures from omitted metadata or order issues.
## Business Context
...
- Deployment Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Deployment Defects on a Salesforce release?
...
- **Previous:** [Configuration Defects](configuration-defects.md)
- **Next:** [Production Defects](production-defects.md)
