...
keywords: [severity, defect-intelligence, quality-analytics]
---
...
Classify defect severity by business/technical impact—not urgency.
## Business Context
...
- Severity supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Severity on a Salesforce release?
...
- **Previous:** [Defect Workflow](defect-workflow.md)
