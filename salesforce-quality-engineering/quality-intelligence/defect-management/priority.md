...
keywords: [priority, defect-intelligence, quality-analytics]
---
...
Set fix priority relative to release risk and severity.
## Business Context
...
- Priority supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Priority on a Salesforce release?
...
- **Previous:** [Severity](severity.md)
- **Next:** [Defect Classification](defect-classification.md)
