...
keywords: [defect-classification, defect-intelligence, quality-analytics]
---
...
Provide a consistent taxonomy for analytics and pattern detection.
## Business Context
...
- Defect Classification supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Defect Classification on a Salesforce release?
...
- **Previous:** [Priority](priority.md)
- **Next:** [Functional Defects](functional-defects.md)
