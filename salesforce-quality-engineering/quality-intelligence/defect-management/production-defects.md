...
keywords: [production-defects, defect-intelligence, quality-analytics]
---
...
Production escapes—mandatory RCA and leakage metrics.
## Business Context
...
- Production Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Production Defects on a Salesforce release?
...
- **Previous:** [Deployment Defects](deployment-defects.md)
