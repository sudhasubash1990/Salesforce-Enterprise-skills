...
keywords: [environment-failures, defect-intelligence, quality-analytics]
---
...
Cluster failures by environment symptoms.
## Business Context
...
- Environment Failures supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Environment Failures on a Salesforce release?
...
- **Previous:** [Requirement Gaps](requirement-gaps.md)
- **Next:** [Integration Failures](integration-failures.md)
