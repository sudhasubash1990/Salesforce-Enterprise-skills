...
keywords: [duplicate-defects, defect-intelligence, quality-analytics]
---
...
Detect duplicates to clean analytics and triage.
## Business Context
...
- Duplicate Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Duplicate Defects on a Salesforce release?
...
- **Previous:** [Recurring Defects](recurring-defects.md)
- **Next:** [Regression Patterns](regression-patterns.md)
