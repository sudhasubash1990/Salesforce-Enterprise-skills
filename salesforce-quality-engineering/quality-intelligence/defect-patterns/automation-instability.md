...
keywords: [automation-instability, defect-intelligence, quality-analytics]
---
...
Separate product risk from unstable automation.
## Business Context
...
- Automation Instability supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Automation Instability on a Salesforce release?
...
- **Previous:** [Security Weaknesses](security-weaknesses.md)
- **Next:** [Production Leakage](production-leakage.md)
