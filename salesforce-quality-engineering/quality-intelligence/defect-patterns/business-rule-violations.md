...
keywords: [business-rule-violations, defect-intelligence, quality-analytics]
---
...
Repeated business-rule/validation failures.
## Business Context
...
- Business Rule Violations supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Business Rule Violations on a Salesforce release?
...
- **Previous:** [Production Leakage](production-leakage.md)
- **Next:** [Pattern Detection Rules](pattern-detection-rules.md)
