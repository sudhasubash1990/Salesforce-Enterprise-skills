...
keywords: [recurring-defects, defect-intelligence, quality-analytics]
---
...
Identify defects that recur across sprints/releases.
## Business Context
...
- Recurring Defects supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Recurring Defects on a Salesforce release?
...
- **Next:** [Duplicate Defects](duplicate-defects.md)
