...
keywords: [pattern-detection-rules, defect-intelligence, quality-analytics]
---
...
Rules the AI should apply to claim a pattern (min samples, window, similarity).
## Business Context
...
- Pattern Detection Rules supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Pattern Detection Rules on a Salesforce release?
...
- **Previous:** [Business Rule Violations](business-rule-violations.md)
- **Next:** [Confidence Score](confidence-score.md)
