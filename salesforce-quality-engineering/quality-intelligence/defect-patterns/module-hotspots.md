...
keywords: [module-hotspots, defect-intelligence, quality-analytics]
---
...
Rank Salesforce modules/objects with elevated defect density.
## Business Context
...
- Module Hotspots supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Module Hotspots on a Salesforce release?
...
- **Previous:** [Regression Patterns](regression-patterns.md)
