...
keywords: [requirement-gaps, defect-intelligence, quality-analytics]
---
...
Recurring misses from incomplete requirements/AC.
## Business Context
...
- Requirement Gaps supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Requirement Gaps on a Salesforce release?
...
- **Next:** [Environment Failures](environment-failures.md)
