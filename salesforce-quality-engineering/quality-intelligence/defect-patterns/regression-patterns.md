...
keywords: [regression-patterns, defect-intelligence, quality-analytics]
---
...
Spot modules that break when adjacent features change.
## Business Context
...
- Regression Patterns supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Regression Patterns on a Salesforce release?
...
- **Previous:** [Duplicate Defects](duplicate-defects.md)
- **Next:** [Module Hotspots](module-hotspots.md)
