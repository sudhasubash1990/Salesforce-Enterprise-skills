...
keywords: [security-weaknesses, defect-intelligence, quality-analytics]
---
...
Recurring FLS/sharing/persona failures.
## Business Context
...
- Security Weaknesses supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Security Weaknesses on a Salesforce release?
...
- **Previous:** [Integration Failures](integration-failures.md)
- **Next:** [Automation Instability](automation-instability.md)
