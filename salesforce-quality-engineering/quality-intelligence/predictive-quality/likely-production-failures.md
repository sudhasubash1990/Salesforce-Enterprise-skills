---
title: Likely Production Failures
...
keywords: [likely-production-failures, defect-intelligence, quality-analytics]
---
...
Predict failure modes under prod volume/permissions.
## Business Context
...
- Likely Production Failures supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Likely Production Failures on a Salesforce release?
...
- **Previous:** [Likely Regression Areas](likely-regression-areas.md)
- **Next:** [Automation Candidates](automation-candidates.md)
