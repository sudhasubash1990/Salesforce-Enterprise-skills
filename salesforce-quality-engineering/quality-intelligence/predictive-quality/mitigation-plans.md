...
keywords: [mitigation-plans, defect-intelligence, quality-analytics]
---
...
Recommend mitigations tied to each prediction class.
## Business Context
...
- Mitigation Plans supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Mitigation Plans on a Salesforce release?
...
- **Previous:** [Confidence Levels](confidence-levels.md)
