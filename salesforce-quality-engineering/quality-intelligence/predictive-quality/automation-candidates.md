...
keywords: [automation-candidates, defect-intelligence, quality-analytics]
---
...
Predict strong automation ROI candidates from stability/frequency.
## Business Context
...
- Automation Candidates supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Automation Candidates on a Salesforce release?
...
- **Previous:** [Likely Production Failures](likely-production-failures.md)
- **Next:** [Likely Defect Leakage](likely-defect-leakage.md)
