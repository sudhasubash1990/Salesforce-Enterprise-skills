...
keywords: [high-risk-components, defect-intelligence, quality-analytics]
---
...
Predict Salesforce components likely to fail based on history + change.
## Business Context
...
- High Risk Components supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply High Risk Components on a Salesforce release?
...
- **Previous:** [High Risk User Stories](high-risk-user-stories.md)
- **Next:** [Likely Regression Areas](likely-regression-areas.md)
