...
keywords: [quality-gate-failures, defect-intelligence, quality-analytics]
---
...
Predict which entry/exit gates are at risk of failing.
## Business Context
...
- Quality Gate Failures supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Quality Gate Failures on a Salesforce release?
...
- **Previous:** [Release Readiness Risks](release-readiness-risks.md)
- **Next:** [Confidence Levels](confidence-levels.md)
