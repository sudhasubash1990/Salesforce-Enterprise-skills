...
keywords: [high-risk-user-stories, defect-intelligence, quality-analytics]
---
...
Flag stories likely to inject defects (complexity, volatility, integration, security).
## Business Context
...
- High Risk User Stories supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply High Risk User Stories on a Salesforce release?
