...
tags: [quality-intelligence, sprint-7, predictive-quality]
keywords: [likely-defect-leakage, defect-intelligence, quality-analytics]
---

# Likely Defect Leakage
...
Predict where escapes are likely given weak coverage/gates.
## Business Context
...
- Likely Defect Leakage supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Likely Defect Leakage on a Salesforce release?
...
- **Previous:** [Automation Candidates](automation-candidates.md)
- **Next:** [Release Readiness Risks](release-readiness-risks.md)
