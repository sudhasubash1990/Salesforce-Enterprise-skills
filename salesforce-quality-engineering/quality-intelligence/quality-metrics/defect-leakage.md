...
keywords: [defect-leakage, defect-intelligence, quality-analytics]
---
...
Define and interpret Defect Leakage for Salesforce QE governance.
## Business Context
...
- Share of defects found in later phases (e.g., prod) vs earlier.
- **Formula (conceptual):** Phase_n defects / Total defects (define phases)
## Inputs
...
- Interpretation guidance for Defect Leakage must cite numerator/denominator sources
...
- How would you apply Defect Leakage on a Salesforce release?
...
- **Previous:** [Defect Density](defect-density.md)
- **Next:** [Defect Removal Efficiency](defect-removal-efficiency.md)
