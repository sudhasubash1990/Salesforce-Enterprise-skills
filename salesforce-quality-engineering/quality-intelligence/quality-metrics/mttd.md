...
keywords: [mttd, defect-intelligence, quality-analytics]
---
...
Define and interpret MTTD for Salesforce QE governance.
## Business Context
...
- Average time from introduce/deploy to detect.
- **Formula (conceptual):** Sum(detect - introduce) / n
## Inputs
...
- Interpretation guidance for MTTD must cite numerator/denominator sources
...
- How would you apply MTTD on a Salesforce release?
...
- **Previous:** [Reopen Rate](reopen-rate.md)
- **Next:** [MTTR](mttr.md)
