...
keywords: [fail-rate, defect-intelligence, quality-analytics]
---
...
Define and interpret Fail Rate for Salesforce QE governance.
## Business Context
...
- Failed executions / executed.
- **Formula (conceptual):** Failed / Executed
## Inputs
...
- Interpretation guidance for Fail Rate must cite numerator/denominator sources
...
- How would you apply Fail Rate on a Salesforce release?
...
- **Next:** [Automation Coverage](automation-coverage.md)
