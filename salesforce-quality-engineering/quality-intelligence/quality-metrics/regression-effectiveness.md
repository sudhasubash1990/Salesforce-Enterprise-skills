---
title: Regression Effectiveness
...
keywords: [regression-effectiveness, defect-intelligence, quality-analytics]
---
...
Define and interpret Regression Effectiveness for Salesforce QE governance.
## Business Context
...
- Regressions caught by pack vs missed.
- **Formula (conceptual):** Caught by regression / (Caught + Missed)
## Inputs
...
- Interpretation guidance for Regression Effectiveness must cite numerator/denominator sources
...
- How would you apply Regression Effectiveness on a Salesforce release?
...
- **Previous:** [MTTR](mttr.md)
- **Next:** [Requirement Volatility](requirement-volatility.md)
