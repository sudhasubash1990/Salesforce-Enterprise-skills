...
keywords: [execution-progress, defect-intelligence, quality-analytics]
---
...
Define and interpret Execution Progress for Salesforce QE governance.
## Business Context
...
- Executed vs planned cases.
- **Formula (conceptual):** Executed / Planned
## Inputs
...
- Interpretation guidance for Execution Progress must cite numerator/denominator sources
...
- How would you apply Execution Progress on a Salesforce release?
...
- **Previous:** [Test Coverage](test-coverage.md)
