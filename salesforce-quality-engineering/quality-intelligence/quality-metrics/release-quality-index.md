...
keywords: [release-quality-index, defect-intelligence, quality-analytics]
---
...
Define and interpret Release Quality Index for Salesforce QE governance.
## Business Context
...
- Composite readiness/quality score for release.
...
- Interpretation guidance for Release Quality Index must cite numerator/denominator sources
...
- How would you apply Release Quality Index on a Salesforce release?
...
- **Previous:** [Sprint Quality Index](sprint-quality-index.md)
- **Next:** [Production Stability Index](production-stability-index.md)
