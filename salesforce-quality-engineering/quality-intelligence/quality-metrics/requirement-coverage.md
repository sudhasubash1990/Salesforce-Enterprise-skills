...
keywords: [requirement-coverage, defect-intelligence, quality-analytics]
---
...
Define and interpret Requirement Coverage for Salesforce QE governance.
## Business Context
...
- Requirements with linked scenarios/cases.
- **Formula (conceptual):** Covered reqs / Total in-scope reqs
## Inputs
...
- Interpretation guidance for Requirement Coverage must cite numerator/denominator sources
...
- How would you apply Requirement Coverage on a Salesforce release?
...
- **Previous:** [Defect Removal Efficiency](defect-removal-efficiency.md)
- **Next:** [Test Coverage](test-coverage.md)
