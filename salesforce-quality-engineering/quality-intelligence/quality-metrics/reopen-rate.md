...
keywords: [reopen-rate, defect-intelligence, quality-analytics]
---
...
Define and interpret Reopen Rate for Salesforce QE governance.
## Business Context
...
- Reopened / Closed in period.
- **Formula (conceptual):** Reopened / Closed
## Inputs
...
- Interpretation guidance for Reopen Rate must cite numerator/denominator sources
...
- How would you apply Reopen Rate on a Salesforce release?
...
- **Previous:** [Escaped Defects](escaped-defects.md)
- **Next:** [MTTD](mttd.md)
