...
keywords: [automation-coverage, defect-intelligence, quality-analytics]
---
...
Define and interpret Automation Coverage for Salesforce QE governance.
## Business Context
...
- Automated cases / automatable candidates (define set).
- **Formula (conceptual):** Automated / Candidates
## Inputs
...
- Interpretation guidance for Automation Coverage must cite numerator/denominator sources
...
- How would you apply Automation Coverage on a Salesforce release?
...
- **Previous:** [Fail Rate](fail-rate.md)
- **Next:** [Automation Stability](automation-stability.md)
