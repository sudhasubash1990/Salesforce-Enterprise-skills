...
keywords: [escaped-defects, defect-intelligence, quality-analytics]
---
...
Define and interpret Escaped Defects for Salesforce QE governance.
## Business Context
...
- Count of defects found after exit of intended phase.
- **Formula (conceptual):** Count of escaped defects (by definition)
## Inputs
...
- Interpretation guidance for Escaped Defects must cite numerator/denominator sources
...
- How would you apply Escaped Defects on a Salesforce release?
...
- **Previous:** [Automation Stability](automation-stability.md)
- **Next:** [Reopen Rate](reopen-rate.md)
