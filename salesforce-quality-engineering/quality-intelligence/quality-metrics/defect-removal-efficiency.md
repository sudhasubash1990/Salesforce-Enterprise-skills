...
keywords: [defect-removal-efficiency, defect-intelligence, quality-analytics]
---
...
Define and interpret DRE for Salesforce QE governance.
## Business Context
...
- Effectiveness of removing defects before a phase.
- **Formula (conceptual):** Defects removed before phase / (removed + escaped)
## Inputs
...
- Interpretation guidance for DRE must cite numerator/denominator sources
...
- How would you apply Defect Removal Efficiency on a Salesforce release?
...
- **Previous:** [Defect Leakage](defect-leakage.md)
- **Next:** [Requirement Coverage](requirement-coverage.md)
