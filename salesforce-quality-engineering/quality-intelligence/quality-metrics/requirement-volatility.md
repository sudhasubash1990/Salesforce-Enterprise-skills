...
keywords: [requirement-volatility, defect-intelligence, quality-analytics]
---
...
Define and interpret Requirement Volatility for Salesforce QE governance.
## Business Context
...
- Change rate of requirements in a window.
- **Formula (conceptual):** Changed reqs / Total reqs
## Inputs
...
- Interpretation guidance for Requirement Volatility must cite numerator/denominator sources
...
- How would you apply Requirement Volatility on a Salesforce release?
...
- **Previous:** [Regression Effectiveness](regression-effectiveness.md)
- **Next:** [Sprint Quality Index](sprint-quality-index.md)
