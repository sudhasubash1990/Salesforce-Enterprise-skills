...
keywords: [pass-rate, defect-intelligence, quality-analytics]
---
...
Define and interpret Pass Rate for Salesforce QE governance.
## Business Context
...
- Passed executions / executed.
- **Formula (conceptual):** Passed / Executed
## Inputs
...
- Interpretation guidance for Pass Rate must cite numerator/denominator sources
...
- How would you apply Pass Rate on a Salesforce release?
...
- **Previous:** [Execution Progress](execution-progress.md)
- **Next:** [Fail Rate](fail-rate.md)
