...
keywords: [sprint-quality-index, defect-intelligence, quality-analytics]
---

# Sprint Quality Index
...
Define and interpret Sprint Quality Index for Salesforce QE governance.
## Business Context
...
- Composite of pass rate, Critical opens, leakage signals (define weights).
- **Formula (conceptual):** Weighted score (document weights)
## Inputs
...
- Interpretation guidance for Sprint Quality Index must cite numerator/denominator sources
...
- How would you apply Sprint Quality Index on a Salesforce release?
...
- **Previous:** [Requirement Volatility](requirement-volatility.md)
- **Next:** [Release Quality Index](release-quality-index.md)
