...
keywords: [mttr, defect-intelligence, quality-analytics]
---
...
Define and interpret MTTR for Salesforce QE governance.
## Business Context
...
- Average time from detect to resolve/verify.
- **Formula (conceptual):** Sum(resolve - detect) / n
## Inputs
...
- Interpretation guidance for MTTR must cite numerator/denominator sources
...
- How would you apply MTTR on a Salesforce release?
...
- **Previous:** [MTTD](mttd.md)
- **Next:** [Regression Effectiveness](regression-effectiveness.md)
