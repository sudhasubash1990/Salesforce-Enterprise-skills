...
keywords: [test-coverage, defect-intelligence, quality-analytics]
---
...
Define and interpret Test Coverage for Salesforce QE governance.
## Business Context
...
- Scope covered by scenarios/cases (qualitative+linked)—not code % unless measured.
- **Formula (conceptual):** Linked coverage items / In-scope items
## Inputs
...
- Interpretation guidance for Test Coverage must cite numerator/denominator sources
...
- How would you apply Test Coverage on a Salesforce release?
...
- **Previous:** [Requirement Coverage](requirement-coverage.md)
- **Next:** [Execution Progress](execution-progress.md)
