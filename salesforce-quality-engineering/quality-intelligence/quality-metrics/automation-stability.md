...
keywords: [automation-stability, defect-intelligence, quality-analytics]
---
...
Define and interpret Automation Stability for Salesforce QE governance.
## Business Context
...
- Stable runs vs flaky failures.
- **Formula (conceptual):** 1 - (Flaky failures / Automation runs)
## Inputs
...
- Interpretation guidance for Automation Stability must cite numerator/denominator sources
...
- How would you apply Automation Stability on a Salesforce release?
...
- **Previous:** [Automation Coverage](automation-coverage.md)
- **Next:** [Escaped Defects](escaped-defects.md)
