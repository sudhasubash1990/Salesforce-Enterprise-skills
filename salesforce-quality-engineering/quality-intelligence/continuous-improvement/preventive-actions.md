...
keywords: [preventive-actions, defect-intelligence, quality-analytics]
---
...
Define preventive controls (reviews, tests, gates).
## Business Context
...
- Preventive Actions supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Preventive Actions on a Salesforce release?
...
- **Previous:** [Quality Improvement Plans](quality-improvement-plans.md)
- **Next:** [Corrective Actions (CAPA)](capa.md)
