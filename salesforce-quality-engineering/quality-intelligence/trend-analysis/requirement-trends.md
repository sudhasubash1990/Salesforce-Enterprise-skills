...
keywords: [requirement-trends, defect-intelligence, quality-analytics]
---
...
Correlate requirement churn with defect injection.
## Business Context
...
- Requirement Trends supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Requirement Trends on a Salesforce release?
...
- **Previous:** [Defect Trends](defect-trends.md)
- **Next:** [Regression Trends](regression-trends.md)
