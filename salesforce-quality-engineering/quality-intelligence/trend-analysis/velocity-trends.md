...
keywords: [velocity-trends, defect-intelligence, quality-analytics]
---
...
Relate delivery velocity to quality risk (avoid gaming).
## Business Context
...
- Velocity Trends supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Velocity Trends on a Salesforce release?
...
- **Previous:** [Production Trends](production-trends.md)
- **Next:** [Quality Trends](quality-trends.md)
