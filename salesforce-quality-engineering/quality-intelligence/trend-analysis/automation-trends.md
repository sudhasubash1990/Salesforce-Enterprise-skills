...
keywords: [automation-trends, defect-intelligence, quality-analytics]
---
...
Track coverage vs stability over time.
## Business Context
...
- Automation Trends supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Automation Trends on a Salesforce release?
...
- **Previous:** [Regression Trends](regression-trends.md)
- **Next:** [Environment Trends](environment-trends.md)
