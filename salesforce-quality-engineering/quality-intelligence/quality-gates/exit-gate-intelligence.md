...
tags: [quality-intelligence, sprint-7, quality-gates]
keywords: [exit-gate-intelligence, defect-intelligence, quality-analytics]
---

# Exit Gate Intelligence
...
When to block phase exit based on residual risk.
## Business Context
...
- Exit Gate Intelligence supports data-driven quality decisions across Salesforce delivery.
...
- How would you apply Exit Gate Intelligence on a Salesforce release?
...
- **Previous:** [Entry Gate Intelligence](entry-gate-intelligence.md)
- **Next:** [Release Gate Intelligence](release-gate-intelligence.md)
