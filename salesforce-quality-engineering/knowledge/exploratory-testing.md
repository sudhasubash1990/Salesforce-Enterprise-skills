...
**Purpose:** Time-boxed simultaneous learning, design, and execution around a charter.
...
Thin AC, new UX, high uncertainty after scripted core.

## Guidance

- Define charter and time box.
- Capture notes/risks; feed back into scenarios.
- Complements—not replaces—scripted High coverage.
