...
**Purpose:** Verify valid and invalid transitions across object lifecycle states.
...
Case/Opportunity/Order status models; approval states.

## Guidance

- Map states and events.
- Cover valid transitions + key illegal transitions.
- Include permission to transition.
