...
keywords: [profile-testing]
tags: [knowledge, sprint-3, test-design]
---

# Profile Testing

**Purpose:** Verify profile-level app, object, and field access still required by the story.
...
Legacy profile-based designs (prefer confirming permission sets).

## Guidance

- CRUD/FLS per profile in scope.
- Recommend PS over profile when advising improvements.
