---
title: Sharing Security Testing
...
keywords: [sharing-security]
tags: [knowledge, sprint-3, test-design]
---

# Sharing Security Testing

**Purpose:** Verify OWD, sharing rules, teams, and manual sharing behaviour.
...
Record visibility changes, Experience users, private OWD.

## Guidance

- Persona A sees / does not see record.
