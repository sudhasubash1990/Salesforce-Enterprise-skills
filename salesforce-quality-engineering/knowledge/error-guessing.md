...
keywords: [error-guessing]
tags: [knowledge, sprint-3, test-design]
---

# Error Guessing

**Purpose:** Use experience to target historically failure-prone areas.
...
Sharing surprises, Flow order, partial saves, duplicate rules.

## Guidance

- Document hypothesized defects as scenario objectives.
- Prefer evidence from prior defects when available.
