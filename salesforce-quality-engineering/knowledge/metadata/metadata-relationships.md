...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-relationships.md
...
keywords: [metadata-relationships, salesforce, quality-engineering, platform-foundation]
...
Explain reference graphs (field→VR→Flow→Layout→Report) for regression neighbor discovery.
...
- **Previous:** [Deployment Considerations](deployment-considerations.md)
- **Next:** [Configuration vs Customization](configuration-vs-customization.md)
