...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-validation.md
...
keywords: [metadata-validation, salesforce, quality-engineering, platform-foundation]
...
Define validation evidence: compile, retrieve, smoke journeys, permission spot checks.
...
- **Previous:** [Metadata Migration](metadata-migration.md)
- **Next:** [Metadata Best Practices](metadata-best-practices.md)
