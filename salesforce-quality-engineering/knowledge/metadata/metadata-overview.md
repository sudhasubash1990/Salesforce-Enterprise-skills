...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-overview.md
...
keywords: [metadata-overview, salesforce, quality-engineering, platform-foundation]
...
Teach QE to think in metadata types for coverage and deploy risk.
...
- **Next:** [Metadata Types](metadata-types.md)
