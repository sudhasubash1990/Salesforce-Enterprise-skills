...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-risks.md
...
keywords: [metadata-risks, salesforce, quality-engineering, platform-foundation]
...
Catalog high-frequency metadata risks for RAID and test planning.
...
- Partial deploy leaving inconsistent state
- Profile/FLS omitted from package
- Hard-coded IDs in Flow/Apex
...
- **Previous:** [Metadata Best Practices](metadata-best-practices.md)
