...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-best-practices.md
...
keywords: [metadata-best-practices, salesforce, quality-engineering, platform-foundation]
...
Document practices that reduce defect escape: naming, inactive cleanup, env parity.
...
- **Previous:** [Metadata Validation](metadata-validation.md)
- **Next:** [Metadata Risks](metadata-risks.md)
