...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-migration.md
...
keywords: [metadata-migration, salesforce, quality-engineering, platform-foundation]
...
Validate promotion path, dependency order, and post-migrate functional checks.
...
- **Previous:** [Metadata Comparison](metadata-comparison.md)
- **Next:** [Metadata Validation](metadata-validation.md)
