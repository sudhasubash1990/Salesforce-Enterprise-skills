...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-dependencies.md
...
keywords: [metadata-dependencies, salesforce, quality-engineering, platform-foundation]
...
Highlight broken references, inactive versions, and cross-component dependency failures.
...
- **Previous:** [Metadata Types](metadata-types.md)
- **Next:** [Deployment Considerations](deployment-considerations.md)
