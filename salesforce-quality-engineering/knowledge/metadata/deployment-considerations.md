...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/deployment-considerations.md
...
keywords: [deployment-considerations, salesforce, quality-engineering, platform-foundation]
...
Connect deployment mechanics to smoke, PPV, and Go/No-Go evidence.
...
- Validate deploy success AND functional smoke
- Confirm profiles/permission sets and assignments if in package
- Watch for destructive changes and renamed API names
...
- **Previous:** [Metadata Dependencies](metadata-dependencies.md)
- **Next:** [Metadata Relationships](metadata-relationships.md)
