...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/regression-impact-analysis.md
...
keywords: [regression-impact-analysis, salesforce, quality-engineering, platform-foundation]
...
Translate metadata impact into In/Out/Conditional regression packs.
...
- **Previous:** [Metadata Testing Strategy](metadata-testing-strategy.md)
- **Next:** [Metadata Comparison](metadata-comparison.md)
