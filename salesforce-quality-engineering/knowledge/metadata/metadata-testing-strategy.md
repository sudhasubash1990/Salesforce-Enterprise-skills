...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-testing-strategy.md
...
keywords: [metadata-testing-strategy, salesforce, quality-engineering, platform-foundation]
...
Define layered strategy: static review, config validation, functional, persona, regression.
...
- **Previous:** [Metadata Impact Analysis](metadata-impact-analysis.md)
- **Next:** [Regression Impact Analysis](regression-impact-analysis.md)
