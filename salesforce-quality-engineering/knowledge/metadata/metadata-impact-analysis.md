...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-impact-analysis.md
...
keywords: [metadata-impact-analysis, salesforce, quality-engineering, platform-foundation]
...
Provide a repeatable impact model from metadata diff to test scope.
...
- [Regression Impact Analysis](regression-impact-analysis.md)
...
- **Previous:** [Configuration vs Customization](configuration-vs-customization.md)
- **Next:** [Metadata Testing Strategy](metadata-testing-strategy.md)
