...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/configuration-vs-customization.md
...
keywords: [configuration-vs-customization, salesforce, quality-engineering, platform-foundation]
tags: [knowledge, sprint-4a, metadata]
---
...
Guide QE on risk/depth differences between declarative config and code customization.
...
- Classify Standard / Config / Extend / Gap for each need (align with BA fit-gap language)
- Custom Apex generally needs stronger negative, bulk, and regression coverage
...
- **Previous:** [Metadata Relationships](metadata-relationships.md)
- **Next:** [Metadata Impact Analysis](metadata-impact-analysis.md)
