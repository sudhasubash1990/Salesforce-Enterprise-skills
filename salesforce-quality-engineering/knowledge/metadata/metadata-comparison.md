...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-comparison.md
...
keywords: [metadata-comparison, salesforce, quality-engineering, platform-foundation]
...
Use comparison (manifest diffs, DevOps center, unlocked package diffs) as QE input—not as pass/fail alone.
...
- **Previous:** [Regression Impact Analysis](regression-impact-analysis.md)
- **Next:** [Metadata Migration](metadata-migration.md)
