...
related_documents:
  - salesforce-quality-engineering/knowledge/metadata/metadata-types.md
...
keywords: [metadata-types, salesforce, quality-engineering, platform-foundation]
...
Catalog major metadata types QE must recognize in impact analysis.
...
- **Previous:** [Metadata Overview](metadata-overview.md)
- **Next:** [Metadata Dependencies](metadata-dependencies.md)
