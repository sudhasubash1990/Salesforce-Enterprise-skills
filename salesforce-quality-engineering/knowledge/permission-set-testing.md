...
keywords: [permission-set-testing]
tags: [knowledge, sprint-3, test-design]
---

# Permission Set Testing

**Purpose:** Verify permission sets/groups grant and revoke intended capabilities.
...
Modern FLS/capability model.

## Guidance

- Assigned vs unassigned persona.
- Group bundling side effects.
