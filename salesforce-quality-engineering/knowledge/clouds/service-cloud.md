...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/service-cloud.md
...
keywords: [service-cloud, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, clouds]
---
...
Cover Case lifecycle, Omni-Channel, entitlements, Knowledge from a QE lens.
...
- Case, Entitlement, Milestone, Knowledge
- Omni-Channel, macros, service console
- Assignment/escalation/auto-response rules
...
- [../../../salesforce-business-analyst/knowledge/service-cloud-patterns.md](../../../salesforce-business-analyst/knowledge/service-cloud-patterns.md) (BA—do not duplicate)
...
- **Previous:** [Sales Cloud](sales-cloud.md)
