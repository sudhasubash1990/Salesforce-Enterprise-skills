...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/experience-cloud.md
...
keywords: [experience-cloud, salesforce, quality-engineering, enterprise]
...
Test persona access, guest vs authenticated, sharing, and branded journeys.
...
- Guest user oversharing is a top enterprise risk
- Profile/permission set assignment on self-registration

## Production Risks

- Broken public pages after deploy
- Incorrect record visibility for partners/customers
...
- **Previous:** [Service Cloud](service-cloud.md)
