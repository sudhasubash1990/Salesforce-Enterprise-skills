...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/health-cloud.md
...
keywords: [health-cloud, salesforce, quality-engineering, enterprise]
...
Overview of care/patient-adjacent CRM patterns; PHI/HIPAA constraints are Legal-confirmed.
...
- Access control and audit evidence are primary QE themes
- Do not invent clinical workflows
...
- **Previous:** [Financial Services Cloud](financial-services-cloud.md)
- **Next:** [Education Cloud](education-cloud.md)
