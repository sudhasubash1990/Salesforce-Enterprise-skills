...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/marketing-cloud.md
...
keywords: [marketing-cloud, salesforce, quality-engineering, enterprise]
...
Functional overview for CRM sync, journeys, and consent touchpoints—not full MC admin.
...
- Focus QE on CRM connector sync, journey entry, and consent flags touching Salesforce data
- Defer deep Studio configuration to marketing specialists
...
- **Previous:** [Revenue Cloud / CPQ](revenue-cloud-cpq.md)
- **Next:** [Data Cloud](data-cloud.md)
