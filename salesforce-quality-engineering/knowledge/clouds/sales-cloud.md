...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/sales-cloud.md
...
keywords: [sales-cloud, salesforce, quality-engineering, enterprise]
...
QE guidance for Sales Cloud journeys, objects, and enterprise regression hotspots.
...
- Lead capture → qualify → opportunity → quote/order handoff
- Sales managers forecast; ops govern stages

## Key Components

- Lead, Account, Contact, Opportunity, Quote, Product, Price Book
- Path, forecasting, activities
- Sharing/teams often critical
...
- [Revenue Cloud / CPQ](revenue-cloud-cpq.md)
...
- **Next:** [Service Cloud](service-cloud.md)
