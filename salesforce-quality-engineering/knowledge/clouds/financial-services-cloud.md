...
related_documents:
  - salesforce-quality-engineering/knowledge/clouds/financial-services-cloud.md
...
keywords: [financial-services-cloud, salesforce, quality-engineering, enterprise]
...
Overview of Financial Services Cloud patterns; confirm regulatory constraints with Compliance.
...
- Never invent KYC/AML/regulatory rules—mark TBC with Legal/Compliance
...
- **Previous:** [Omnistudio](omnistudio.md)
- **Next:** [Health Cloud](health-cloud.md)
