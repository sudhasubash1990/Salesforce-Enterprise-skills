...
related_documents:
  - salesforce-quality-engineering/knowledge/security/audit-trail.md
...
Use Setup Audit Trail as investigation/deploy evidence—not as functional AC alone.
...
- [../data/audit-trail.md](../data/audit-trail.md)
...
- **Previous:** [MFA](mfa.md)
- **Next:** [Login History](login-history.md)
