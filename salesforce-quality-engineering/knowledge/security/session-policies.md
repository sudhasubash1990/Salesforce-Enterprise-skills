...
related_documents:
  - salesforce-quality-engineering/knowledge/security/session-policies.md
...
keywords: [session-policies, salesforce, quality-engineering, platform-foundation]
...
Confirm session timeout and high-assurance session requirements.
...
- **Previous:** [Login Policies](login-policies.md)
- **Next:** [MFA](mfa.md)
