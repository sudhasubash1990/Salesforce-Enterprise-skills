...
related_documents:
  - salesforce-quality-engineering/knowledge/security/organization-wide-defaults.md
...
keywords: [organization-wide-defaults, salesforce, quality-engineering, platform-foundation]
...
Treat OWD changes as high regression risk across the org.
...
- **Previous:** [Queues](queues.md)
- **Next:** [Restriction Rules](restriction-rules.md)
