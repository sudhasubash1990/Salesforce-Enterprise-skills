...
related_documents:
  - salesforce-quality-engineering/knowledge/security/territory-management.md
...
keywords: [territory-management, salesforce, quality-engineering, platform-foundation]
...
Overview of territory-based visibility for QE impact (confirm licensed model).
...
- Territory models affect Account/Opportunity visibility in many sales orgs
- Confirm Enterprise Territory Management vs legacy—do not invent model details
...
- User in/out of territory
- Account alignment changes
- Forecast/visibility side effects
...
- **Previous:** [Restriction Rules](restriction-rules.md)
- **Next:** [Login Policies](login-policies.md)
