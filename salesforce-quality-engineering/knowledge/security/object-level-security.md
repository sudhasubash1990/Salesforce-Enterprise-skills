...
related_documents:
  - salesforce-quality-engineering/knowledge/security/object-level-security.md
...
keywords: [object-level-security, salesforce, quality-engineering, platform-foundation]
...
Validate object-level CRUD and escalate View All/Modify All as high risk.
...
- **Previous:** [Field Level Security](field-level-security.md)
- **Next:** [Role Hierarchy](role-hierarchy.md)
