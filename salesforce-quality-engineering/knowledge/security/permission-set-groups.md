...
related_documents:
  - salesforce-quality-engineering/knowledge/security/permission-set-groups.md
...
keywords: [permission-set-groups, salesforce, quality-engineering, platform-foundation]
...
Test mute permissions and persona packaging via groups.
...
- **Next:** [Field Level Security](field-level-security.md)
