...
related_documents:
  - salesforce-quality-engineering/knowledge/security/mfa.md
...
keywords: [mfa, salesforce, quality-engineering, platform-foundation]
...
Validate MFA enforcement, exemptions, and break-glass for test users.
...
- **Previous:** [Session Policies](session-policies.md)
