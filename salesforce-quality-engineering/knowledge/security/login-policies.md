...
related_documents:
  - salesforce-quality-engineering/knowledge/security/login-policies.md
...
keywords: [login-policies, salesforce, quality-engineering, platform-foundation]
...
Validate login restrictions without locking out test/integration users unexpectedly.
...
- **Previous:** [Territory Management](territory-management.md)
- **Next:** [Session Policies](session-policies.md)
