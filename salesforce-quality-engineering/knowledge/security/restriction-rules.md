...
related_documents:
  - salesforce-quality-engineering/knowledge/security/restriction-rules.md
...
keywords: [restriction-rules, salesforce, quality-engineering, platform-foundation]
...
Test restriction filters and coexistence with sharing grants.
...
- **Previous:** [Organization-Wide Defaults](organization-wide-defaults.md)
- **Next:** [Territory Management](territory-management.md)
