...
related_documents:
  - salesforce-quality-engineering/knowledge/security/sharing-rules.md
...
keywords: [sharing-rules, salesforce, quality-engineering, platform-foundation]
...
Test share expansion/revocation when criteria change.
...
- [../sharing-security-testing.md](../sharing-security-testing.md)
...
- **Previous:** [Role Hierarchy](role-hierarchy.md)
- **Next:** [Manual Sharing](manual-sharing.md)
