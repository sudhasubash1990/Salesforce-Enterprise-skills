...
related_documents:
  - salesforce-quality-engineering/knowledge/security/queues.md
...
keywords: [queues, salesforce, quality-engineering, platform-foundation]
...
Test queue membership, assignment, and access to queued records.
...
- **Previous:** [Public Groups](public-groups.md)
- **Next:** [Organization-Wide Defaults](organization-wide-defaults.md)
