...
related_documents:
  - salesforce-quality-engineering/knowledge/security/permission-sets.md
...
keywords: [permission-sets, salesforce, quality-engineering, platform-foundation]
...
Validate assignment/revoke effects and additive grants.
...
- [../permission-set-testing.md](../permission-set-testing.md)
...
- **Next:** [Permission Set Groups](permission-set-groups.md)
