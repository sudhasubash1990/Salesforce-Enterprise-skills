...
related_documents:
  - salesforce-quality-engineering/knowledge/security/field-history-tracking.md
...
Validate tracked fields and history visibility for audit scenarios.
...
- [../data/field-history-tracking.md](../data/field-history-tracking.md)
...
- **Previous:** [Login History](login-history.md)
