...
related_documents:
  - salesforce-quality-engineering/knowledge/security/manual-sharing.md
...
keywords: [manual-sharing, salesforce, quality-engineering, platform-foundation]
...
Confirm manual share create/revoke and UI availability.
...
- **Next:** [Public Groups](public-groups.md)
