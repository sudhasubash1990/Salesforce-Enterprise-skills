...
**Purpose:** Verify Salesforce features behave against stated functional requirements and AC.
...
Most story-level design after requirement analysis.

## Guidance

- Trace scenarios to AC/rules.
- Combine positive/negative/permission as needed.
- Prefer platform-observable outcomes.
