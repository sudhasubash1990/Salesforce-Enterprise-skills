...
related_documents:
  - salesforce-quality-engineering/knowledge/release/feature-toggles.md
...
keywords: [feature-toggles, salesforce, quality-engineering, enterprise]
...
Overview of toggle-driven release testing (on/off, partial cohorts).
...
- **Previous:** [Environment Refresh](environment-refresh.md)
