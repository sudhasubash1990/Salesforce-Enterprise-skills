...
related_documents:
  - salesforce-quality-engineering/knowledge/release/rollback-strategy.md
...
keywords: [rollback-strategy, salesforce, quality-engineering, enterprise]
...
Validate backout plan tests: data integrity and feature restore.
...
- **Previous:** [Go / No-Go Decision](go-no-go-decision.md)
- **Next:** [Cutover Planning](cutover-planning.md)
