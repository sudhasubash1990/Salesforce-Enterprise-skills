...
related_documents:
  - salesforce-quality-engineering/knowledge/release/go-no-go-decision.md
...
keywords: [go-no-go-decision, salesforce, quality-engineering, enterprise]
...
Structure Go/No-Go recommendation from test evidence and residual risk.
