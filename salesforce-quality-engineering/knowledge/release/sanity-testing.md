...
related_documents:
  - salesforce-quality-engineering/knowledge/release/sanity-testing.md
...
keywords: [sanity-testing, salesforce, quality-engineering, enterprise]
...
Targeted sanity around the change vs full regression.
...
- [../sanity-testing.md](../sanity-testing.md)
...
- **Next:** [Regression Planning](regression-planning.md)
