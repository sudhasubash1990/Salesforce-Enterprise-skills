...
related_documents:
  - salesforce-quality-engineering/knowledge/release/devops-center.md
...
keywords: [devops-center, salesforce, quality-engineering, enterprise]
...
QE use of work items/pipelines as impact and evidence inputs.
...
- **Previous:** [Change Sets](change-sets.md)
- **Next:** [CI/CD Overview](ci-cd-overview.md)
