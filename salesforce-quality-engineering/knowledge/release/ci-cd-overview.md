...
related_documents:
  - salesforce-quality-engineering/knowledge/release/ci-cd-overview.md
...
keywords: [ci-cd-overview, salesforce, quality-engineering, enterprise]
...
Where automated quality gates fit; what remains manual/UAT.
...
- **Previous:** [Devops Center](devops-center.md)
