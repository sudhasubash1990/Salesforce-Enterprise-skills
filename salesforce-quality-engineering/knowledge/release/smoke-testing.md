...
related_documents:
  - salesforce-quality-engineering/knowledge/release/smoke-testing.md
...
keywords: [smoke-testing, salesforce, quality-engineering, enterprise]
...
Minimal critical-path confidence after deploy.
...
- **Previous:** [Post Deployment Validation](post-deployment-validation.md)
