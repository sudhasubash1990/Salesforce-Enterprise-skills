...
related_documents:
  - salesforce-quality-engineering/knowledge/release/release-planning.md
...
keywords: [release-planning, salesforce, quality-engineering, enterprise]
...
Define QE inputs to release plans: scope, risk, environments, evidence.
...
- **Next:** [Deployment Strategy](deployment-strategy.md)
