...
related_documents:
  - salesforce-quality-engineering/knowledge/release/environment-refresh.md
...
keywords: [environment-refresh, salesforce, quality-engineering, enterprise]
...
Validate post-refresh reconfig, credentials, and smoke after refresh.
...
- **Previous:** [Environment Strategy](environment-strategy.md)
- **Next:** [Feature Toggles](feature-toggles.md)
