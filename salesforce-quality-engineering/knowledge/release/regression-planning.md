...
related_documents:
  - salesforce-quality-engineering/knowledge/release/regression-planning.md
...
keywords: [regression-planning, salesforce, quality-engineering, enterprise]
...
Release-level regression packs and risk-based selection.
...
- **Previous:** [Sanity Testing](sanity-testing.md)
