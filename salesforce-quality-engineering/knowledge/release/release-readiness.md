...
related_documents:
  - salesforce-quality-engineering/knowledge/release/release-readiness.md
...
keywords: [release-readiness, salesforce, quality-engineering, enterprise]
...
Evidence checklist for exit criteria, open risks, and sign-off inputs.
...
- **Previous:** [Regression Planning](regression-planning.md)
- **Next:** [Go / No-Go Decision](go-no-go-decision.md)
