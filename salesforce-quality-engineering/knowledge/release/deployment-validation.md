...
related_documents:
  - salesforce-quality-engineering/knowledge/release/deployment-validation.md
...
keywords: [deployment-validation, salesforce, quality-engineering, enterprise]
...
Evidence for successful metadata/data deploy validation.
...
- **Previous:** [CI/CD Overview](ci-cd-overview.md)
- **Next:** [Post Deployment Validation](post-deployment-validation.md)
