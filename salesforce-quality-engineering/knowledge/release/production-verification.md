...
related_documents:
  - salesforce-quality-engineering/knowledge/release/production-verification.md
...
keywords: [production-verification, salesforce, quality-engineering, enterprise]
...
Post-go-live verification themes distinct from full UAT re-run.
...
- **Previous:** [Hypercare](hypercare.md)
