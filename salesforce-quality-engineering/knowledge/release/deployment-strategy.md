...
related_documents:
  - salesforce-quality-engineering/knowledge/release/deployment-strategy.md
...
keywords: [deployment-strategy, salesforce, quality-engineering, enterprise]
...
How deploy approach (big-bang, phased, toggle) changes test strategy.
...
- **Previous:** [Release Planning](release-planning.md)
- **Next:** [Change Sets](change-sets.md)
