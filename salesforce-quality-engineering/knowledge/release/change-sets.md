...
related_documents:
  - salesforce-quality-engineering/knowledge/release/change-sets.md
...
keywords: [change-sets, salesforce, quality-engineering, enterprise]
...
QE risks with change sets: omissions, order, and validation gaps.
...
- **Previous:** [Deployment Strategy](deployment-strategy.md)
- **Next:** [Devops Center](devops-center.md)
