...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/large-data-volumes.md
...
keywords: [large-data-volumes, salesforce, quality-engineering, enterprise]
...
Plan LDV for list views, roll-ups, sharing, batches, and reports.
...
- **Previous:** [Batch Processing](batch-processing.md)
- **Next:** [Record Locking](record-locking.md)
