...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/concurrent-users.md
...
keywords: [concurrent-users, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Concurrent Users

**Purpose:** Design concurrency scenarios for queues, inventory, approvals.
...
Design concurrency scenarios for queues, inventory, approvals.
...
- **Previous:** [Record Locking](record-locking.md)
- **Next:** [Report Performance](report-performance.md)
