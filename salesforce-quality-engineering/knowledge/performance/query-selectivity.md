...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/query-selectivity.md
...
keywords: [query-selectivity, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Query Selectivity

**Purpose:** Advise selective filter tests and LDV query plans.
...
Advise selective filter tests and LDV query plans.
...
- **Previous:** [SOQL Performance](soql-performance.md)
- **Next:** [Indexing Concepts](indexing-concepts.md)
