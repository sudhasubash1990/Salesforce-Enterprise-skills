...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/integration-performance.md
...
keywords: [integration-performance, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Integration Performance

**Purpose:** Latency, throughput, and backpressure across integrations.
...
Latency, throughput, and backpressure across integrations.
...
- **Previous:** [Dashboard Performance](dashboard-performance.md)
- **Next:** [Performance Testing Considerations](performance-testing-considerations.md)
