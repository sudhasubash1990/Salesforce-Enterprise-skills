...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/batch-processing.md
...
keywords: [batch-processing, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Batch Processing

**Purpose:** Measure throughput, chunk failures, and restart behaviour.
...
Measure throughput, chunk failures, and restart behaviour.
...
- **Previous:** [Flow Performance](flow-performance.md)
