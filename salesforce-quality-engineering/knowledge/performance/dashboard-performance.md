...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/dashboard-performance.md
...
keywords: [dashboard-performance, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Dashboard Performance

**Purpose:** Validate running user, component load, and refresh behaviour under load.
...
Validate running user, component load, and refresh behaviour under load.
...
- **Previous:** [Report Performance](report-performance.md)
- **Next:** [Integration Performance](integration-performance.md)
