...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/scalability.md
...
keywords: [scalability, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Scalability

**Purpose:** Growth in users/data/transactions—what QE should evidence.
...
Growth in users/data/transactions—what QE should evidence.
...
- **Previous:** [Performance Testing Considerations](performance-testing-considerations.md)
- **Next:** [Performance Risks](performance-risks.md)
