...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/record-locking.md
...
keywords: [record-locking, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Record Locking

**Purpose:** Reproduce and mitigate lock contention in parallel updates.
...
Reproduce and mitigate lock contention in parallel updates.
...
- **Previous:** [Large Data Volumes](large-data-volumes.md)
- **Next:** [Concurrent Users](concurrent-users.md)
