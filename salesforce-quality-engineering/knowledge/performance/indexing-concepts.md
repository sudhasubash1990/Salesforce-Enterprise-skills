...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/indexing-concepts.md
...
keywords: [indexing-concepts, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Indexing Concepts

**Purpose:** QE awareness of selective fields/indexes—flag architecture needs to SA.
...
QE awareness of selective fields/indexes—flag architecture needs to SA.
...
- **Previous:** [Query Selectivity](query-selectivity.md)
- **Next:** [Flow Performance](flow-performance.md)
