...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/report-performance.md
...
keywords: [report-performance, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, performance]
---

# Report Performance

**Purpose:** Identify timeout risks and filter/index mitigations.
...
Identify timeout risks and filter/index mitigations.
...
- **Previous:** [Concurrent Users](concurrent-users.md)
- **Next:** [Dashboard Performance](dashboard-performance.md)
