...
related_documents:
  - salesforce-quality-engineering/knowledge/performance/governor-limits.md
...
keywords: [governor-limits, salesforce, quality-engineering, enterprise]
...
Teach which limits matter in scenarios and how failures present.
...
- [Platform 4A](../platform/README.md)
...
- **Next:** [SOQL Performance](soql-performance.md)
