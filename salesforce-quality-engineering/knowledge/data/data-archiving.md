...
related_documents:
  - salesforce-quality-engineering/knowledge/data/data-archiving.md
...
keywords: [data-archiving, salesforce, quality-engineering, platform-foundation]
...
Validate archive criteria, access to archived data, and reporting impact.
...
- **Previous:** [Recycle Bin](recycle-bin.md)
- **Next:** [Data Retention](data-retention.md)
