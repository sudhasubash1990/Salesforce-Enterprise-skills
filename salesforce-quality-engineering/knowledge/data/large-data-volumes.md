...
related_documents:
  - salesforce-quality-engineering/knowledge/data/large-data-volumes.md
...
keywords: [large-data-volumes, salesforce, quality-engineering, platform-foundation]
...
Plan LDV scenarios for queries, sharing, roll-ups, batches, and list views.
...
- Selective filters
- Skinny tables/indexes are architecture topics—flag for SA
- Avoid unrealistic full-org clones as the only strategy
...
- [../performance/large-data-volumes.md](../performance/large-data-volumes.md)
...
- **Previous:** [Referential Integrity](referential-integrity.md)
