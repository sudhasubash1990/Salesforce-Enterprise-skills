...
related_documents:
  - salesforce-quality-engineering/knowledge/data/data-masking.md
...
keywords: [data-masking, salesforce, quality-engineering, platform-foundation]
...
Validate masking completeness for sensitive data and broken-reference risks.
...
- **Previous:** [Test Data Management](test-data-management.md)
- **Next:** [PII Considerations](pii-considerations.md)
