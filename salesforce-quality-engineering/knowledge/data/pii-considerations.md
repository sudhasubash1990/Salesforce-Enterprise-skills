...
related_documents:
  - salesforce-quality-engineering/knowledge/data/pii-considerations.md
...
keywords: [pii-considerations, salesforce, quality-engineering, platform-foundation]
tags: [knowledge, sprint-4a, data]
---
...
Guide PII minimization in test data and evidence packs; confirm classifications with the program.
...
- Never put real PII in prompts, repos, or shared evidence without approval
- Prefer synthetic or masked data in lower environments
...
- **Previous:** [Data Masking](data-masking.md)
- **Next:** [GDPR Awareness](gdpr-awareness.md)
