...
related_documents:
  - salesforce-quality-engineering/knowledge/data/data-loader.md
...
keywords: [data-loader, salesforce, quality-engineering, platform-foundation]
tags: [knowledge, sprint-4a, data]
---

# Data Loader

**Purpose:** Test upsert keys, error CSVs, and batch sizes.
...
Test upsert keys, error CSVs, and batch sizes.
...
- **Previous:** [Data Export](data-export.md)
- **Next:** [Duplicate Rules](duplicate-rules.md)
