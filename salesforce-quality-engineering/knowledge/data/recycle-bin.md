...
related_documents:
  - salesforce-quality-engineering/knowledge/data/recycle-bin.md
...
keywords: [recycle-bin, salesforce, quality-engineering, platform-foundation]
...
Test delete → recycle bin → restore integrity and related-record behaviour.
...
- Restore without parent
- Hard delete irreversibility where applicable
...
- **Previous:** [Audit Trail](audit-trail.md)
- **Next:** [Data Archiving](data-archiving.md)
