...
related_documents:
  - salesforce-quality-engineering/knowledge/data/referential-integrity.md
...
keywords: [referential-integrity, salesforce, quality-engineering, platform-foundation]
...
Validate relationship constraints, orphans, and cascade behaviour.
...
- [../platform/lookup-relationships.md](../platform/lookup-relationships.md)
- [../platform/master-detail-relationships.md](../platform/master-detail-relationships.md)
...
- **Previous:** [Data Integrity](data-integrity.md)
- **Next:** [Large Data Volumes](large-data-volumes.md)
