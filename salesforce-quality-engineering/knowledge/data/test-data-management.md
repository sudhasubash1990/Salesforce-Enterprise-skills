...
related_documents:
  - salesforce-quality-engineering/knowledge/data/test-data-management.md
...
keywords: [test-data-management, salesforce, quality-engineering, platform-foundation]
...
Advise synthetic vs masked data, referential integrity, and persona packs.
...
- **Previous:** [Data Reconciliation](data-reconciliation.md)
- **Next:** [Data Masking](data-masking.md)
