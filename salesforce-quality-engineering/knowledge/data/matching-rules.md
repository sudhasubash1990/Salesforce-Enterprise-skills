...
related_documents:
  - salesforce-quality-engineering/knowledge/data/matching-rules.md
...
keywords: [matching-rules, salesforce, quality-engineering, platform-foundation]
...
Data-quality view of matching accuracy and migration false matches.
...
- [../automation/matching-rules.md](../automation/matching-rules.md)
...
- **Previous:** [Duplicate Rules](duplicate-rules.md)
- **Next:** [Field History Tracking](field-history-tracking.md)
