...
related_documents:
  - salesforce-quality-engineering/knowledge/data/audit-trail.md
...
keywords: [audit-trail, salesforce, quality-engineering, platform-foundation]
...
Evidence setup changes affecting data behaviour.
...
- **Previous:** [Field History Tracking](field-history-tracking.md)
- **Next:** [Recycle Bin](recycle-bin.md)
