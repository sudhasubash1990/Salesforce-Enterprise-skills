...
related_documents:
  - salesforce-quality-engineering/knowledge/data/gdpr-awareness.md
...
keywords: [gdpr-awareness, salesforce, quality-engineering, platform-foundation]
...
Awareness-only: subject rights and retention themes affecting test design—confirm with Legal; do not invent legal advice.
...
- Flag stories implying erasure, export, or consent without Legal confirmation
- Mark regulatory claims as TBC with Compliance
...
- **Previous:** [PII Considerations](pii-considerations.md)
- **Next:** [Data Integrity](data-integrity.md)
