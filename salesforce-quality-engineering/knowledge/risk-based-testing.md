...
keywords: [risk-based-testing]
tags: [knowledge, sprint-3, test-design]
---

# Risk-Based Testing

**Purpose:** Allocate depth by business/technical risk, not equal effort.
...
Always—especially under schedule pressure.

## Guidance

| Priority | Meaning |
|----------|--------|
| Business Critical | Must pass for release confidence |
| High | Core AC / primary path |
| Medium | Important variants |
| Low | Deferable |

Tie to [requirement-risk-analysis.md](requirement-risk-analysis.md). Explain why.
