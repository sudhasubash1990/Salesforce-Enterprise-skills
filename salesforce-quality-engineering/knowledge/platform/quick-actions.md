...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/quick-actions.md
...
keywords: [quick-actions, salesforce, quality-engineering, platform-foundation]
...
Test action field sets, prefill, publisher layout, and success behaviour.
...
- **Previous:** [Compact Layouts](compact-layouts.md)
- **Next:** [Global Actions](global-actions.md)
