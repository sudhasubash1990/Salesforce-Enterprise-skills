...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/external-objects.md
...
keywords: [external-objects, salesforce, quality-engineering, platform-foundation]
...
Test availability, latency, CRUD limits, and auth failure modes.
...
- **Previous:** [Roll Up Summary Fields](roll-up-summary-fields.md)
- **Next:** [Big Objects](big-objects.md)
