...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/compact-layouts.md
...
keywords: [compact-layouts, salesforce, quality-engineering, platform-foundation]
...
Confirm compact fields support triage without leaking restricted data.
...
- **Previous:** [Lightning Record Pages](lightning-record-pages.md)
- **Next:** [Quick Actions](quick-actions.md)
