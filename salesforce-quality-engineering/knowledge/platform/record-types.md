...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/record-types.md
...
keywords: [record-types, salesforce, quality-engineering, platform-foundation]
...
Test record-type assignment, picklist subsets, layouts, and process differences.
...
- **Previous:** [Master Detail Relationships](master-detail-relationships.md)
- **Next:** [Business Processes](business-processes.md)
