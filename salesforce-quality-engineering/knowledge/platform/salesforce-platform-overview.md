...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/salesforce-platform-overview.md
...
keywords: [salesforce-platform-overview, salesforce, quality-engineering, platform-foundation]
...
Give QE a coherent mental model of Salesforce so every requirement maps to objects, UI, automation, security, data, and integrations.
...
- [Metadata-Driven Architecture](metadata-driven-architecture.md)
