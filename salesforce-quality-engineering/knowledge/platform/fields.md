...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/fields.md
...
keywords: [fields, salesforce, quality-engineering, platform-foundation]
...
Map field requirements to validation, FLS, layout, formula, and history tracking.
...
- Max length, precision/scale, unique/external ID collisions
- Picklist restricted vs unrestricted
- Default value vs null on API insert
...
- **Previous:** [Custom Objects](custom-objects.md)
