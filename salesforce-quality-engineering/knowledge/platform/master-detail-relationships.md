...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/master-detail-relationships.md
...
keywords: [master-detail-relationships, salesforce, quality-engineering, platform-foundation]
...
Validate ownership cascade, roll-up eligibility, and cascade delete risk.
...
- Child access often inherits master—validate persona visibility carefully
...
- [Roll-Up Summary Fields](roll-up-summary-fields.md)
...
- **Previous:** [Lookup Relationships](lookup-relationships.md)
- **Next:** [Record Types](record-types.md)
