...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/big-objects.md
...
keywords: [big-objects, salesforce, quality-engineering, platform-foundation]
...
Validate insert/query patterns and reporting limitations.
...
- **Previous:** [External Objects](external-objects.md)
- **Next:** [Custom Metadata Types](custom-metadata-types.md)
