...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/custom-metadata-types.md
...
keywords: [custom-metadata-types, salesforce, quality-engineering, platform-foundation]
...
Treat CMDT as testable configuration consumed by automation.
...
- Missing CMDT in lower envs
- Package upgrade value changes
...
- **Previous:** [Big Objects](big-objects.md)
- **Next:** [Custom Settings](custom-settings.md)
