...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/global-actions.md
...
keywords: [global-actions, salesforce, quality-engineering, platform-foundation]
...
Validate global action availability, defaults, and permission prerequisites.
...
- **Previous:** [Quick Actions](quick-actions.md)
- **Next:** [Formula Fields](formula-fields.md)
