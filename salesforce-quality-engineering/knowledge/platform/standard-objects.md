...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/standard-objects.md
...
keywords: [standard-objects, salesforce, quality-engineering, platform-foundation]
...
Guide QE on standard object semantics, extensions, and failure modes.
...
- **Previous:** [Metadata-Driven Architecture](metadata-driven-architecture.md)
- **Next:** [Custom Objects](custom-objects.md)
