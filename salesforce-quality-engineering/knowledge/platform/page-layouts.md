...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/page-layouts.md
...
keywords: [page-layouts, salesforce, quality-engineering, platform-foundation]
...
Verify layout-driven required fields and related lists per persona.
...
- [Lightning Record Pages](lightning-record-pages.md)
...
- **Previous:** [Business Processes](business-processes.md)
- **Next:** [Lightning Record Pages](lightning-record-pages.md)
