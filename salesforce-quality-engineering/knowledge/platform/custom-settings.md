...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/custom-settings.md
...
keywords: [custom-settings, salesforce, quality-engineering, platform-foundation]
...
Validate hierarchy overrides and environment seeding of settings.
...
- Prefer CMDT for new packaged config; document remaining custom settings debt
...
- **Previous:** [Custom Metadata Types](custom-metadata-types.md)
