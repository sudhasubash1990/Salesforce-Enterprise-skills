...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/roll-up-summary-fields.md
...
keywords: [roll-up-summary-fields, salesforce, quality-engineering, platform-foundation]
...
Validate roll-up filters, recalculation timing, and LDV risk.
...
- [Master-Detail Relationships](master-detail-relationships.md)
- [../data/large-data-volumes.md](../data/large-data-volumes.md)
...
- **Previous:** [Formula Fields](formula-fields.md)
- **Next:** [External Objects](external-objects.md)
