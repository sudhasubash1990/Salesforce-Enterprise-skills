...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/formula-fields.md
...
keywords: [formula-fields, salesforce, quality-engineering, platform-foundation]
...
Test formula correctness, null handling, and downstream consumers.
...
- Compile size / reference limits
- Avoid assuming real-time heavy cross-object formulas at LDV
...
- **Previous:** [Global Actions](global-actions.md)
- **Next:** [Roll Up Summary Fields](roll-up-summary-fields.md)
