...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/lookup-relationships.md
...
keywords: [lookup-relationships, salesforce, quality-engineering, platform-foundation]
...
Validate optional/required lookups, filters, and delete constraints.
...
- Lookup filter true/false paths
- Clearing optional lookup
- Related list visibility

## Negative Testing

- Invalid Id
- Lookup filter blocks intended parent
- Delete parent when children exist (per setting)
...
- **Next:** [Master Detail Relationships](master-detail-relationships.md)
