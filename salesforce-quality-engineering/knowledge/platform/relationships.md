...
related_documents:
  - salesforce-quality-engineering/knowledge/platform/relationships.md
...
keywords: [relationships, salesforce, quality-engineering, platform-foundation]
...
Orient QE to relationship types before deep lookup/MD articles.
...
- [Lookup Relationships](lookup-relationships.md)
...
- **Previous:** [Fields](fields.md)
- **Next:** [Lookup Relationships](lookup-relationships.md)
