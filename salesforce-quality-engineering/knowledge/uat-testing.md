...
keywords: [uat-testing]
tags: [knowledge, sprint-3, test-design]
---

# UAT Testing

**Purpose:** Business-outcome validation by business users; QE enables readiness.
...
Pre-release business acceptance. Partner with BA UAT playbooks—do not replace BA ownership.

## Guidance

- Prefer business language scenarios.
- Cross-link BA UAT process; QE supplies coverage intent.
