...
**Purpose:** Verify contracts and failure modes across system boundaries.
...
APIs, middleware, platform events, ETL, email/SMS gateways.

## Guidance

- Success, timeout, retry, idempotency, dual-write risks.
- Pair with [api-testing.md](api-testing.md).
