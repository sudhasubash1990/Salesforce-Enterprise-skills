...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/testing-approach.md
...
keywords: [testing-approach, salesforce, quality-engineering]
...
Define data fixtures, expected aggregates, and persona checks for analytics.

## Business Context

- Testing Approach affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Testing Approach as a platform capability used across clouds and industries.
...
- Explain how you would test Testing Approach without jumping to click-paths first
- Describe risks, regression neighbors, and automation candidates with rationale

## Related Documents

- [Report Testing](../report-testing.md)
...
- **Previous:** [Subscriptions](subscriptions.md)
- **Next:** [Validation Strategy](validation-strategy.md)
