...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/joined-reports.md
...
keywords: [joined-reports, salesforce, quality-engineering]
...
Validate block filters and common dimension assumptions.

## Business Context

- Joined Reports affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Joined Reports as a platform capability used across clouds and industries.
...
- Explain how you would test Joined Reports without jumping to click-paths first
...
- **Previous:** [Report Types](report-types.md)
- **Next:** [Matrix Reports](matrix-reports.md)
