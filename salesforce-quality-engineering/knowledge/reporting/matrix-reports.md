...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/matrix-reports.md
...
keywords: [matrix-reports, salesforce, quality-engineering]
...
Test row/column groupings and grand totals against known datasets.

## Business Context

- Matrix Reports affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Matrix Reports as a platform capability used across clouds and industries.
...
- Explain how you would test Matrix Reports without jumping to click-paths first
...
- **Previous:** [Joined Reports](joined-reports.md)
- **Next:** [Summary Reports](summary-reports.md)
