...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/summary-reports.md
...
keywords: [summary-reports, salesforce, quality-engineering]
...
Validate groupings, summaries, and chart source data.

## Business Context

- Summary Reports affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Summary Reports as a platform capability used across clouds and industries.
...
- Explain how you would test Summary Reports without jumping to click-paths first
...
- **Previous:** [Matrix Reports](matrix-reports.md)
