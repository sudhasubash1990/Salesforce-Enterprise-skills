...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/scheduling.md
...
keywords: [scheduling, salesforce, quality-engineering]
...
Test schedule timing, recipients, and failure notification.

## Business Context

- Scheduling affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Scheduling as a platform capability used across clouds and industries.
...
- Explain how you would test Scheduling without jumping to click-paths first
