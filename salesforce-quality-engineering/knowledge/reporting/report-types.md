...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/report-types.md
...
keywords: [report-types, salesforce, quality-engineering]
...
Confirm CRT object joins and field availability match stakeholder needs.

## Business Context

- Report Types affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Report Types as a platform capability used across clouds and industries.
...
- Explain how you would test Report Types without jumping to click-paths first
...
- **Previous:** [Dashboards](dashboards.md)
- **Next:** [Joined Reports](joined-reports.md)
