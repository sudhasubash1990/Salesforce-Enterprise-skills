...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/dashboards.md
...
keywords: [dashboards, salesforce, quality-engineering]
...
Test dashboard running user, component filters, and refresh behaviour.

## Business Context

- Dashboards affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Dashboards as a platform capability used across clouds and industries.
...
- Explain how you would test Dashboards without jumping to click-paths first
...
- **Previous:** [Reports](reports.md)
- **Next:** [Report Types](report-types.md)
