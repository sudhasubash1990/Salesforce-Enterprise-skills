...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/validation-strategy.md
...
keywords: [validation-strategy, salesforce, quality-engineering]
...
Reconcile report output to SOQL/export or source-of-truth samples.

## Business Context

- Validation Strategy affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Validation Strategy as a platform capability used across clouds and industries.
...
- Explain how you would test Validation Strategy without jumping to click-paths first
...
- **Previous:** [Testing Approach](testing-approach.md)
- **Next:** [Common Risks](common-risks.md)
