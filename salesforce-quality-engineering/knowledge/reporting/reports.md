...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/reports.md
...
keywords: [reports, salesforce, quality-engineering]
...
Validate report filters, fields, folders, and persona visibility.

## Business Context

- Reports affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Reports as a platform capability used across clouds and industries.
...
- Explain how you would test Reports without jumping to click-paths first
