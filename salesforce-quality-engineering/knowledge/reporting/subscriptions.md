...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/subscriptions.md
...
keywords: [subscriptions, salesforce, quality-engineering]
...
Validate subscription recipients and attachment/link formats.

## Business Context

- Subscriptions affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Subscriptions as a platform capability used across clouds and industries.
...
- Explain how you would test Subscriptions without jumping to click-paths first
...
- **Previous:** [Scheduling](scheduling.md)
- **Next:** [Testing Approach](testing-approach.md)
