...
related_documents:
  - salesforce-quality-engineering/knowledge/reporting/charts.md
...
keywords: [charts, salesforce, quality-engineering]
...
Confirm chart type, axis fields, and filter interaction.

## Business Context

- Charts affects how business users complete journeys and how defects surface in production.
- QE must connect business outcomes to Salesforce configuration and automation behaviour.

## Salesforce Overview

- Salesforce provides Charts as a platform capability used across clouds and industries.
...
- Explain how you would test Charts without jumping to click-paths first
...
- **Previous:** [Summary Reports](summary-reports.md)
