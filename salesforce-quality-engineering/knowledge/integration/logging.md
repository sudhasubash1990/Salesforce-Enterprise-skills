...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/logging.md
...
keywords: [logging, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Logging

**Purpose:** What QE expects in logs for triage without exposing secrets/PII.
...
What QE expects in logs for triage without exposing secrets/PII.
