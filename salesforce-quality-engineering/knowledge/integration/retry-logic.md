...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/retry-logic.md
...
keywords: [retry-logic, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Retry Logic

**Purpose:** Validate retry limits, poison messages, and duplicate side effects.
...
Validate retry limits, poison messages, and duplicate side effects.
...
- **Next:** [Timeout Handling](timeout-handling.md)
