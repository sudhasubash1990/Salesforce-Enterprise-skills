...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/soap-apis.md
...
keywords: [soap-apis, salesforce, quality-engineering, enterprise]
...
Cover SOAP login, CRUD, and fault handling where still in use.
