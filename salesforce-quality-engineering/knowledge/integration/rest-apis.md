...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/rest-apis.md
...
keywords: [rest-apis, salesforce, quality-engineering, enterprise]
...
Guide REST contract, auth, status codes, and idempotency checks for QE.
