...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/external-services.md
...
keywords: [external-services, salesforce, quality-engineering, enterprise]
...
Validate External Service actions from Flow and error mapping.
