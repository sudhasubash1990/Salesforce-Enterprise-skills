...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/authorization.md
...
keywords: [authorization, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Authorization

**Purpose:** Least privilege for integration users and connected apps.
...
Least privilege for integration users and connected apps.
