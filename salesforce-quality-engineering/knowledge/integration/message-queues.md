...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/message-queues.md
...
keywords: [message-queues, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Message Queues

**Purpose:** Overview of queue-based integration testing themes (ordering, DLQ, idempotency).
...
Overview of queue-based integration testing themes (ordering, DLQ, idempotency).
...
- **Previous:** [Data Synchronization](data-synchronization.md)
