...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/oauth.md
...
keywords: [oauth, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# OAuth

**Purpose:** Validate OAuth grant types in scope, refresh, and scope misuse negatives.
...
Validate OAuth grant types in scope, refresh, and scope misuse negatives.
...
- **Previous:** [Authorization](authorization.md)
