...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/authentication.md
...
keywords: [authentication, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Authentication

**Purpose:** Test token lifecycle and expired-credential failure modes.
...
Test token lifecycle and expired-credential failure modes.
...
- **Previous:** [External Services](external-services.md)
