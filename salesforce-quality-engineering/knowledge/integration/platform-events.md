...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/platform-events.md
...
keywords: [platform-events, salesforce, quality-engineering, enterprise]
...
Test publish/subscribe contracts and subscriber failure isolation.
...
- [../automation/platform-events.md](../automation/platform-events.md)
...
- **Previous:** [Bulk API](bulk-api.md)
- **Next:** [Change Data Capture](change-data-capture.md)
