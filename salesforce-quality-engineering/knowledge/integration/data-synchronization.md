...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/data-synchronization.md
...
keywords: [data-synchronization, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Data Synchronization

**Purpose:** Test near-real-time vs batch sync, conflict resolution, and drift detection.
...
Test near-real-time vs batch sync, conflict resolution, and drift detection.
...
- **Previous:** [API Limits](api-limits.md)
