...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/bulk-api.md
...
keywords: [bulk-api, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Bulk API

**Purpose:** Validate job lifecycle, error files, and partial success.
...
Validate job lifecycle, error files, and partial success.
...
- **Previous:** [SOAP APIs](soap-apis.md)
