...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/named-credentials.md
...
keywords: [named-credentials, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Named Credentials

**Purpose:** Test auth protocols, env mapping, and secret rotation impact.
...
Test auth protocols, env mapping, and secret rotation impact.
...
- **Next:** [External Services](external-services.md)
