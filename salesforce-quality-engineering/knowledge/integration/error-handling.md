...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/error-handling.md
...
keywords: [error-handling, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---

# Error Handling

**Purpose:** Ensure errors are logged, surfaced, and do not corrupt data silently.
...
Ensure errors are logged, surfaced, and do not corrupt data silently.
