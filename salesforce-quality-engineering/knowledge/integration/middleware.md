...
related_documents:
  - salesforce-quality-engineering/knowledge/integration/middleware.md
...
keywords: [middleware, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, integration]
---
...
Define QE responsibilities across Salesforce vs middleware vs target systems.
...
- E2E with controlled doubles when needed
- Clear failure ownership per hop
...
- **Previous:** [Change Data Capture](change-data-capture.md)
- **Next:** [Named Credentials](named-credentials.md)
