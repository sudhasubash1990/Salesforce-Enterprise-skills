...
keywords: [boundary-testing, bva]
tags: [knowledge, sprint-3, test-design]
---

# Boundary Testing

**Purpose:** Probe edges of allowed ranges (min, min-1, max, max+1).
...
Lengths, amounts, dates, numeric limits, picklist edges.

## Guidance

- Derive boundaries from field defs and rules.
- Pair with [equivalence-partitioning.md](equivalence-partitioning.md).
- Include timezone/date boundaries when material.
