---
title: Testing Managed Packages
...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/testing-managed-packages.md
...
keywords: [testing-managed-packages, salesforce, quality-engineering, enterprise]
...
Combine vendor release notes with subscriber-org process regression.
...
- **Previous:** [Packaged Metadata](packaged-metadata.md)
