---
title: Custom Objects In Packages
...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/custom-objects-in-packages.md
...
keywords: [custom-objects-in-packages, salesforce, quality-engineering, enterprise]
tags: [knowledge, sprint-4b, managed-packages]
---

# Custom Objects In Packages
...
QE focus on packaged schema, subscriber extensions, and layout/FLS after upgrade.
...
- **Previous:** [Version Compatibility](version-compatibility.md)
- **Next:** [Packaged Apex](packaged-apex.md)
