---
title: Packaged Validation Rules
...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/packaged-validation-rules.md
...
keywords: [packaged-validation-rules, salesforce, quality-engineering, enterprise]
...
Validate packaged VR messages, bypass patterns, and upgrade changes.
...
- **Previous:** [Packaged Flows](packaged-flows.md)
- **Next:** [Packaged Metadata](packaged-metadata.md)
