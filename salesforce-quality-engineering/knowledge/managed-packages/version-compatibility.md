...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/version-compatibility.md
...
keywords: [version-compatibility, salesforce, quality-engineering, enterprise]
...
Track package versions, deprecated components, and API version drift.
...
- **Previous:** [Package Upgrades](package-upgrades.md)
- **Next:** [Custom Objects In Packages](custom-objects-in-packages.md)
