...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/regression-strategy.md
...
keywords: [regression-strategy, salesforce, quality-engineering, enterprise]
...
Risk-based regression packs around package upgrades and subscriber customizations.
...
- **Previous:** [Testing Managed Packages](testing-managed-packages.md)
- **Next:** [Upgrade Testing](upgrade-testing.md)
