...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/unlocked-packages.md
...
keywords: [unlocked-packages, salesforce, quality-engineering, enterprise]
...
Validate unlocked package install/upgrade and coexistence with org customizations.
...
- **Next:** [Namespace Prefixes](namespace-prefixes.md)
