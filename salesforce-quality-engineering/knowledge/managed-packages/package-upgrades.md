...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/package-upgrades.md
...
keywords: [package-upgrades, salesforce, quality-engineering, enterprise]
...
Define pre/post upgrade smoke, data, automation, and permission regression.
...
- **Previous:** [Package Dependencies](package-dependencies.md)
- **Next:** [Version Compatibility](version-compatibility.md)
