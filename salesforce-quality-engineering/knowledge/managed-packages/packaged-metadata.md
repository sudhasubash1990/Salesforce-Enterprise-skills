...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/packaged-metadata.md
...
keywords: [packaged-metadata, salesforce, quality-engineering, enterprise]
...
Cover layouts, permission sets, reports, and settings shipped in packages.
...
- [Metadata 4A](../metadata/README.md)
...
- **Previous:** [Packaged Validation Rules](packaged-validation-rules.md)
- **Next:** [Testing Managed Packages](testing-managed-packages.md)
