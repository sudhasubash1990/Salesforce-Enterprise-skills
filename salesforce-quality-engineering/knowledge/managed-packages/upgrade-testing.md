...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/upgrade-testing.md
...
keywords: [upgrade-testing, salesforce, quality-engineering, enterprise]
...
Structured upgrade test themes: install, config, process, integration, security.
...
- **Previous:** [Regression Strategy](regression-strategy.md)
