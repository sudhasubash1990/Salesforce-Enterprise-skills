...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/packaged-apex.md
...
keywords: [packaged-apex, salesforce, quality-engineering, enterprise]
...
Validate packaged Apex interactions with subscriber automation and governors.
...
- **Previous:** [Custom Objects In Packages](custom-objects-in-packages.md)
- **Next:** [Packaged Flows](packaged-flows.md)
