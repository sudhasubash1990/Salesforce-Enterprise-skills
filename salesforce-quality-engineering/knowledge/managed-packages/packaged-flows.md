...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/packaged-flows.md
...
keywords: [packaged-flows, salesforce, quality-engineering, enterprise]
...
Test packaged Flow entry criteria, versions, and subscriber overrides/extensions.
...
- **Previous:** [Packaged Apex](packaged-apex.md)
- **Next:** [Packaged Validation Rules](packaged-validation-rules.md)
