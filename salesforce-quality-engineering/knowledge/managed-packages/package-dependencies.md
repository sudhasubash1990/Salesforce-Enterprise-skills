...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/package-dependencies.md
...
keywords: [package-dependencies, salesforce, quality-engineering, enterprise]
...
Test prerequisites and broken subscriber overrides after dependency changes.
...
- **Previous:** [Namespace Prefixes](namespace-prefixes.md)
- **Next:** [Package Upgrades](package-upgrades.md)
