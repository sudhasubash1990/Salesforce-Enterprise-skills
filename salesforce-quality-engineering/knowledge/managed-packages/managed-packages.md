...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/managed-packages.md
...
keywords: [managed-packages, salesforce, quality-engineering, enterprise]
...
Explain managed package constraints, upgrade risk, and subscriber testing strategy.
...
- **Next:** [Unlocked Packages](unlocked-packages.md)
