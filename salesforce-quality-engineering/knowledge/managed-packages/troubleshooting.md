...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/troubleshooting.md
...
keywords: [troubleshooting, salesforce, quality-engineering, enterprise]
...
QE checklist for install errors, missing access, and post-upgrade defects.
...
- **Previous:** [Upgrade Testing](upgrade-testing.md)
- **Next:** [Vendor Coordination](vendor-coordination.md)
