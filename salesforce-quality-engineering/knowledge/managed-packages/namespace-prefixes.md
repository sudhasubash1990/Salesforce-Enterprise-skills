...
related_documents:
  - salesforce-quality-engineering/knowledge/managed-packages/namespace-prefixes.md
...
keywords: [namespace-prefixes, salesforce, quality-engineering, enterprise]
...
Ensure API/Apex/Flow references handle namespaced components correctly.
...
- **Previous:** [Unlocked Packages](unlocked-packages.md)
- **Next:** [Package Dependencies](package-dependencies.md)
