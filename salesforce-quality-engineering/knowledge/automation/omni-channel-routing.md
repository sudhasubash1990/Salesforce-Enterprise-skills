...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/omni-channel-routing.md
...
keywords: [omni-channel-routing, salesforce, quality-engineering, platform-foundation]
...
Overview-only QE guidance for routing/work distribution (deep Service Cloud in Sprint 4B).
...
- Presence/capacity changes
- Skill mismatch
- Queue overflow / backlog behaviour
- Permission to own routed work
...
- **Previous:** [Auto Response Rules](auto-response-rules.md)
