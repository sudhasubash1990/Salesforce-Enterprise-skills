...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/matching-rules.md
...
Test match strength and false positive/negative tradeoffs.
...
- [../data/matching-rules.md](../data/matching-rules.md)
...
- **Next:** [Assignment Rules](assignment-rules.md)
