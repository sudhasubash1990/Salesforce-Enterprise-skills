...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/approval-processes.md
...
keywords: [approval-processes, salesforce, quality-engineering, platform-foundation]
...
Cover submit/approve/reject/recall, reassignment, and notification side effects.
...
- **Previous:** [Screen Flows](screen-flows.md)
- **Next:** [Workflow Rules](workflow-rules.md)
