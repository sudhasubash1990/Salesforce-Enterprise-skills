...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/process-builder.md
...
keywords: [process-builder, salesforce, quality-engineering, platform-foundation]
...
Validate remaining PB and coexistence with Flow/Apex.
...
- **Previous:** [Workflow Rules](workflow-rules.md)
- **Next:** [Apex Triggers](apex-triggers.md)
