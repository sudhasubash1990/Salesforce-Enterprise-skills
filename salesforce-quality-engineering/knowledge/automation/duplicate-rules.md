...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/duplicate-rules.md
...
Validate alert vs block, matching interplay, and bypass roles.
...
- [../data/duplicate-rules.md](../data/duplicate-rules.md)
