...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/scheduled-flows.md
...
keywords: [scheduled-flows, salesforce, quality-engineering, platform-foundation]
...
Test schedule frequency, filters, bulk batches, and missed-run behaviour.
...
- **Previous:** [Record-Triggered Flows](record-triggered-flows.md)
- **Next:** [Auto-Launched Flows](auto-launched-flows.md)
