...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/auto-response-rules.md
...
keywords: [auto-response-rules, salesforce, quality-engineering, platform-foundation]
...
Validate rule criteria, templates, and when responses must NOT send.
...
- **Previous:** [Escalation Rules](escalation-rules.md)
- **Next:** [Omni-Channel Routing](omni-channel-routing.md)
