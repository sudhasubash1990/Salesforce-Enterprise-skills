...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/escalation-rules.md
...
keywords: [escalation-rules, salesforce, quality-engineering, platform-foundation]
...
Test age criteria, business hours, escalation actions, and re-escalation.
...
- **Previous:** [Assignment Rules](assignment-rules.md)
- **Next:** [Auto Response Rules](auto-response-rules.md)
