...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/auto-launched-flows.md
...
keywords: [auto-launched-flows, salesforce, quality-engineering, platform-foundation]
...
Validate inputs/outputs, subflow contracts, and invocation from Apex/API/Flow.
...
- **Previous:** [Scheduled Flows](scheduled-flows.md)
- **Next:** [Screen Flows](screen-flows.md)
