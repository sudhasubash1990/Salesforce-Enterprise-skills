...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/screen-flows.md
...
keywords: [screen-flows, salesforce, quality-engineering, platform-foundation]
...
Test screens, decisions, fault paths, finish behaviour, and run permissions.
...
- **Previous:** [Auto-Launched Flows](auto-launched-flows.md)
- **Next:** [Approval Processes](approval-processes.md)
