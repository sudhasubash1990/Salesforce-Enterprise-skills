...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/record-triggered-flows.md
...
keywords: [record-triggered-flows, salesforce, quality-engineering, platform-foundation]
...
Validate entry criteria, recursion controls, async paths, and bulk assumptions.
...
- Before-save vs after-save vs async paths have different testing implications
- Coexistence with Apex triggers is a primary defect source
...
- [../flow-testing.md](../flow-testing.md)
...
- **Previous:** [Validation Rules](validation-rules.md)
- **Next:** [Scheduled Flows](scheduled-flows.md)
