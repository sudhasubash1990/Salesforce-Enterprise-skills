...
related_documents:
  - salesforce-quality-engineering/knowledge/automation/assignment-rules.md
...
keywords: [assignment-rules, salesforce, quality-engineering, platform-foundation]
...
Validate rule order, criteria, default owner/queue, and API bypass behaviour.
...
- Order of rules matters; first match typically wins
- Assignment on create vs update paths differ—confirm requirement
...
- **Previous:** [Matching Rules](matching-rules.md)
- **Next:** [Escalation Rules](escalation-rules.md)
