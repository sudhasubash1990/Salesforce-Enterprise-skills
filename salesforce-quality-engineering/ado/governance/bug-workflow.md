...
keywords: [bug-workflow, azure-devops, quality-engineering]
---
...
States, owners, and retest expectations for bugs.
## Business Context
...
- Well-formed Bug Workflow ready to paste into Azure DevOps
...
- **Previous:** [Definition of Done](definition-of-done.md)
- **Next:** [Test Case Review](test-case-review.md)
