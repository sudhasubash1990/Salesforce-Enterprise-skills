...
tags: [ado, sprint-6, test-cases]
keywords: [shared-steps, azure-devops, quality-engineering]
---
...
Reusable step blocks for login, navigation, or common setup to reduce duplication.
## Business Context
...
- Well-formed Shared Steps ready to paste into Azure DevOps
...
- Stable, high-reuse only
- Version carefully when setup changes
## Common Mistakes
...
- **Previous:** [Test Case](test-case.md)
