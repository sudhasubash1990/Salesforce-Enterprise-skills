...
keywords: [test-suite, azure-devops, quality-engineering]
---
...
Explain Static, Requirement-Based, Query-Based suites and purpose packs (Smoke, Regression, UAT, Release).
## Business Context
...
- Well-formed Test Suite ready to paste into Azure DevOps
