...
keywords: [delivery-manager-dashboard, azure-devops, quality-engineering]
---
...
Program-level quality and dependency risk.
## Business Context
...
- Well-formed Delivery Manager Dashboard ready to paste into Azure DevOps
...
- KPIs: PI objectives risk, cross-team defects, environment blockers
## Common Mistakes
...
- **Previous:** [Release Manager Dashboard](release-manager-dashboard.md)
- **Next:** [Executive Leadership Dashboard](executive-dashboard.md)
