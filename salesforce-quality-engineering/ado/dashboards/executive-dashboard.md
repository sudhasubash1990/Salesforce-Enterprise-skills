...
keywords: [executive-dashboard, azure-devops, quality-engineering]
---
...
Outcome and residual risk view for steering.
## Business Context
...
- Well-formed Executive Leadership Dashboard ready to paste into Azure DevOps
...
- KPIs: release recommendation, top 3 risks, customer-impacting defects
- Avoid raw case counts without context
## Common Mistakes
...
- **Previous:** [Delivery Manager Dashboard](delivery-manager-dashboard.md)
