...
keywords: [project-manager-dashboard, azure-devops, quality-engineering]
---
...
Delivery progress and quality risk for PM cadence.
## Business Context
...
- Well-formed Project Manager Dashboard ready to paste into Azure DevOps
...
- KPIs: story done %, test progress, top risks
## Common Mistakes
...
- **Previous:** [Test Manager Dashboard](test-manager-dashboard.md)
- **Next:** [Release Manager Dashboard](release-manager-dashboard.md)
