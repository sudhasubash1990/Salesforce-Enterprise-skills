...
keywords: [qa-lead-dashboard, azure-devops, quality-engineering]
---
...
Day-to-day execution: pass rate, blockers, open bugs, case progress.
## Business Context
...
- Well-formed QA Lead Dashboard ready to paste into Azure DevOps
...
- KPIs: executed vs planned, blocked count, Critical bugs
- Charts: burndown of cases, severity pie
- Filters: Iteration + Area
## Common Mistakes
...
- **Next:** [Test Manager Dashboard](test-manager-dashboard.md)
