...
keywords: [test-manager-dashboard, azure-devops, quality-engineering]
---
...
Cross-sprint quality and coverage posture.
## Business Context
...
- Well-formed Test Manager Dashboard ready to paste into Azure DevOps
...
- KPIs: coverage themes, escape rate inputs, automation ratio
- Decision: deepen regression vs proceed
## Common Mistakes
...
- **Previous:** [QA Lead Dashboard](qa-lead-dashboard.md)
- **Next:** [Project Manager Dashboard](project-manager-dashboard.md)
