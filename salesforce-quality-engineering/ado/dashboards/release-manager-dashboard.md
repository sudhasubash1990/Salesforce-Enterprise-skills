---
title: Release Manager Dashboard
...
tags: [ado, sprint-6, dashboards]
keywords: [release-manager-dashboard, azure-devops, quality-engineering]
---
...
Go/No-Go evidence: readiness, open Critical/High, smoke results.
## Business Context
...
- Well-formed Release Manager Dashboard ready to paste into Azure DevOps
...
- KPIs: readiness checklist status, failed smoke, rollback readiness
## Common Mistakes
...
- **Previous:** [Project Manager Dashboard](project-manager-dashboard.md)
- **Next:** [Delivery Manager Dashboard](delivery-manager-dashboard.md)
