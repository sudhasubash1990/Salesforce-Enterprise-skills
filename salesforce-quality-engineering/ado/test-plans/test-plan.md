...
tags: [ado, sprint-6, test-plans]
keywords: [test-plan, azure-devops, quality-engineering]
---
...
Organize test execution for a defined scope and cadence.
## Business Context
...
- Well-formed Test Plan ready to paste into Azure DevOps
...
- [test-plans-organization.md](../test-plans-organization.md)
