...
tags: [ado, sprint-6, user-stories]
keywords: [user-story, azure-devops, quality-engineering]
---
...
Capture role/goal/benefit and testable acceptance criteria for a shippable increment.
## Business Context
...
- Well-formed User Story ready to paste into Azure DevOps
...
- Primary hook for Test Design Engine and Sprint 5 case templates
- Link AC ↔ scenarios ↔ cases
## Interview Questions
...
- [../../templates/test-scenario-document.md](../../templates/test-scenario-document.md)
- [../../templates/test-case-document.md](../../templates/test-case-document.md)
