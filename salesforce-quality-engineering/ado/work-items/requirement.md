...
keywords: [requirement, azure-devops, quality-engineering]
---
...
Formal requirement type when used (CMMI/legacy); else map via Story/AC.
## Business Context
...
- Well-formed Requirement ready to paste into Azure DevOps
