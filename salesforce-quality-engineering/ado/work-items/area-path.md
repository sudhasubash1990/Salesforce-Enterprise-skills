...
keywords: [area-path, azure-devops, quality-engineering]
---
...
Team/product ownership structure for work and tests.
## Business Context
...
- Well-formed Area Path ready to paste into Azure DevOps
...
- **Previous:** [Iteration](iteration.md)
- **Next:** [Build](build.md)
