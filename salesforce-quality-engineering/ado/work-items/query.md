...
keywords: [query, azure-devops, quality-engineering]
---
...
Saved query concept—see Query Intelligence for strategies.
## Business Context
...
- Well-formed Query ready to paste into Azure DevOps
