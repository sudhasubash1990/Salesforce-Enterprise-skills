...
keywords: [iteration, azure-devops, quality-engineering]
---
...
Timeboxes for sprint/PI planning and reporting filters.
## Business Context
...
- Well-formed Iteration ready to paste into Azure DevOps
...
- **Previous:** [Requirement](requirement.md)
- **Next:** [Area Path](area-path.md)
