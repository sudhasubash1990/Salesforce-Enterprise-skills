...
tags: [ado, sprint-6, work-items]
keywords: [pipeline, azure-devops, quality-engineering]
---
...
QE awareness of CI/CD pipelines—gates and smoke hooks (not YAML authoring).
## Business Context
...
- Well-formed Pipeline ready to paste into Azure DevOps
...
- **Previous:** [Release](release.md)
- **Next:** [Sprint](sprint.md)
