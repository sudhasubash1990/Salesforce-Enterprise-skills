...
keywords: [sprint, azure-devops, quality-engineering]
---
...
Sprint as planning container: goals, capacity, quality exit.
## Business Context
...
- Well-formed Sprint ready to paste into Azure DevOps
...
- **Previous:** [Pipeline](pipeline.md)
- **Next:** [Backlog](backlog.md)
