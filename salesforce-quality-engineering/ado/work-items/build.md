...
keywords: [build, azure-devops, quality-engineering]
---
...
Associate bugs/tests with build numbers for evidence.
## Business Context
...
- Well-formed Build ready to paste into Azure DevOps
...
- **Previous:** [Area Path](area-path.md)
