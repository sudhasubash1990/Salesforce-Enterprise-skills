...
tags: [ado, sprint-6, epics]
keywords: [epic, azure-devops, quality-engineering]
---
...
Define a large business outcome that will be delivered through Features and Stories.
## Business Context
...
- Well-formed Epic ready to paste into Azure DevOps
- Links for traceability
## Relationships

- Parent: Portfolio/Initiative (process-dependent)
- Children: Features
- Related: Risks, Releases
## Examples
...
- Epic success criteria inform Test Strategy and Release RTM views
- Do not put test steps on Epics
## Interview Questions
