...
Operate hypercare quality checks and feedback loop.
...
- Unresolved Critical gaps blocking design/execution
- Missing approver / environment
- Regulatory ambiguity — Legal/Compliance
...
- [README.md](README.md)
- [Hypercare Validation Checklist](../templates/hypercare-validation-checklist.md)
- [Defect Report](../templates/defect-report.md)
