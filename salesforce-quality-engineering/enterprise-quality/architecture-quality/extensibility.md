...
keywords: [extensibility, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Extensibility.
## Business Context
...
- How would you advise a CIO using Extensibility?
...
- **Previous:** [Maintainability](maintainability.md)
- **Next:** [Architecture Risks](architecture-risks.md)
