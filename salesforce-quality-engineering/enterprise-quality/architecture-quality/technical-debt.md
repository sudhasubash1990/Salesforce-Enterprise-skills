...
keywords: [technical-debt, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Technical Debt.
## Business Context
...
- How would you advise a CIO using Technical Debt?
...
- **Previous:** [Metadata Quality](metadata-quality.md)
- **Next:** [Configuration Complexity](configuration-complexity.md)
