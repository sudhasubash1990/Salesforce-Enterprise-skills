...
keywords: [automation-architecture, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Automation Architecture.
## Business Context
...
- How would you advise a CIO using Automation Architecture?
...
- **Next:** [Environment Architecture](environment-architecture.md)
