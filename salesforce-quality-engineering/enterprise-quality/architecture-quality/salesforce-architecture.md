...
keywords: [salesforce-architecture, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Salesforce Architecture.
## Business Context
...
- How would you advise a CIO using Salesforce Architecture?
...
- **Next:** [Integration Architecture](integration-architecture.md)
