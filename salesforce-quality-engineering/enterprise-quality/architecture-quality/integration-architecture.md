...
keywords: [integration-architecture, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Integration Architecture.
## Business Context
...
- How would you advise a CIO using Integration Architecture?
...
- **Previous:** [Salesforce Architecture](salesforce-architecture.md)
