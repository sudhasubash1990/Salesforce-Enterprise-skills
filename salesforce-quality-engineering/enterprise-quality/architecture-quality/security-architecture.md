...
tags: [enterprise-quality, sprint-10, architecture-quality]
keywords: [security-architecture, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Security Architecture.
## Business Context
...
- How would you advise a CIO using Security Architecture?
...
- **Previous:** [Integration Architecture](integration-architecture.md)
- **Next:** [Automation Architecture](automation-architecture.md)
