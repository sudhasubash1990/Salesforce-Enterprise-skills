...
keywords: [defect-audit, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Defect Audit.
## Business Context
...
- How would you advise a CIO using Defect Audit?
...
- **Previous:** [Production Audit](production-audit.md)
- **Next:** [Documentation Audit](documentation-audit.md)
