...
keywords: [decision-records, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Decision Records.
## Business Context
...
- How would you advise a CIO using Decision Records?
...
- **Previous:** [Compliance Tracking](compliance-tracking.md)
- **Next:** [Governance Kpis](governance-kpis.md)
