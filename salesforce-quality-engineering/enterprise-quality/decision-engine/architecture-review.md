...
keywords: [architecture-review, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Architecture Review.
## Business Context
...
- Trigger criteria for Architecture Review
...
- How would you advise a CIO using Architecture Review?
...
- **Previous:** [Increase Testing](increase-testing.md)
- **Next:** [Security Review](security-review.md)
