...
keywords: [reduce-scope, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Reduce Scope.
## Business Context
...
- Trigger criteria for Reduce Scope
...
- How would you advise a CIO using Reduce Scope?
...
- **Previous:** [Delay Release](delay-release.md)
- **Next:** [Increase Testing](increase-testing.md)
