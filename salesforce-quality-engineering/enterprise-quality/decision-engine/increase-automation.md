...
keywords: [increase-automation, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Increase Automation.
## Business Context
...
- Trigger criteria for Increase Automation
...
- How would you advise a CIO using Increase Automation?
...
- **Next:** [Expand Regression](expand-regression.md)
