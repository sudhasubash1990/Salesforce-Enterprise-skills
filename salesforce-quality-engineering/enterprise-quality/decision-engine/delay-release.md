...
keywords: [delay-release, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Delay Release.
## Business Context
...
- Trigger criteria for Delay Release
...
- How would you advise a CIO using Delay Release?
...
- **Previous:** [Expand Regression](expand-regression.md)
- **Next:** [Reduce Scope](reduce-scope.md)
