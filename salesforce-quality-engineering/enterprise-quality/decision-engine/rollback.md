...
keywords: [rollback, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Rollback.
## Business Context
...
- How would you advise a CIO using Rollback?
...
- **Previous:** [Escalate](escalate.md)
- **Next:** [Increase Automation](increase-automation.md)
