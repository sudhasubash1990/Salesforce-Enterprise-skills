...
tags: [enterprise-quality, sprint-10, decision-engine]
keywords: [expand-regression, enterprise-advisory, quality-maturity]
---
...
When and how to recommend the executive decision: Expand Regression.
## Business Context
...
- Trigger criteria for Expand Regression
...
- How would you advise a CIO using Expand Regression?
...
- **Previous:** [Increase Automation](increase-automation.md)
- **Next:** [Delay Release](delay-release.md)
