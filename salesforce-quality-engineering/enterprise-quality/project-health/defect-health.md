...
keywords: [defect-health, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Defect Health.
## Business Context
...
- How would you advise a CIO using Defect Health?
...
- **Previous:** [Automation Coverage Health](automation-coverage-health.md)
- **Next:** [Release Readiness Health](release-readiness-health.md)
