...
keywords: [target-state-definition, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Target State Definition.
## Business Context
...
- How would you advise a CIO using Target State Definition?
...
- **Previous:** [Gap Assessment](gap-assessment.md)
- **Next:** [Improvement Planning](improvement-planning.md)
