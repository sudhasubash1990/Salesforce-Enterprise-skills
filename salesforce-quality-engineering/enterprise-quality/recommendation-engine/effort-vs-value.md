...
keywords: [effort-vs-value, enterprise-advisory, quality-maturity]
---
...
Provide enterprise advisory guidance on Effort Vs Value.
## Business Context
...
- How would you advise a CIO using Effort Vs Value?
...
- **Previous:** [Prioritization](prioritization.md)
- **Next:** [Dependency Aware Recommendations](dependency-aware-recommendations.md)
