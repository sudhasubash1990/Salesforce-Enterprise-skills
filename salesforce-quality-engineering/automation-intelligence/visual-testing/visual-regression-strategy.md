...
keywords: [visual-regression-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Visual Regression Strategy for Salesforce automation intelligence.
## Business Context
...
- Visual Regression Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Visual Regression Strategy on a Salesforce program?
...
- **Next:** [Baseline Management](baseline-management.md)
