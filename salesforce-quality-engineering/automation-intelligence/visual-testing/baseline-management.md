...
keywords: [baseline-management, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Baseline Management for Salesforce automation intelligence.
## Business Context
...
- Baseline Management fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Baseline Management on a Salesforce program?
...
- **Previous:** [Visual Regression Strategy](visual-regression-strategy.md)
- **Next:** [Threshold And Noise](threshold-and-noise.md)
