...
keywords: [automation-feasibility, automation-strategy, test-automation]
---
...
Assess whether a scenario is ready and suitable to automate.
## Business Context
...
- Automation Feasibility fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Feasibility on a Salesforce program?
...
- **Previous:** [Automation Roi](automation-roi.md)
- **Next:** [Automation Prioritization](automation-prioritization.md)
