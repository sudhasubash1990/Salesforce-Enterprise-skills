...
keywords: [service-layer-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Service Layer Testing for Salesforce automation intelligence.
## Business Context
...
- Service Layer Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Service Layer Testing on a Salesforce program?
...
- **Previous:** [Ui Automation](ui-automation.md)
- **Next:** [Automation Roi](automation-roi.md)
