...
keywords: [ui-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Ui Automation for Salesforce automation intelligence.
## Business Context
...
- Ui Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Ui Automation on a Salesforce program?
...
- **Previous:** [Api Automation](api-automation.md)
- **Next:** [Service Layer Testing](service-layer-testing.md)
