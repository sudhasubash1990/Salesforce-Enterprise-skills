...
keywords: [regression-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Regression Automation for Salesforce automation intelligence.
## Business Context
...
- Regression Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Regression Automation on a Salesforce program?
...
- **Previous:** [Risk Based Automation](risk-based-automation.md)
- **Next:** [Smoke Automation](smoke-automation.md)
