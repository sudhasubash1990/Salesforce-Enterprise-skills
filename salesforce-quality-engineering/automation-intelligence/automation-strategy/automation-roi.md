...
keywords: [automation-roi, automation-strategy, test-automation]
---
...
Estimate automation ROI with transparent assumptions—never invent financials.
## Business Context
...
- Automation Roi fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Roi on a Salesforce program?
...
- **Previous:** [Service Layer Testing](service-layer-testing.md)
- **Next:** [Automation Feasibility](automation-feasibility.md)
