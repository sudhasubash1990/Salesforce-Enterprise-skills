...
keywords: [shift-right-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Shift Right Testing for Salesforce automation intelligence.
## Business Context
...
- Shift Right Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Shift Right Testing on a Salesforce program?
...
- **Previous:** [Shift Left Testing](shift-left-testing.md)
- **Next:** [Continuous Testing](continuous-testing.md)
