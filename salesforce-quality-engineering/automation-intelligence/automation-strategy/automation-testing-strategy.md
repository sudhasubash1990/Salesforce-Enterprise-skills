---
title: Automation Testing Strategy
...
tags: [automation-intelligence, sprint-8, automation-strategy]
keywords: [automation-testing-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Automation Testing Strategy for Salesforce automation intelligence.
## Business Context
...
- Automation Testing Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Testing Strategy on a Salesforce program?
...
- **Previous:** [Automation Pyramid](automation-pyramid.md)
- **Next:** [Risk Based Automation](risk-based-automation.md)
