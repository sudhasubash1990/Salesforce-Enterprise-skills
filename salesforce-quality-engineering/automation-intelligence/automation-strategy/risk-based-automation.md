...
keywords: [risk-based-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Risk Based Automation for Salesforce automation intelligence.
## Business Context
...
- Risk Based Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Risk Based Automation on a Salesforce program?
...
- **Previous:** [Automation Testing Strategy](automation-testing-strategy.md)
- **Next:** [Regression Automation](regression-automation.md)
