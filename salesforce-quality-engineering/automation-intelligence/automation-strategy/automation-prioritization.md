...
keywords: [automation-prioritization, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Automation Prioritization for Salesforce automation intelligence.
## Business Context
...
- Automation Prioritization fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Prioritization on a Salesforce program?
...
- **Previous:** [Automation Feasibility](automation-feasibility.md)
- **Next:** [Shift Left Testing](shift-left-testing.md)
