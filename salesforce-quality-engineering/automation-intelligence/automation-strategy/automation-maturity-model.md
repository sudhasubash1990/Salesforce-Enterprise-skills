...
keywords: [automation-maturity-model, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Automation Maturity Model for Salesforce automation intelligence.
## Business Context
...
- Automation Maturity Model fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Maturity Model on a Salesforce program?
...
- **Previous:** [Continuous Testing](continuous-testing.md)
