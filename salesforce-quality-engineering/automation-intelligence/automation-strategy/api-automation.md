...
keywords: [api-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Api Automation for Salesforce automation intelligence.
## Business Context
...
- Api Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Api Automation on a Salesforce program?
...
- **Previous:** [Sanity Automation](sanity-automation.md)
- **Next:** [Ui Automation](ui-automation.md)
