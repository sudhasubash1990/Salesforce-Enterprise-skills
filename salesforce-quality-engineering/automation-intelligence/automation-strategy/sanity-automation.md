...
keywords: [sanity-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Sanity Automation for Salesforce automation intelligence.
## Business Context
...
- Sanity Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Sanity Automation on a Salesforce program?
...
- **Previous:** [Smoke Automation](smoke-automation.md)
- **Next:** [Api Automation](api-automation.md)
