...
keywords: [smoke-automation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Smoke Automation for Salesforce automation intelligence.
## Business Context
...
- Smoke Automation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Smoke Automation on a Salesforce program?
...
- **Previous:** [Regression Automation](regression-automation.md)
- **Next:** [Sanity Automation](sanity-automation.md)
