...
keywords: [automation-pyramid, automation-strategy, test-automation]
---
...
Explain and apply the test automation pyramid for Salesforce programs.
## Business Context
...
- When would you apply Automation Pyramid on a Salesforce program?
...
- **Next:** [Automation Testing Strategy](automation-testing-strategy.md)
