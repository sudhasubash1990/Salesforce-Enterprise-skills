...
keywords: [shift-left-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Shift Left Testing for Salesforce automation intelligence.
## Business Context
...
- Shift Left Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Shift Left Testing on a Salesforce program?
...
- **Previous:** [Automation Prioritization](automation-prioritization.md)
- **Next:** [Shift Right Testing](shift-right-testing.md)
