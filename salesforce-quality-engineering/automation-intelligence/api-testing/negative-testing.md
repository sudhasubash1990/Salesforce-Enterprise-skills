...
keywords: [negative-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Negative Testing for Salesforce automation intelligence.
## Business Context
...
- Negative Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Negative Testing on a Salesforce program?
...
- **Previous:** [Error Validation](error-validation.md)
