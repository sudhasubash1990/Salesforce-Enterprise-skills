...
keywords: [contract-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Contract Testing for Salesforce automation intelligence.
## Business Context
...
- Contract Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Contract Testing on a Salesforce program?
...
- **Previous:** [Api Mocking](api-mocking.md)
