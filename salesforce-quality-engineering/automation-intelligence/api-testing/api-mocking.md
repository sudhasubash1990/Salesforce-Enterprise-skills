...
keywords: [api-mocking, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Api Mocking for Salesforce automation intelligence.
## Business Context
...
- Api Mocking fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Api Mocking on a Salesforce program?
...
- **Previous:** [Named Credentials](named-credentials.md)
- **Next:** [Contract Testing](contract-testing.md)
