...
keywords: [named-credentials, automation-strategy, test-automation]
---
...
Test integrations that rely on Salesforce Named Credentials securely.
## Business Context
...
- Named Credentials fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Named Credentials on a Salesforce program?
...
- **Previous:** [JWT](jwt.md)
- **Next:** [Api Mocking](api-mocking.md)
