...
keywords: [migration-to-playwright, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Migration To Playwright for Salesforce automation intelligence.
## Business Context
...
- Migration To Playwright fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Migration To Playwright on a Salesforce program?
...
- **Previous:** [Salesforce Ui Risks](salesforce-ui-risks.md)
