...
tags: [automation-intelligence, sprint-8, selenium]
keywords: [salesforce-ui-risks, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Salesforce Ui Risks for Salesforce automation intelligence.
## Business Context
...
- Salesforce Ui Risks fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Ui Risks on a Salesforce program?
...
- **Previous:** [Waits And Stability](waits-and-stability.md)
- **Next:** [Migration To Playwright](migration-to-playwright.md)
