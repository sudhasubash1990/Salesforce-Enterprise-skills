...
tags: [automation-intelligence, sprint-8, test-data]
keywords: [api-data-creation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Api Data Creation for Salesforce automation intelligence.
## Business Context
...
- Api Data Creation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Api Data Creation on a Salesforce program?
...
- **Previous:** [Data Seeding](data-seeding.md)
- **Next:** [Data Dependencies](data-dependencies.md)
