...
keywords: [data-dependencies, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Data Dependencies for Salesforce automation intelligence.
## Business Context
...
- Data Dependencies fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Data Dependencies on a Salesforce program?
...
- **Previous:** [Api Data Creation](api-data-creation.md)
- **Next:** [Environment Isolation](environment-isolation.md)
