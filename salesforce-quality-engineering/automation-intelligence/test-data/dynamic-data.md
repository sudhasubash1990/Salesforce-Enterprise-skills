...
keywords: [dynamic-data, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Dynamic Data for Salesforce automation intelligence.
## Business Context
...
- Dynamic Data fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Dynamic Data on a Salesforce program?
...
- **Previous:** [Bulk Data](bulk-data.md)
