...
keywords: [masked-data, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Masked Data for Salesforce automation intelligence.
## Business Context
...
- Masked Data fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Masked Data on a Salesforce program?
...
- **Previous:** [Synthetic Data](synthetic-data.md)
- **Next:** [Salesforce Test Data](salesforce-test-data.md)
