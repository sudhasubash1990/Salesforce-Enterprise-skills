...
keywords: [salesforce-test-data, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Salesforce Test Data for Salesforce automation intelligence.
## Business Context
...
- Salesforce Test Data fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Test Data on a Salesforce program?
...
- **Previous:** [Masked Data](masked-data.md)
- **Next:** [Bulk Data](bulk-data.md)
