...
keywords: [data-seeding, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Data Seeding for Salesforce automation intelligence.
## Business Context
...
- Data Seeding fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Data Seeding on a Salesforce program?
...
- **Previous:** [Refresh Strategy](refresh-strategy.md)
- **Next:** [Api Data Creation](api-data-creation.md)
