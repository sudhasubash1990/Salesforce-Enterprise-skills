...
keywords: [bulk-data, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Bulk Data for Salesforce automation intelligence.
## Business Context
...
- Bulk Data fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Bulk Data on a Salesforce program?
...
- **Previous:** [Salesforce Test Data](salesforce-test-data.md)
- **Next:** [Dynamic Data](dynamic-data.md)
