...
keywords: [refresh-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Refresh Strategy for Salesforce automation intelligence.
## Business Context
...
- Refresh Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Refresh Strategy on a Salesforce program?
...
- **Previous:** [Cleanup](cleanup.md)
- **Next:** [Data Seeding](data-seeding.md)
