...
keywords: [synthetic-data, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Synthetic Data for Salesforce automation intelligence.
## Business Context
...
- Synthetic Data fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Synthetic Data on a Salesforce program?
...
- **Next:** [Masked Data](masked-data.md)
