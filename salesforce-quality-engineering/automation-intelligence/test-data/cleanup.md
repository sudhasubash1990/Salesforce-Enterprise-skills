...
keywords: [cleanup, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Cleanup for Salesforce automation intelligence.
## Business Context
...
- Cleanup fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Cleanup on a Salesforce program?
...
- **Previous:** [Dynamic Data](dynamic-data.md)
- **Next:** [Refresh Strategy](refresh-strategy.md)
