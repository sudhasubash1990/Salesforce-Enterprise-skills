...
keywords: [flake-triage, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Flake Triage for Salesforce automation intelligence.
## Business Context
...
- Flake Triage fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Flake Triage on a Salesforce program?
...
- **Previous:** [Maintenance Model](maintenance-model.md)
- **Next:** [Refactor Triggers](refactor-triggers.md)
