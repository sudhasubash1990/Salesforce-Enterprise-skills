...
keywords: [quarantine-policy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Quarantine Policy for Salesforce automation intelligence.
## Business Context
...
- Quarantine Policy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Quarantine Policy on a Salesforce program?
...
- **Previous:** [Refactor Triggers](refactor-triggers.md)
