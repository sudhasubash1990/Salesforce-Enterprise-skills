...
keywords: [technical-debt, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Technical Debt for Salesforce automation intelligence.
## Business Context
...
- Technical Debt fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Technical Debt on a Salesforce program?
...
- **Previous:** [Quarantine Policy](quarantine-policy.md)
