...
tags: [automation-intelligence, sprint-8, maintenance]
keywords: [refactor-triggers, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Refactor Triggers for Salesforce automation intelligence.
## Business Context
...
- Refactor Triggers fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Refactor Triggers on a Salesforce program?
...
- **Previous:** [Flake Triage](flake-triage.md)
- **Next:** [Quarantine Policy](quarantine-policy.md)
