...
keywords: [dashboards, automation-strategy, test-automation]
---
...
Advise how to automate or validate Dashboards on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Dashboards where UI is not the risk.
...
- Load matching 4A/4B knowledge for Dashboards before recommending design.
...
- When would you apply Dashboards on a Salesforce program?
