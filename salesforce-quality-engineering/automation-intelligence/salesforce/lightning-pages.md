...
keywords: [lightning-pages, automation-strategy, test-automation]
---
...
Advise how to automate or validate Lightning Pages on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Lightning Pages where UI is not the risk.
...
- Load matching 4A/4B knowledge for Lightning Pages before recommending design.
...
- When would you apply Lightning Pages on a Salesforce program?
