...
keywords: [integrations, automation-strategy, test-automation]
---
...
Advise how to automate or validate Integrations on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Integrations where UI is not the risk.
...
- Load matching 4A/4B knowledge for Integrations before recommending design.
...
- When would you apply Integrations on a Salesforce program?
...
- **Previous:** [Managed Packages](managed-packages.md)
- **Next:** [Batch Jobs](batch-jobs.md)
