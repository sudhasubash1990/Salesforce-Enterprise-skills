...
keywords: [reports, automation-strategy, test-automation]
---
...
Advise how to automate or validate Reports on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Reports where UI is not the risk.
...
- Load matching 4A/4B knowledge for Reports before recommending design.
...
- When would you apply Reports on a Salesforce program?
