...
keywords: [record-types, automation-strategy, test-automation]
---
...
Advise how to automate or validate Record Types on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Record Types where UI is not the risk.
...
- Load matching 4A/4B knowledge for Record Types before recommending design.
...
- When would you apply Record Types on a Salesforce program?
