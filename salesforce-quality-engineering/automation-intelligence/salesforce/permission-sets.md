...
keywords: [permission-sets, automation-strategy, test-automation]
---
...
Advise how to automate or validate Permission Sets on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Permission Sets where UI is not the risk.
...
- Load matching 4A/4B knowledge for Permission Sets before recommending design.
...
- When would you apply Permission Sets on a Salesforce program?
...
- **Next:** [Sharing Rules](sharing-rules.md)
