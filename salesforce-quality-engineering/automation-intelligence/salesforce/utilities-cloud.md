...
keywords: [utilities-cloud, automation-strategy, test-automation]
---
...
Advise how to automate or validate Utilities Cloud on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Utilities Cloud where UI is not the risk.
...
- Load matching 4A/4B knowledge for Utilities Cloud before recommending design.
...
- When would you apply Utilities Cloud on a Salesforce program?
...
- **Previous:** [Experience Cloud](experience-cloud.md)
- **Next:** [Agentforce](agentforce.md)
