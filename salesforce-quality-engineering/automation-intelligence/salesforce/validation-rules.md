...
keywords: [validation-rules, automation-strategy, test-automation]
---
...
Advise how to automate or validate Validation Rules on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Validation Rules where UI is not the risk.
...
- Load matching 4A/4B knowledge for Validation Rules before recommending design.
...
- When would you apply Validation Rules on a Salesforce program?
