...
keywords: [profiles, automation-strategy, test-automation]
---
...
Advise how to automate or validate Profiles on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Profiles where UI is not the risk.
...
- Load matching 4A/4B knowledge for Profiles before recommending design.
...
- When would you apply Profiles on a Salesforce program?
...
- **Previous:** [Record Types](record-types.md)
