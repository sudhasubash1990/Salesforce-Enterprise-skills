...
keywords: [flows, automation-strategy, test-automation]
---
...
Advise how to automate or validate Flows on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Flows where UI is not the risk.
...
- Load matching 4A/4B knowledge for Flows before recommending design.
...
- When would you apply Flows on a Salesforce program?
...
- **Previous:** [Lightning Pages](lightning-pages.md)
