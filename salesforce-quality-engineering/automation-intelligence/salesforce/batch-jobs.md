...
keywords: [batch-jobs, automation-strategy, test-automation]
---
...
Advise how to automate or validate Batch Jobs on Salesforce programs.
## Business Context
...
- Prefer API/metadata/service assertions for Batch Jobs where UI is not the risk.
...
- Load matching 4A/4B knowledge for Batch Jobs before recommending design.
...
- When would you apply Batch Jobs on a Salesforce program?
