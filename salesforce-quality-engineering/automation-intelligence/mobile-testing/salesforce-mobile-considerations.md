---
title: Salesforce Mobile Considerations
...
keywords: [salesforce-mobile-considerations, automation-strategy, test-automation]
---

# Salesforce Mobile Considerations
...
Provide enterprise guidance on Salesforce Mobile Considerations for Salesforce automation intelligence.
## Business Context
...
- Salesforce Mobile Considerations fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Mobile Considerations on a Salesforce program?
...
- **Previous:** [Device Cloud Labs](device-cloud-labs.md)
