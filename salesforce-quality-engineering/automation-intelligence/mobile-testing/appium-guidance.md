...
keywords: [appium-guidance, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Appium Guidance for Salesforce automation intelligence.
## Business Context
...
- Appium Guidance fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Appium Guidance on a Salesforce program?
...
- **Previous:** [Mobile Automation Strategy](mobile-automation-strategy.md)
- **Next:** [Device Cloud Labs](device-cloud-labs.md)
