---
title: Mobile Automation Strategy
...
keywords: [mobile-automation-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Mobile Automation Strategy for Salesforce automation intelligence.
## Business Context
...
- Mobile Automation Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Mobile Automation Strategy on a Salesforce program?
...
- **Next:** [Appium Guidance](appium-guidance.md)
