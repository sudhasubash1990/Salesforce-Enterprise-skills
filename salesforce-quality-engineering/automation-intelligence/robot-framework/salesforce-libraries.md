...
tags: [automation-intelligence, sprint-8, robot-framework]
keywords: [salesforce-libraries, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Salesforce Libraries for Salesforce automation intelligence.
## Business Context
...
- Salesforce Libraries fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Libraries on a Salesforce program?
...
- **Previous:** [Keyword Design](keyword-design.md)
- **Next:** [Governance With Robot](governance-with-robot.md)
