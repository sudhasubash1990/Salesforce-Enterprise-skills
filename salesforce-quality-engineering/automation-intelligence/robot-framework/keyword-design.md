...
keywords: [keyword-design, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Keyword Design for Salesforce automation intelligence.
## Business Context
...
- Keyword Design fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Keyword Design on a Salesforce program?
...
- **Previous:** [Robot Architecture](robot-architecture.md)
- **Next:** [Salesforce Libraries](salesforce-libraries.md)
