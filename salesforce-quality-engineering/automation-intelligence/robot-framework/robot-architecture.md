...
keywords: [robot-architecture, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Robot Architecture for Salesforce automation intelligence.
## Business Context
...
- Robot Architecture fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Robot Architecture on a Salesforce program?
...
- **Next:** [Keyword Design](keyword-design.md)
