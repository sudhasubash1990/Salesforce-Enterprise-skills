...
keywords: [folder-structure, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Folder Structure for Salesforce automation intelligence.
## Business Context
...
- Folder Structure fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Folder Structure on a Salesforce program?
...
- **Previous:** [Naming Standards](naming-standards.md)
