...
keywords: [naming-standards, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Naming Standards for Salesforce automation intelligence.
## Business Context
...
- Naming Standards fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Naming Standards on a Salesforce program?
