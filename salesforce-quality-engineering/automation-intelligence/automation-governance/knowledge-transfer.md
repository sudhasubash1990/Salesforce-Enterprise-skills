...
keywords: [knowledge-transfer, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Knowledge Transfer for Salesforce automation intelligence.
## Business Context
...
- Knowledge Transfer fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Knowledge Transfer on a Salesforce program?
