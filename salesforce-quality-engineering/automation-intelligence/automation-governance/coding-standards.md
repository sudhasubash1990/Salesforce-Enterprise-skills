...
keywords: [coding-standards, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Coding Standards for Salesforce automation intelligence.
## Business Context
...
- Coding Standards fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Coding Standards on a Salesforce program?
...
- **Next:** [Naming Standards](naming-standards.md)
