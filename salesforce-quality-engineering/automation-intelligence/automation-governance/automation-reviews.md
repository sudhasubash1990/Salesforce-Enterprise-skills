...
tags: [automation-intelligence, sprint-8, automation-governance]
keywords: [automation-reviews, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Automation Reviews for Salesforce automation intelligence.
## Business Context
...
- Automation Reviews fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Reviews on a Salesforce program?
...
- **Previous:** [Framework Ownership](framework-ownership.md)
- **Next:** [Release Readiness](release-readiness.md)
