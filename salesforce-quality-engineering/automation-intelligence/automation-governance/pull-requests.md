...
keywords: [pull-requests, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Pull Requests for Salesforce automation intelligence.
## Business Context
...
- Pull Requests fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Pull Requests on a Salesforce program?
...
- **Previous:** [Code Reviews](code-reviews.md)
- **Next:** [Branch Strategy](branch-strategy.md)
