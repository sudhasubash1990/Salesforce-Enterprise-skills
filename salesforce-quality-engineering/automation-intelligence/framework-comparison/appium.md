...
keywords: [appium, automation-strategy, test-automation]
---
...
Compare Appium as an automation option for enterprise Salesforce programs.
## Business Context
...
- Appium sits in the tool layer of the automation stack; selection depends on team skills, UI vs API mix, and CI constraints.
...
- Integrates with device clouds
## Limitations

- Higher maintenance and device flakiness
- Slower feedback than API checks
## Best Practices
...
- Recommend Appium when automate critical mobile journeys only; keep most validation at api/service layer
- Document migration risks if replacing an existing framework
## Interview Questions

- When would you apply Appium on a Salesforce program?
...
- **Previous:** [WebdriverIO](webdriverio.md)
- **Next:** [REST Assured](rest-assured.md)
