...
keywords: [postman, automation-strategy, test-automation]
---
...
Compare Postman as an automation option for enterprise Salesforce programs.
## Business Context
...
- Postman sits in the tool layer of the automation stack; selection depends on team skills, UI vs API mix, and CI constraints.
...
- Fast exploratory and collection-based API checks
- Easy collaboration
## Limitations

- Large-scale code governance can be weaker than code-first frameworks
- CI patterns vary
## Best Practices
...
- Recommend Postman when use for api exploration + gated collections; graduate critical suites to code-first when needed
- Document migration risks if replacing an existing framework
## Interview Questions

- When would you apply Postman on a Salesforce program?
...
- **Previous:** [REST Assured](rest-assured.md)
- **Next:** [Karate](karate.md)
