...
keywords: [robot-framework, automation-strategy, test-automation]
---
...
Compare Robot Framework as an automation option for enterprise Salesforce programs.
## Business Context
...
- Robot Framework sits in the tool layer of the automation stack; selection depends on team skills, UI vs API mix, and CI constraints.
...
- Keyword readability for mixed-skill teams
- Rich library ecosystem
- Good for hybrid keyword+Python
## Limitations

- Abstraction can hide poor design
- UI stability still depends on underlying driver
## Best Practices
...
- Recommend Robot Framework when use for keyword-driven programs with clear library ownership
- Document migration risks if replacing an existing framework
## Interview Questions

- When would you apply Robot Framework on a Salesforce program?
...
- **Previous:** [Cypress](cypress.md)
- **Next:** [WebdriverIO](webdriverio.md)
