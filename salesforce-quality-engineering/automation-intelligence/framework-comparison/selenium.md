...
keywords: [selenium, automation-strategy, test-automation]
---
...
Compare Selenium as an automation option for enterprise Salesforce programs.
## Business Context
...
- Selenium sits in the tool layer of the automation stack; selection depends on team skills, UI vs API mix, and CI constraints.
...
- More boilerplate and wait discipline required
- Higher flake risk without strong design
## Best Practices
...
- Recommend Selenium when retain/optimize when migration cost exceeds benefit; plan gradual playwright pilots
- Document migration risks if replacing an existing framework
## Interview Questions

- When would you apply Selenium on a Salesforce program?
...
- **Previous:** [Playwright](playwright.md)
- **Next:** [Cypress](cypress.md)
