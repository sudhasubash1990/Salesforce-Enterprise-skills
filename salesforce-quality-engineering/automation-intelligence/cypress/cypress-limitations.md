...
keywords: [cypress-limitations, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Cypress Limitations for Salesforce automation intelligence.
## Business Context
...
- Cypress Limitations fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Cypress Limitations on a Salesforce program?
...
- **Previous:** [Cypress Architecture](cypress-architecture.md)
- **Next:** [Salesforce Fit](salesforce-fit.md)
