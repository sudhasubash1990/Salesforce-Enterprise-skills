...
keywords: [cypress-architecture, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Cypress Architecture for Salesforce automation intelligence.
## Business Context
...
- Cypress Architecture fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Cypress Architecture on a Salesforce program?
...
- **Next:** [Cypress Limitations](cypress-limitations.md)
