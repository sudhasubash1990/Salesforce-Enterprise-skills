...
keywords: [page-object-model, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Page Object Model for Salesforce automation intelligence.
## Business Context
...
- Page Object Model fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Page Object Model on a Salesforce program?
...
- **Previous:** [Layered Architecture](layered-architecture.md)
- **Next:** [Screenplay Pattern](screenplay-pattern.md)
