...
keywords: [data-driven-framework, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Data Driven Framework for Salesforce automation intelligence.
## Business Context
...
- Data Driven Framework fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Data Driven Framework on a Salesforce program?
...
- **Previous:** [Component Object Model](component-object-model.md)
- **Next:** [Keyword Driven Framework](keyword-driven-framework.md)
