...
keywords: [bdd-framework, automation-strategy, test-automation]
---
...
Provide enterprise guidance on BDD Framework for Salesforce automation intelligence.
## Business Context
...
- BDD Framework fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply BDD Framework on a Salesforce program?
...
- **Previous:** [Hybrid Framework](hybrid-framework.md)
- **Next:** [Reusable Utilities](reusable-utilities.md)
