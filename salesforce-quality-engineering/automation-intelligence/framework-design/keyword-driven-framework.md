...
keywords: [keyword-driven-framework, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Keyword Driven Framework for Salesforce automation intelligence.
## Business Context
...
- Keyword Driven Framework fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Keyword Driven Framework on a Salesforce program?
...
- **Previous:** [Data Driven Framework](data-driven-framework.md)
- **Next:** [Hybrid Framework](hybrid-framework.md)
