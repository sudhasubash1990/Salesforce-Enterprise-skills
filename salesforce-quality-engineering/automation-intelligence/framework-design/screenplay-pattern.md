...
keywords: [screenplay-pattern, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Screenplay Pattern for Salesforce automation intelligence.
## Business Context
...
- Screenplay Pattern fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Screenplay Pattern on a Salesforce program?
...
- **Previous:** [Page Object Model](page-object-model.md)
- **Next:** [Component Object Model](component-object-model.md)
