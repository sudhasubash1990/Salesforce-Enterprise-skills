...
keywords: [versioning, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Versioning for Salesforce automation intelligence.
## Business Context
...
- Versioning fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Versioning on a Salesforce program?
...
- **Previous:** [Secrets Management](secrets-management.md)
- **Next:** [Framework Scalability](framework-scalability.md)
