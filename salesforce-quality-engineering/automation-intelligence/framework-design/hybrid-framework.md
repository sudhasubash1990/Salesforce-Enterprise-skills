...
keywords: [hybrid-framework, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Hybrid Framework for Salesforce automation intelligence.
## Business Context
...
- Hybrid Framework fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Hybrid Framework on a Salesforce program?
...
- **Previous:** [Keyword Driven Framework](keyword-driven-framework.md)
- **Next:** [BDD Framework](bdd-framework.md)
