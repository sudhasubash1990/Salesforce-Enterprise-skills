...
keywords: [error-handling, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Error Handling for Salesforce automation intelligence.
## Business Context
...
- Error Handling fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Error Handling on a Salesforce program?
...
- **Previous:** [Reporting](reporting.md)
