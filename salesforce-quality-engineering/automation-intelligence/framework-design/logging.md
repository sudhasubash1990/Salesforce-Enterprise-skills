...
keywords: [logging, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Logging for Salesforce automation intelligence.
## Business Context
...
- Logging fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Logging on a Salesforce program?
...
- **Previous:** [Reusable Utilities](reusable-utilities.md)
