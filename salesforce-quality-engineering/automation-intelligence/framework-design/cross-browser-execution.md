...
keywords: [cross-browser-execution, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Cross Browser Execution for Salesforce automation intelligence.
## Business Context
...
- Cross Browser Execution fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Cross Browser Execution on a Salesforce program?
