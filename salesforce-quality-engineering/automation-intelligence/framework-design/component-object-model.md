...
keywords: [component-object-model, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Component Object Model for Salesforce automation intelligence.
## Business Context
...
- Component Object Model fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Component Object Model on a Salesforce program?
...
- **Previous:** [Screenplay Pattern](screenplay-pattern.md)
- **Next:** [Data Driven Framework](data-driven-framework.md)
