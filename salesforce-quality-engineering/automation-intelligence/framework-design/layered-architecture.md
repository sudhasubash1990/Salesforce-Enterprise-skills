...
keywords: [layered-architecture, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Layered Architecture for Salesforce automation intelligence.
## Business Context
...
- Layered Architecture fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Layered Architecture on a Salesforce program?
...
- **Next:** [Page Object Model](page-object-model.md)
