...
keywords: [roi, automation-strategy, test-automation]
---
...
Provide enterprise guidance on ROI for Salesforce automation intelligence.
## Business Context
...
- ROI fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply ROI on a Salesforce program?
...
- **Previous:** [Maintenance Effort](maintenance-effort.md)
- **Next:** [Defect Detection Rate](defect-detection-rate.md)
