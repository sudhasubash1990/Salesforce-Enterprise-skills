...
keywords: [script-stability, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Script Stability for Salesforce automation intelligence.
## Business Context
...
- Script Stability fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Script Stability on a Salesforce program?
...
- **Previous:** [Failure Rate](failure-rate.md)
- **Next:** [Flaky Tests](flaky-tests.md)
