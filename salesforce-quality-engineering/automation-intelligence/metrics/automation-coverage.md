...
keywords: [automation-coverage, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Automation Coverage for Salesforce automation intelligence.
## Business Context
...
- Automation Coverage fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Automation Coverage on a Salesforce program?
...
- **Next:** [Execution Time](execution-time.md)
