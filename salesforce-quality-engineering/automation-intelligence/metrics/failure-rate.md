...
keywords: [failure-rate, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Failure Rate for Salesforce automation intelligence.
## Business Context
...
- Failure Rate fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Failure Rate on a Salesforce program?
...
- **Previous:** [Pass Rate](pass-rate.md)
- **Next:** [Script Stability](script-stability.md)
