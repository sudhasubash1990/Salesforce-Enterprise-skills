...
keywords: [execution-cost, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Execution Cost for Salesforce automation intelligence.
## Business Context
...
- Execution Cost fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Execution Cost on a Salesforce program?
...
- **Previous:** [Defect Detection Rate](defect-detection-rate.md)
