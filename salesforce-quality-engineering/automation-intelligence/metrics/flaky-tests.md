...
keywords: [flaky-tests, automation-strategy, test-automation]
---
...
Measure and act on flaky automation using Sprint 7 stability rules.
## Business Context
...
- Flaky Tests fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Flaky Tests on a Salesforce program?
...
- **Previous:** [Script Stability](script-stability.md)
- **Next:** [Maintenance Effort](maintenance-effort.md)
