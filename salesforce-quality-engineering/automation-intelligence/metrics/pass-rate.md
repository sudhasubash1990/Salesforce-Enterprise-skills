...
keywords: [pass-rate, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Pass Rate for Salesforce automation intelligence.
## Business Context
...
- Pass Rate fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Pass Rate on a Salesforce program?
...
- **Previous:** [Execution Time](execution-time.md)
- **Next:** [Failure Rate](failure-rate.md)
