...
keywords: [defect-detection-rate, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Defect Detection Rate for Salesforce automation intelligence.
## Business Context
...
- Defect Detection Rate fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Defect Detection Rate on a Salesforce program?
...
- **Previous:** [ROI](roi.md)
- **Next:** [Execution Cost](execution-cost.md)
