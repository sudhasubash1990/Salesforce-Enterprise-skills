...
keywords: [stable-locator-patterns, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Stable Locator Patterns for Salesforce automation intelligence.
## Business Context
...
- Stable Locator Patterns fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Stable Locator Patterns on a Salesforce program?
...
- **Next:** [Fixture And Setup Patterns](fixture-and-setup-patterns.md)
