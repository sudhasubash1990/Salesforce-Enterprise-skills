...
keywords: [framework-selection, automation-strategy, test-automation]
---
...
Guide the AI on Framework Selection within the Automation Decision Engine.
## Business Context
...
- When would you apply Framework Selection on a Salesforce program?
...
- **Previous:** [Should Automate](should-automate.md)
- **Next:** [Effort And Roi](effort-and-roi.md)
