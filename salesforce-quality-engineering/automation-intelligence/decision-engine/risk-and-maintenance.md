...
keywords: [risk-and-maintenance, automation-strategy, test-automation]
---
...
Guide the AI on Risk And Maintenance within the Automation Decision Engine.
## Business Context
...
- When would you apply Risk And Maintenance on a Salesforce program?
...
- **Previous:** [Effort And Roi](effort-and-roi.md)
- **Next:** [Ci Cd Readiness](ci-cd-readiness.md)
