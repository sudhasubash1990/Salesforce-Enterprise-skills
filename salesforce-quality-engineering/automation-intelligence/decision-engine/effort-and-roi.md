...
tags: [automation-intelligence, sprint-8, decision-engine]
keywords: [effort-and-roi, automation-strategy, test-automation]
---
...
Guide the AI on Effort And Roi within the Automation Decision Engine.
## Business Context
...
- When would you apply Effort And Roi on a Salesforce program?
...
- **Previous:** [Framework Selection](framework-selection.md)
- **Next:** [Risk And Maintenance](risk-and-maintenance.md)
