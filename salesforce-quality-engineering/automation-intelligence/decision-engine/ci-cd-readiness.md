...
keywords: [ci-cd-readiness, automation-strategy, test-automation]
---
...
Guide the AI on Ci Cd Readiness within the Automation Decision Engine.
## Business Context
...
- When would you apply Ci Cd Readiness on a Salesforce program?
...
- **Previous:** [Risk And Maintenance](risk-and-maintenance.md)
- **Next:** [Priority Scoring](priority-scoring.md)
