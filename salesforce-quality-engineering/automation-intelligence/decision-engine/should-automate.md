...
keywords: [should-automate, automation-strategy, test-automation]
---
...
Guide the AI on Should Automate within the Automation Decision Engine.
## Business Context
...
- When would you apply Should Automate on a Salesforce program?
...
- **Next:** [Framework Selection](framework-selection.md)
