...
keywords: [priority-scoring, automation-strategy, test-automation]
---
...
Guide the AI on Priority Scoring within the Automation Decision Engine.
## Business Context
...
- When would you apply Priority Scoring on a Salesforce program?
...
- **Previous:** [Ci Cd Readiness](ci-cd-readiness.md)
