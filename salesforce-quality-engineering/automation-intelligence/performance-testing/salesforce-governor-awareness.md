---
title: Salesforce Governor Awareness
...
tags: [automation-intelligence, sprint-8, performance-testing]
keywords: [salesforce-governor-awareness, automation-strategy, test-automation]
---

# Salesforce Governor Awareness
...
Provide enterprise guidance on Salesforce Governor Awareness for Salesforce automation intelligence.
## Business Context
...
- Salesforce Governor Awareness fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Governor Awareness on a Salesforce program?
...
- **Previous:** [Performance Strategy](performance-strategy.md)
- **Next:** [Api Load Considerations](api-load-considerations.md)
