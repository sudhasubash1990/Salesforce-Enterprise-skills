...
keywords: [performance-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Performance Strategy for Salesforce automation intelligence.
## Business Context
...
- Performance Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Performance Strategy on a Salesforce program?
...
- **Next:** [Salesforce Governor Awareness](salesforce-governor-awareness.md)
