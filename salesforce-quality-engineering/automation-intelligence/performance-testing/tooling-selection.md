...
keywords: [tooling-selection, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Tooling Selection for Salesforce automation intelligence.
## Business Context
...
- Tooling Selection fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Tooling Selection on a Salesforce program?
...
- **Previous:** [Api Load Considerations](api-load-considerations.md)
