...
keywords: [environment-promotion, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Environment Promotion for Salesforce automation intelligence.
## Business Context
...
- Environment Promotion fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Environment Promotion on a Salesforce program?
...
- **Next:** [Approval Gates](approval-gates.md)
