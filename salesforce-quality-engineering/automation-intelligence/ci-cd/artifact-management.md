...
keywords: [artifact-management, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Artifact Management for Salesforce automation intelligence.
## Business Context
...
- Artifact Management fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Artifact Management on a Salesforce program?
...
- **Previous:** [Notifications](notifications.md)
