...
keywords: [build-validation, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Build Validation for Salesforce automation intelligence.
## Business Context
...
- Build Validation fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Build Validation on a Salesforce program?
...
- **Previous:** [Jenkins](jenkins.md)
- **Next:** [Smoke Execution](smoke-execution.md)
