...
keywords: [github-actions, automation-strategy, test-automation]
---
...
Design GitHub Actions workflows for automation execution and publishing.
## Business Context
...
- GitHub Actions fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply GitHub Actions on a Salesforce program?
...
- **Previous:** [Azure DevOps Pipelines](azure-devops-pipelines.md)
