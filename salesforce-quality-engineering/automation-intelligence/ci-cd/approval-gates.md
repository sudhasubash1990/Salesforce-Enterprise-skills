...
keywords: [approval-gates, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Approval Gates for Salesforce automation intelligence.
## Business Context
...
- Approval Gates fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Approval Gates on a Salesforce program?
...
- **Previous:** [Environment Promotion](environment-promotion.md)
