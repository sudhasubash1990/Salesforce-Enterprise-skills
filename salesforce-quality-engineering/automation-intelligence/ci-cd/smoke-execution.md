...
keywords: [smoke-execution, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Smoke Execution for Salesforce automation intelligence.
## Business Context
...
- Smoke Execution fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Smoke Execution on a Salesforce program?
...
- **Previous:** [Build Validation](build-validation.md)
- **Next:** [Regression Execution](regression-execution.md)
