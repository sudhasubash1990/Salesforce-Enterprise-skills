...
keywords: [rollback-strategy, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Rollback Strategy for Salesforce automation intelligence.
## Business Context
...
- Rollback Strategy fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Rollback Strategy on a Salesforce program?
