...
keywords: [jenkins, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Jenkins for Salesforce automation intelligence.
## Business Context
...
- Jenkins fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Jenkins on a Salesforce program?
...
- **Previous:** [GitHub Actions](github-actions.md)
- **Next:** [Build Validation](build-validation.md)
