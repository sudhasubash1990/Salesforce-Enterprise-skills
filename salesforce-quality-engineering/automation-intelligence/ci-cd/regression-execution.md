...
keywords: [regression-execution, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Regression Execution for Salesforce automation intelligence.
## Business Context
...
- Regression Execution fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Regression Execution on a Salesforce program?
...
- **Previous:** [Smoke Execution](smoke-execution.md)
