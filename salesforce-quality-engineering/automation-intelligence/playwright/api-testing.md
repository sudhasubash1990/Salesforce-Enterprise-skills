...
keywords: [api-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on API Testing for Salesforce automation intelligence.
## Business Context
...
- API Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply API Testing on a Salesforce program?
...
- **Previous:** [Page Objects](page-objects.md)
