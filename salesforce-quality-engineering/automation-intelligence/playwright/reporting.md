...
keywords: [reporting, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Reporting for Salesforce automation intelligence.
## Business Context
...
- Reporting fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Reporting on a Salesforce program?
...
- **Previous:** [Tracing](tracing.md)
- **Next:** [Retry Strategy](retry-strategy.md)
