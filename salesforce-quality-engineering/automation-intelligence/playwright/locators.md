...
keywords: [locators, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Locators for Salesforce automation intelligence.
## Business Context
...
- Locators fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Locators on a Salesforce program?
