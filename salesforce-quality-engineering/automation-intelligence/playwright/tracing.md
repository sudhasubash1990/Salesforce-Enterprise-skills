...
keywords: [tracing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Tracing for Salesforce automation intelligence.
## Business Context
...
- Tracing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Tracing on a Salesforce program?
...
- **Previous:** [Visual Testing](visual-testing.md)
