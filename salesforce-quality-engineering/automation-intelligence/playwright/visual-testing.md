...
keywords: [visual-testing, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Visual Testing for Salesforce automation intelligence.
## Business Context
...
- Visual Testing fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Visual Testing on a Salesforce program?
...
- **Previous:** [Storage State](storage-state.md)
