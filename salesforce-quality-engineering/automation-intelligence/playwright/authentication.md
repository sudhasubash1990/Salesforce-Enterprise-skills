...
keywords: [authentication, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Authentication for Salesforce automation intelligence.
## Business Context
...
- Authentication fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Authentication on a Salesforce program?
...
- **Previous:** [API Testing](api-testing.md)
- **Next:** [Storage State](storage-state.md)
