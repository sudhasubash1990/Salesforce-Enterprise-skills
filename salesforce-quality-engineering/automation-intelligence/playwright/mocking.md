...
keywords: [mocking, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Mocking for Salesforce automation intelligence.
## Business Context
...
- Mocking fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Mocking on a Salesforce program?
...
- **Next:** [Network Interception](network-interception.md)
