...
keywords: [salesforce-best-practices, automation-strategy, test-automation]
---
...
Playwright practices tailored to Lightning and Salesforce testing constraints.
## Business Context
...
- Salesforce Best Practices fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Salesforce Best Practices on a Salesforce program?
...
- **Previous:** [Ci Cd Integration](ci-cd-integration.md)
- **Next:** [Common Failures](common-failures.md)
