...
keywords: [common-failures, automation-strategy, test-automation]
---
...
Catalog common Playwright+Salesforce failure modes and prevention.
## Business Context
...
- Common Failures fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Common Failures on a Salesforce program?
...
- **Previous:** [Salesforce Best Practices](salesforce-best-practices.md)
