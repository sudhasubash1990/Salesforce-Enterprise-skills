...
keywords: [fixtures, automation-strategy, test-automation]
---
...
Provide enterprise guidance on Fixtures for Salesforce automation intelligence.
## Business Context
...
- Fixtures fits a layered automation architecture: tests → abstractions → drivers/clients → CI/CD → reporting.
...
- When would you apply Fixtures on a Salesforce program?
...
- **Previous:** [Locators](locators.md)
- **Next:** [Page Objects](page-objects.md)
