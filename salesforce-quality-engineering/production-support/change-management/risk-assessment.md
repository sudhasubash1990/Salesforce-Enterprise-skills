...
keywords: [risk-assessment, production-support, operational-excellence]
---
...
Provide enterprise guidance on Risk Assessment for Salesforce production operations.
## Business Context
...
- Map Risk Assessment into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Risk Assessment activities with clear owners and timeboxes
...
- How do you apply Risk Assessment on an enterprise Salesforce program?
...
- **Previous:** [Standard Changes](standard-changes.md)
- **Next:** [Impact Assessment](impact-assessment.md)
