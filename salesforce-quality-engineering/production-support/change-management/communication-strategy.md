...
keywords: [communication-strategy, production-support, operational-excellence]
---
...
Provide enterprise guidance on Communication Strategy for Salesforce production operations.
## Business Context
...
- Map Communication Strategy into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Communication Strategy activities with clear owners and timeboxes
...
- How do you apply Communication Strategy on an enterprise Salesforce program?
...
- **Previous:** [Approval Workflow](approval-workflow.md)
