...
keywords: [emergency-changes, production-support, operational-excellence]
---
...
Provide enterprise guidance on Emergency Changes for Salesforce production operations.
## Business Context
...
- Map Emergency Changes into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Emergency Changes activities with clear owners and timeboxes
...
- How do you apply Emergency Changes on an enterprise Salesforce program?
...
- **Previous:** [CAB Meetings](cab-meetings.md)
- **Next:** [Normal Changes](normal-changes.md)
