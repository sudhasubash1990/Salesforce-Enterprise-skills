...
keywords: [rollback-planning, production-support, operational-excellence]
---
...
Provide enterprise guidance on Rollback Planning for Salesforce production operations.
## Business Context
...
- Map Rollback Planning into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Rollback Planning activities with clear owners and timeboxes
...
- How do you apply Rollback Planning on an enterprise Salesforce program?
...
- **Previous:** [Change Validation](change-validation.md)
- **Next:** [Approval Workflow](approval-workflow.md)
