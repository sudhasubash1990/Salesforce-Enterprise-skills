...
keywords: [standard-changes, production-support, operational-excellence]
---
...
Provide enterprise guidance on Standard Changes for Salesforce production operations.
## Business Context
...
- Map Standard Changes into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Standard Changes activities with clear owners and timeboxes
...
- How do you apply Standard Changes on an enterprise Salesforce program?
...
- **Previous:** [Normal Changes](normal-changes.md)
- **Next:** [Risk Assessment](risk-assessment.md)
