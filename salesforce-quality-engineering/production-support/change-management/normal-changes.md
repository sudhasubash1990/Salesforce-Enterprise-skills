...
keywords: [normal-changes, production-support, operational-excellence]
---
...
Provide enterprise guidance on Normal Changes for Salesforce production operations.
## Business Context
...
- Map Normal Changes into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Normal Changes activities with clear owners and timeboxes
...
- How do you apply Normal Changes on an enterprise Salesforce program?
...
- **Previous:** [Emergency Changes](emergency-changes.md)
- **Next:** [Standard Changes](standard-changes.md)
