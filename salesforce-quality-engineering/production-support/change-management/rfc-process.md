...
keywords: [rfc-process, production-support, operational-excellence]
---
...
Provide enterprise guidance on RFC Process for Salesforce production operations.
## Business Context
...
- Map RFC Process into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute RFC Process activities with clear owners and timeboxes
...
- How do you apply RFC Process on an enterprise Salesforce program?
...
- **Next:** [CAB Meetings](cab-meetings.md)
