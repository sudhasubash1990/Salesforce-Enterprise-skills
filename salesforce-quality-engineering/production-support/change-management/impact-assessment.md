...
keywords: [impact-assessment, production-support, operational-excellence]
---
...
Provide enterprise guidance on Impact Assessment for Salesforce production operations.
## Business Context
...
- Map Impact Assessment into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Impact Assessment activities with clear owners and timeboxes
...
- How do you apply Impact Assessment on an enterprise Salesforce program?
...
- **Previous:** [Risk Assessment](risk-assessment.md)
- **Next:** [Change Validation](change-validation.md)
