...
keywords: [change-validation, production-support, operational-excellence]
---
...
Provide enterprise guidance on Change Validation for Salesforce production operations.
## Business Context
...
- Map Change Validation into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Change Validation activities with clear owners and timeboxes
...
- How do you apply Change Validation on an enterprise Salesforce program?
...
- **Previous:** [Impact Assessment](impact-assessment.md)
- **Next:** [Rollback Planning](rollback-planning.md)
