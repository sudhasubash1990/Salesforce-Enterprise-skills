...
keywords: [on-call-playbook, production-support, operational-excellence]
---
...
Provide enterprise guidance on On Call Playbook for Salesforce production operations.
## Business Context
...
- Map On Call Playbook into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute On Call Playbook activities with clear owners and timeboxes
...
- How do you apply On Call Playbook on an enterprise Salesforce program?
...
- **Next:** [Triage Playbook](triage-playbook.md)
