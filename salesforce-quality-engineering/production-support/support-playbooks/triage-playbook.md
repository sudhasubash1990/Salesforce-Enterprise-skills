...
keywords: [triage-playbook, production-support, operational-excellence]
---
...
Provide enterprise guidance on Triage Playbook for Salesforce production operations.
## Business Context
...
- Map Triage Playbook into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Triage Playbook activities with clear owners and timeboxes
...
- How do you apply Triage Playbook on an enterprise Salesforce program?
...
- **Previous:** [On Call Playbook](on-call-playbook.md)
- **Next:** [Major Incident Playbook](major-incident-playbook.md)
