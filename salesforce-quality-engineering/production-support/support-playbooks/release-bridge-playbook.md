...
keywords: [release-bridge-playbook, production-support, operational-excellence]
---

# Release Bridge Playbook
...
Provide enterprise guidance on Release Bridge Playbook for Salesforce production operations.
## Business Context
...
- Map Release Bridge Playbook into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Bridge Playbook activities with clear owners and timeboxes
...
- How do you apply Release Bridge Playbook on an enterprise Salesforce program?
...
- **Previous:** [Service Review Playbook](service-review-playbook.md)
