...
keywords: [major-incident-playbook, production-support, operational-excellence]
---
...
Provide enterprise guidance on Major Incident Playbook for Salesforce production operations.
## Business Context
...
- Map Major Incident Playbook into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Major Incident Playbook activities with clear owners and timeboxes
...
- How do you apply Major Incident Playbook on an enterprise Salesforce program?
...
- **Previous:** [Triage Playbook](triage-playbook.md)
- **Next:** [Hypercare Exit Playbook](hypercare-exit-playbook.md)
