...
keywords: [operational-dashboard, production-support, operational-excellence]
---
...
Provide enterprise guidance on Operational Dashboard for Salesforce production operations.
## Business Context
...
- Map Operational Dashboard into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Operational Dashboard activities with clear owners and timeboxes
...
- How do you apply Operational Dashboard on an enterprise Salesforce program?
...
- **Previous:** [Release Report](release-report.md)
- **Next:** [Executive Dashboard](executive-dashboard.md)
