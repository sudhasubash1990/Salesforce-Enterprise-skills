...
tags: [production-support, sprint-9, executive-reporting]
keywords: [weekly-operations-report, production-support, operational-excellence]
---
...
Provide enterprise guidance on Weekly Operations Report for Salesforce production operations.
## Business Context
...
- Map Weekly Operations Report into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Weekly Operations Report activities with clear owners and timeboxes
...
- How do you apply Weekly Operations Report on an enterprise Salesforce program?
...
- **Previous:** [Daily Support Report](daily-support-report.md)
- **Next:** [Production Health Report](production-health-report.md)
