...
keywords: [release-report, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Report for Salesforce production operations.
## Business Context
...
- Map Release Report into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Report activities with clear owners and timeboxes
...
- How do you apply Release Report on an enterprise Salesforce program?
...
- **Previous:** [Problem Report](problem-report.md)
- **Next:** [Operational Dashboard](operational-dashboard.md)
