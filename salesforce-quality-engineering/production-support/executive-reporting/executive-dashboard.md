...
keywords: [executive-dashboard, production-support, operational-excellence]
---
...
Provide enterprise guidance on Executive Dashboard for Salesforce production operations.
## Business Context
...
- Map Executive Dashboard into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Executive Dashboard activities with clear owners and timeboxes
...
- How do you apply Executive Dashboard on an enterprise Salesforce program?
...
- **Previous:** [Operational Dashboard](operational-dashboard.md)
- **Next:** [Service Review Report](service-review-report.md)
