...
keywords: [incident-summary, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Summary for Salesforce production operations.
## Business Context
...
- Map Incident Summary into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Summary activities with clear owners and timeboxes
...
- How do you apply Incident Summary on an enterprise Salesforce program?
...
- **Previous:** [Hypercare Report](hypercare-report.md)
- **Next:** [Problem Report](problem-report.md)
