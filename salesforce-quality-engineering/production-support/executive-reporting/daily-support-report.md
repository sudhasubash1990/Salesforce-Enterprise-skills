...
keywords: [daily-support-report, production-support, operational-excellence]
---
...
Provide enterprise guidance on Daily Support Report for Salesforce production operations.
## Business Context
...
- Map Daily Support Report into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Daily Support Report activities with clear owners and timeboxes
...
- How do you apply Daily Support Report on an enterprise Salesforce program?
...
- **Next:** [Weekly Operations Report](weekly-operations-report.md)
