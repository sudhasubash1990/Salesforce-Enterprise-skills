...
keywords: [hypercare-report, production-support, operational-excellence]
---
...
Provide enterprise guidance on Hypercare Report for Salesforce production operations.
## Business Context
...
- Map Hypercare Report into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Hypercare Report activities with clear owners and timeboxes
...
- How do you apply Hypercare Report on an enterprise Salesforce program?
...
- **Previous:** [Production Health Report](production-health-report.md)
- **Next:** [Incident Summary](incident-summary.md)
