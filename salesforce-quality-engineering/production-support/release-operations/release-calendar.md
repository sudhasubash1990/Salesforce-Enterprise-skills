...
keywords: [release-calendar, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Calendar for Salesforce production operations.
## Business Context
...
- Map Release Calendar into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Calendar activities with clear owners and timeboxes
...
- How do you apply Release Calendar on an enterprise Salesforce program?
