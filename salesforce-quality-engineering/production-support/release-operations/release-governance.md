...
keywords: [release-governance, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Governance for Salesforce production operations.
## Business Context
...
- Map Release Governance into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Governance activities with clear owners and timeboxes
...
- How do you apply Release Governance on an enterprise Salesforce program?
...
- **Previous:** [Release Metrics](release-metrics.md)
- **Next:** [Environment Coordination](environment-coordination.md)
