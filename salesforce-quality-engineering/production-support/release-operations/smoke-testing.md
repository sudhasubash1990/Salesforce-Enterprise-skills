...
keywords: [smoke-testing, production-support, operational-excellence]
---
...
Provide enterprise guidance on Smoke Testing for Salesforce production operations.
## Business Context
...
- Map Smoke Testing into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Smoke Testing activities with clear owners and timeboxes
...
- How do you apply Smoke Testing on an enterprise Salesforce program?
...
- **Previous:** [Release Communication](release-communication.md)
- **Next:** [Production Validation](production-validation.md)
