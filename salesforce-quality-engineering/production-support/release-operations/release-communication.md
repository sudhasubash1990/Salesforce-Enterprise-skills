...
keywords: [release-communication, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Communication for Salesforce production operations.
## Business Context
...
- Map Release Communication into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Communication activities with clear owners and timeboxes
...
- How do you apply Release Communication on an enterprise Salesforce program?
