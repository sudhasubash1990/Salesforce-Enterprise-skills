...
keywords: [environment-coordination, production-support, operational-excellence]
---
...
Provide enterprise guidance on Environment Coordination for Salesforce production operations.
## Business Context
...
- Map Environment Coordination into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Environment Coordination activities with clear owners and timeboxes
...
- How do you apply Environment Coordination on an enterprise Salesforce program?
...
- **Previous:** [Release Governance](release-governance.md)
