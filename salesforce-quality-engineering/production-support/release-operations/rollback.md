...
keywords: [rollback, production-support, operational-excellence]
---
...
Provide enterprise guidance on Rollback for Salesforce production operations.
## Business Context
...
- Map Rollback into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Rollback activities with clear owners and timeboxes
...
- How do you apply Rollback on an enterprise Salesforce program?
...
- **Previous:** [Release Monitoring](release-monitoring.md)
- **Next:** [Release Metrics](release-metrics.md)
