...
keywords: [release-metrics, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Metrics for Salesforce production operations.
## Business Context
...
- Map Release Metrics into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Metrics activities with clear owners and timeboxes
...
- How do you apply Release Metrics on an enterprise Salesforce program?
...
- **Next:** [Release Governance](release-governance.md)
