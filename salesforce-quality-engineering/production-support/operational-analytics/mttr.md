...
keywords: [mttr, production-support, operational-excellence]
---
...
Provide enterprise guidance on MTTR for Salesforce production operations.
## Business Context
...
- Map MTTR into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute MTTR activities with clear owners and timeboxes
...
- How do you apply MTTR on an enterprise Salesforce program?
...
- **Previous:** [Sla Breaches](sla-breaches.md)
- **Next:** [MTBF](mtbf.md)
