...
keywords: [business-impact, production-support, operational-excellence]
---
...
Provide enterprise guidance on Business Impact for Salesforce production operations.
## Business Context
...
- Map Business Impact into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Business Impact activities with clear owners and timeboxes
...
- How do you apply Business Impact on an enterprise Salesforce program?
...
- **Previous:** [Production Stability](production-stability.md)
- **Next:** [Support Effort](support-effort.md)
