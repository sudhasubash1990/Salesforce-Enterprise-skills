...
keywords: [support-trends, production-support, operational-excellence]
---
...
Provide enterprise guidance on Support Trends for Salesforce production operations.
## Business Context
...
- Map Support Trends into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Support Trends activities with clear owners and timeboxes
...
- How do you apply Support Trends on an enterprise Salesforce program?
...
- **Previous:** [Release Trends](release-trends.md)
- **Next:** [Recurring Failures](recurring-failures.md)
