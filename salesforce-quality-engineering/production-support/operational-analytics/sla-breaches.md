...
keywords: [sla-breaches, production-support, operational-excellence]
---
...
Provide enterprise guidance on Sla Breaches for Salesforce production operations.
## Business Context
...
- Map Sla Breaches into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Sla Breaches activities with clear owners and timeboxes
...
- How do you apply Sla Breaches on an enterprise Salesforce program?
...
- **Previous:** [High Volume Incidents](high-volume-incidents.md)
- **Next:** [MTTR](mttr.md)
