...
tags: [production-support, sprint-9, operational-analytics]
keywords: [high-risk-components, production-support, operational-excellence]
---
...
Provide enterprise guidance on High Risk Components for Salesforce production operations.
## Business Context
...
- Map High Risk Components into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute High Risk Components activities with clear owners and timeboxes
...
- How do you apply High Risk Components on an enterprise Salesforce program?
...
- **Previous:** [Recurring Failures](recurring-failures.md)
- **Next:** [High Volume Incidents](high-volume-incidents.md)
