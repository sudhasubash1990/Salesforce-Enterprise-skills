...
keywords: [recurring-failures, production-support, operational-excellence]
---
...
Provide enterprise guidance on Recurring Failures for Salesforce production operations.
## Business Context
...
- Map Recurring Failures into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Recurring Failures activities with clear owners and timeboxes
...
- How do you apply Recurring Failures on an enterprise Salesforce program?
...
- **Previous:** [Support Trends](support-trends.md)
- **Next:** [High Risk Components](high-risk-components.md)
