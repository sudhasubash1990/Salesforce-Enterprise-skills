...
keywords: [mtbf, production-support, operational-excellence]
---
...
Provide enterprise guidance on MTBF for Salesforce production operations.
## Business Context
...
- Map MTBF into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute MTBF activities with clear owners and timeboxes
...
- How do you apply MTBF on an enterprise Salesforce program?
