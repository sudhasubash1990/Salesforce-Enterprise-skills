...
keywords: [corrective-actions, production-support, operational-excellence]
---
...
Provide enterprise guidance on Corrective Actions for Salesforce production operations.
## Business Context
...
- Map Corrective Actions into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Corrective Actions activities with clear owners and timeboxes
...
- How do you apply Corrective Actions on an enterprise Salesforce program?
...
- **Previous:** [Preventive Actions](preventive-actions.md)
- **Next:** [Problem Closure](problem-closure.md)
