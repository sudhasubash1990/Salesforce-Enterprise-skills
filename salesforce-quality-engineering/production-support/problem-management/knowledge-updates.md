...
keywords: [knowledge-updates, production-support, operational-excellence]
---
...
Provide enterprise guidance on Knowledge Updates for Salesforce production operations.
## Business Context
...
- Map Knowledge Updates into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Knowledge Updates activities with clear owners and timeboxes
...
- How do you apply Knowledge Updates on an enterprise Salesforce program?
...
- **Previous:** [Problem Closure](problem-closure.md)
- **Next:** [Continuous Improvement](continuous-improvement.md)
