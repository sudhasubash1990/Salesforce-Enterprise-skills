...
keywords: [preventive-actions, production-support, operational-excellence]
---
...
Provide enterprise guidance on Preventive Actions for Salesforce production operations.
## Business Context
...
- Map Preventive Actions into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Preventive Actions activities with clear owners and timeboxes
...
- How do you apply Preventive Actions on an enterprise Salesforce program?
...
- **Previous:** [Trend Analysis](trend-analysis.md)
- **Next:** [Corrective Actions](corrective-actions.md)
