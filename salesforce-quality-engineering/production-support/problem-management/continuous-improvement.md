...
keywords: [continuous-improvement, production-support, operational-excellence]
---
...
Provide enterprise guidance on Continuous Improvement for Salesforce production operations.
## Business Context
...
- Map Continuous Improvement into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Continuous Improvement activities with clear owners and timeboxes
...
- How do you apply Continuous Improvement on an enterprise Salesforce program?
...
- **Previous:** [Knowledge Updates](knowledge-updates.md)
