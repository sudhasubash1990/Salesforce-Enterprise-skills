...
keywords: [platform-events, production-support, operational-excellence]
---
...
Provide enterprise guidance on Platform Events for Salesforce production operations.
## Business Context
...
- Map Platform Events into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Platform Events activities with clear owners and timeboxes
...
- How do you apply Platform Events on an enterprise Salesforce program?
...
- **Previous:** [Flow Monitoring](flow-monitoring.md)
- **Next:** [Integration Monitoring](integration-monitoring.md)
