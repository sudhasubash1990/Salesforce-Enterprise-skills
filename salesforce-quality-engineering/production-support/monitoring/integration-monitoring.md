...
keywords: [integration-monitoring, production-support, operational-excellence]
---
...
Provide enterprise guidance on Integration Monitoring for Salesforce production operations.
## Business Context
...
- Map Integration Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Integration Monitoring activities with clear owners and timeboxes
...
- How do you apply Integration Monitoring on an enterprise Salesforce program?
...
- **Previous:** [Platform Events](platform-events.md)
- **Next:** [Api Monitoring](api-monitoring.md)
