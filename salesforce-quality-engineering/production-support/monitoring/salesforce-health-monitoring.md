---
title: Salesforce Health Monitoring
...
tags: [production-support, sprint-9, monitoring]
keywords: [salesforce-health-monitoring, production-support, operational-excellence]
---

# Salesforce Health Monitoring
...
Provide enterprise guidance on Salesforce Health Monitoring for Salesforce production operations.
## Business Context
...
- Map Salesforce Health Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Salesforce Health Monitoring activities with clear owners and timeboxes
...
- How do you apply Salesforce Health Monitoring on an enterprise Salesforce program?
...
- **Next:** [Batch Monitoring](batch-monitoring.md)
