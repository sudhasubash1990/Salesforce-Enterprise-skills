...
keywords: [login-monitoring, production-support, operational-excellence]
---
...
Provide enterprise guidance on Login Monitoring for Salesforce production operations.
## Business Context
...
- Map Login Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Login Monitoring activities with clear owners and timeboxes
...
- How do you apply Login Monitoring on an enterprise Salesforce program?
...
- **Previous:** [Security Monitoring](security-monitoring.md)
- **Next:** [Performance Monitoring](performance-monitoring.md)
