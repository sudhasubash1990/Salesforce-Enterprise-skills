...
keywords: [security-monitoring, production-support, operational-excellence]
---
...
Provide enterprise guidance on Security Monitoring for Salesforce production operations.
## Business Context
...
- Map Security Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Security Monitoring activities with clear owners and timeboxes
...
- How do you apply Security Monitoring on an enterprise Salesforce program?
...
- **Previous:** [Data Monitoring](data-monitoring.md)
- **Next:** [Login Monitoring](login-monitoring.md)
