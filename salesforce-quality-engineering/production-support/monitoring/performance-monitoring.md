...
keywords: [performance-monitoring, production-support, operational-excellence]
---
...
Provide enterprise guidance on Performance Monitoring for Salesforce production operations.
## Business Context
...
- Map Performance Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Performance Monitoring activities with clear owners and timeboxes
...
- How do you apply Performance Monitoring on an enterprise Salesforce program?
...
- **Previous:** [Login Monitoring](login-monitoring.md)
- **Next:** [Dashboard Monitoring](dashboard-monitoring.md)
