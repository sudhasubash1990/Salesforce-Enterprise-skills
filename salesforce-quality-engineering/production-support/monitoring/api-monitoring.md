...
keywords: [api-monitoring, production-support, operational-excellence]
---
...
Provide enterprise guidance on Api Monitoring for Salesforce production operations.
## Business Context
...
- Map Api Monitoring into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Api Monitoring activities with clear owners and timeboxes
...
- How do you apply Api Monitoring on an enterprise Salesforce program?
...
- **Previous:** [Integration Monitoring](integration-monitoring.md)
- **Next:** [Data Monitoring](data-monitoring.md)
