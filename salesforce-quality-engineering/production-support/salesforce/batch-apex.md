...
keywords: [batch-apex, production-support, operational-excellence]
---
...
Guide production troubleshooting for Salesforce Batch Apex.
## Business Context
...
- Map Batch Apex into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- How do you apply Batch Apex on an enterprise Salesforce program?
...
- **Next:** [Scheduled Jobs](scheduled-jobs.md)
