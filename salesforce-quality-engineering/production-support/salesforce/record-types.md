...
keywords: [record-types, production-support, operational-excellence]
---
...
Guide production troubleshooting for Salesforce Record Types.
## Business Context
...
- Map Record Types into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- How do you apply Record Types on an enterprise Salesforce program?
...
- **Previous:** [Sharing Rules](sharing-rules.md)
