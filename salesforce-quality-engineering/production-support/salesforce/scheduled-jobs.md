...
keywords: [scheduled-jobs, production-support, operational-excellence]
---
...
Guide production troubleshooting for Salesforce Scheduled Jobs.
## Business Context
...
- Map Scheduled Jobs into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- How do you apply Scheduled Jobs on an enterprise Salesforce program?
...
- **Previous:** [Batch Apex](batch-apex.md)
- **Next:** [Queueable Apex](queueable-apex.md)
