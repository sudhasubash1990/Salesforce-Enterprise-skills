...
keywords: [severity-matrix, production-support, operational-excellence]
---
...
Provide enterprise guidance on Severity Matrix for Salesforce production operations.
## Business Context
...
- Map Severity Matrix into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Severity Matrix activities with clear owners and timeboxes
...
- How do you apply Severity Matrix on an enterprise Salesforce program?
...
- **Previous:** [Incident Classification](incident-classification.md)
- **Next:** [Priority Matrix](priority-matrix.md)
