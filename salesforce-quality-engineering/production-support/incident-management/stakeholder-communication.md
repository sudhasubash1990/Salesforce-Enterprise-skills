...
tags: [production-support, sprint-9, incident-management]
keywords: [stakeholder-communication, production-support, operational-excellence]
---
...
Provide enterprise guidance on Stakeholder Communication for Salesforce production operations.
## Business Context
...
- Map Stakeholder Communication into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Stakeholder Communication activities with clear owners and timeboxes
...
- How do you apply Stakeholder Communication on an enterprise Salesforce program?
...
- **Previous:** [Business Impact Assessment](business-impact-assessment.md)
- **Next:** [Knowledge Capture](knowledge-capture.md)
