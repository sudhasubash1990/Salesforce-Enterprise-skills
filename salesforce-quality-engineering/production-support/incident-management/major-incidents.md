...
keywords: [major-incidents, production-support, operational-excellence]
---
...
Provide enterprise guidance on Major Incidents for Salesforce production operations.
## Business Context
...
- Map Major Incidents into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Major Incidents activities with clear owners and timeboxes
...
- How do you apply Major Incidents on an enterprise Salesforce program?
...
- **Previous:** [Priority Matrix](priority-matrix.md)
- **Next:** [Incident Escalation](incident-escalation.md)
