...
keywords: [incident-resolution, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Resolution for Salesforce production operations.
## Business Context
...
- Map Incident Resolution into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Resolution activities with clear owners and timeboxes
...
- How do you apply Incident Resolution on an enterprise Salesforce program?
...
- **Previous:** [Incident Communication](incident-communication.md)
- **Next:** [Incident Closure](incident-closure.md)
