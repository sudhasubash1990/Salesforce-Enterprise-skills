...
keywords: [incident-lifecycle, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Lifecycle for Salesforce production operations.
## Business Context
...
- Map Incident Lifecycle into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Lifecycle activities with clear owners and timeboxes
...
- How do you apply Incident Lifecycle on an enterprise Salesforce program?
...
- **Next:** [Incident Classification](incident-classification.md)
