...
keywords: [business-impact-assessment, production-support, operational-excellence]
---
...
Provide enterprise guidance on Business Impact Assessment for Salesforce production operations.
## Business Context
...
- Map Business Impact Assessment into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Business Impact Assessment activities with clear owners and timeboxes
...
- How do you apply Business Impact Assessment on an enterprise Salesforce program?
...
- **Previous:** [SLA Management](sla-management.md)
- **Next:** [Stakeholder Communication](stakeholder-communication.md)
