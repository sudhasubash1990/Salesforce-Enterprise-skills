...
keywords: [knowledge-capture, production-support, operational-excellence]
---
...
Provide enterprise guidance on Knowledge Capture for Salesforce production operations.
## Business Context
...
- Map Knowledge Capture into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Knowledge Capture activities with clear owners and timeboxes
...
- How do you apply Knowledge Capture on an enterprise Salesforce program?
...
- **Previous:** [Stakeholder Communication](stakeholder-communication.md)
- **Next:** [Post-Incident Review](post-incident-review.md)
