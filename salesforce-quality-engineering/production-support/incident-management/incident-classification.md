...
keywords: [incident-classification, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Classification for Salesforce production operations.
## Business Context
...
- Map Incident Classification into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Classification activities with clear owners and timeboxes
...
- How do you apply Incident Classification on an enterprise Salesforce program?
...
- **Previous:** [Incident Lifecycle](incident-lifecycle.md)
- **Next:** [Severity Matrix](severity-matrix.md)
