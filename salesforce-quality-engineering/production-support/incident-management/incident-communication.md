...
keywords: [incident-communication, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Communication for Salesforce production operations.
## Business Context
...
- Map Incident Communication into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Communication activities with clear owners and timeboxes
...
- How do you apply Incident Communication on an enterprise Salesforce program?
...
- **Previous:** [Incident Escalation](incident-escalation.md)
- **Next:** [Incident Resolution](incident-resolution.md)
