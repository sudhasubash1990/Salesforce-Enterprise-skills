---
title: Runbook — Validation Rule Failure
...
# Runbook — Validation Rule Failure

## Purpose

Operational runbook: Validation rule failure.

## Trigger

- Event matching: Validation rule failure
...
- **Previous:** [Flow Failure](flow-failure.md)
- **Next:** [Data Load Failure](data-load-failure.md)
