...
Operational runbook: API failure.

## Trigger

- Event matching: API failure
...
- **Previous:** [Batch Failure](batch-failure.md)
- **Next:** [Permission Issue](permission-issue.md)
