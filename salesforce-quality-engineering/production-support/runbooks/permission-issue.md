---
title: Runbook — Permission Issue
...
# Runbook — Permission Issue

## Purpose

Operational runbook: Permission issue.

## Trigger

- Event matching: Permission issue
...
- **Previous:** [API Failure](api-failure.md)
- **Next:** [Flow Failure](flow-failure.md)
