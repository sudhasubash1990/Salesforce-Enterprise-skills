...
# Runbook — Flow Failure

## Purpose

Operational runbook: Flow failure.

## Trigger

- Event matching: Flow failure
...
- **Previous:** [Permission Issue](permission-issue.md)
- **Next:** [Validation Rule Failure](validation-rule-failure.md)
