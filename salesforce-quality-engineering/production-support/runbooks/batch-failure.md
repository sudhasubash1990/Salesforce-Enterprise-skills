...
Operational runbook: Batch failure.

## Trigger

- Event matching: Batch failure
...
- **Previous:** [Integration Failure](integration-failure.md)
- **Next:** [API Failure](api-failure.md)
