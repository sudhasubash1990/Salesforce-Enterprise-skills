...
Operational runbook: Rollback execution.

## Trigger

- Event matching: Rollback execution
...
- **Previous:** [Environment Failure](environment-failure.md)
- **Next:** [Business Communication](business-communication.md)
