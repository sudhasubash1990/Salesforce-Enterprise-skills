...
# Runbook — Major Incident

## Purpose

Operational runbook: Major incident response.

## Trigger

- Event matching: Major incident response
...
- **Next:** [Integration Failure](integration-failure.md)
