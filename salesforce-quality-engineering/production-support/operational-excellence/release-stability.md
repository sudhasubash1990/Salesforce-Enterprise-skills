...
keywords: [release-stability, production-support, operational-excellence]
---
...
Provide enterprise guidance on Release Stability for Salesforce production operations.
## Business Context
...
- Map Release Stability into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Release Stability activities with clear owners and timeboxes
...
- How do you apply Release Stability on an enterprise Salesforce program?
...
- **Previous:** [Incident Trends](incident-trends.md)
- **Next:** [Production Stability](production-stability.md)
