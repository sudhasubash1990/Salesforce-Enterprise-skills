...
tags: [production-support, sprint-9, operational-excellence]
keywords: [support-health-checks, production-support, operational-excellence]
---
...
Provide enterprise guidance on Support Health Checks for Salesforce production operations.
## Business Context
...
- Map Support Health Checks into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Support Health Checks activities with clear owners and timeboxes
...
- How do you apply Support Health Checks on an enterprise Salesforce program?
...
- **Previous:** [Governance Reviews](governance-reviews.md)
- **Next:** [Audit Readiness](audit-readiness.md)
