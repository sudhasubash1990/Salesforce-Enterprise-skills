...
keywords: [operational-kpis, production-support, operational-excellence]
---
...
Provide enterprise guidance on Operational Kpis for Salesforce production operations.
## Business Context
...
- Map Operational Kpis into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Operational Kpis activities with clear owners and timeboxes
...
- How do you apply Operational Kpis on an enterprise Salesforce program?
...
- **Next:** [Support Metrics](support-metrics.md)
