...
keywords: [incident-trends, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incident Trends for Salesforce production operations.
## Business Context
...
- Map Incident Trends into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incident Trends activities with clear owners and timeboxes
...
- How do you apply Incident Trends on an enterprise Salesforce program?
...
- **Previous:** [Support Metrics](support-metrics.md)
- **Next:** [Release Stability](release-stability.md)
