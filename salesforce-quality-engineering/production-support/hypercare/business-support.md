...
keywords: [business-support, production-support, operational-excellence]
---
...
Provide enterprise guidance on Business Support for Salesforce production operations.
## Business Context
...
- Map Business Support into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Business Support activities with clear owners and timeboxes
...
- How do you apply Business Support on an enterprise Salesforce program?
...
- **Previous:** [Issue Tracking](issue-tracking.md)
