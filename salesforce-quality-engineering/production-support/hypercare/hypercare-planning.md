...
keywords: [hypercare-planning, production-support, operational-excellence]
---
...
Provide enterprise guidance on Hypercare Planning for Salesforce production operations.
## Business Context
...
- Map Hypercare Planning into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Hypercare Planning activities with clear owners and timeboxes
...
- How do you apply Hypercare Planning on an enterprise Salesforce program?
...
- **Next:** [Hypercare Team](hypercare-team.md)
