...
keywords: [hypercare-team, production-support, operational-excellence]
---
...
Provide enterprise guidance on Hypercare Team for Salesforce production operations.
## Business Context
...
- Map Hypercare Team into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Hypercare Team activities with clear owners and timeboxes
...
- How do you apply Hypercare Team on an enterprise Salesforce program?
...
- **Previous:** [Hypercare Planning](hypercare-planning.md)
- **Next:** [Hypercare Activities](hypercare-activities.md)
