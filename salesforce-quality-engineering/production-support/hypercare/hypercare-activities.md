...
tags: [production-support, sprint-9, hypercare]
keywords: [hypercare-activities, production-support, operational-excellence]
---
...
Provide enterprise guidance on Hypercare Activities for Salesforce production operations.
## Business Context
...
- Map Hypercare Activities into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Hypercare Activities activities with clear owners and timeboxes
...
- How do you apply Hypercare Activities on an enterprise Salesforce program?
...
- **Previous:** [Hypercare Team](hypercare-team.md)
- **Next:** [Issue Tracking](issue-tracking.md)
