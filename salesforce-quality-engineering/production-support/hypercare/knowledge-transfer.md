...
keywords: [knowledge-transfer, production-support, operational-excellence]
---
...
Provide enterprise guidance on Knowledge Transfer for Salesforce production operations.
## Business Context
...
- Map Knowledge Transfer into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Knowledge Transfer activities with clear owners and timeboxes
...
- How do you apply Knowledge Transfer on an enterprise Salesforce program?
...
- **Previous:** [Exit Criteria](exit-criteria.md)
