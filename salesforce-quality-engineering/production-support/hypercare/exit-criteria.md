...
keywords: [exit-criteria, production-support, operational-excellence]
---
...
Provide enterprise guidance on Exit Criteria for Salesforce production operations.
## Business Context
...
- Map Exit Criteria into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Exit Criteria activities with clear owners and timeboxes
...
- How do you apply Exit Criteria on an enterprise Salesforce program?
...
- **Previous:** [Lessons Learned](lessons-learned.md)
- **Next:** [Knowledge Transfer](knowledge-transfer.md)
