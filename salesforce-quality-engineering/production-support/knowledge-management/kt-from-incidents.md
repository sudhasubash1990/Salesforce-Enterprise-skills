...
keywords: [kt-from-incidents, production-support, operational-excellence]
---
...
Provide enterprise guidance on Kt From Incidents for Salesforce production operations.
## Business Context
...
- Map Kt From Incidents into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Kt From Incidents activities with clear owners and timeboxes
...
- How do you apply Kt From Incidents on an enterprise Salesforce program?
...
- **Previous:** [Ownership And Review](ownership-and-review.md)
