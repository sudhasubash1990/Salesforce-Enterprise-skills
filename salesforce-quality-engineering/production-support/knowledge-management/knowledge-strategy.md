...
keywords: [knowledge-strategy, production-support, operational-excellence]
---
...
Provide enterprise guidance on Knowledge Strategy for Salesforce production operations.
## Business Context
...
- Map Knowledge Strategy into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Knowledge Strategy activities with clear owners and timeboxes
...
- How do you apply Knowledge Strategy on an enterprise Salesforce program?
...
- **Next:** [Article Standards](article-standards.md)
