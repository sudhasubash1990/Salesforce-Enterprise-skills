...
keywords: [known-errors, production-support, operational-excellence]
---
...
Provide enterprise guidance on Known Errors for Salesforce production operations.
## Business Context
...
- Map Known Errors into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Known Errors activities with clear owners and timeboxes
...
- How do you apply Known Errors on an enterprise Salesforce program?
...
- **Previous:** [Article Standards](article-standards.md)
- **Next:** [Search And Findability](search-and-findability.md)
