...
keywords: [article-standards, production-support, operational-excellence]
---
...
Provide enterprise guidance on Article Standards for Salesforce production operations.
## Business Context
...
- Map Article Standards into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Article Standards activities with clear owners and timeboxes
...
- How do you apply Article Standards on an enterprise Salesforce program?
...
- **Previous:** [Knowledge Strategy](knowledge-strategy.md)
- **Next:** [Known Errors](known-errors.md)
