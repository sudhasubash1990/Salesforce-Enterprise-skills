...
keywords: [changes, production-support, operational-excellence]
---
...
Provide enterprise guidance on Changes for Salesforce production operations.
## Business Context
...
- Map Changes into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Changes activities with clear owners and timeboxes
...
- How do you apply Changes on an enterprise Salesforce program?
...
- **Next:** [Knowledge Articles](knowledge-articles.md)
