...
keywords: [incidents, production-support, operational-excellence]
---
...
Provide enterprise guidance on Incidents for Salesforce production operations.
## Business Context
...
- Map Incidents into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Incidents activities with clear owners and timeboxes
...
- How do you apply Incidents on an enterprise Salesforce program?
...
- **Previous:** [Service Requests](service-requests.md)
