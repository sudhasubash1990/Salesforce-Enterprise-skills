...
keywords: [knowledge-articles, production-support, operational-excellence]
---
...
Provide enterprise guidance on Knowledge Articles for Salesforce production operations.
## Business Context
...
- Map Knowledge Articles into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Knowledge Articles activities with clear owners and timeboxes
...
- How do you apply Knowledge Articles on an enterprise Salesforce program?
