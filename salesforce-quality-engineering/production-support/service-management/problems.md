...
keywords: [problems, production-support, operational-excellence]
---
...
Provide enterprise guidance on Problems for Salesforce production operations.
## Business Context
...
- Map Problems into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Problems activities with clear owners and timeboxes
...
- How do you apply Problems on an enterprise Salesforce program?
...
- **Previous:** [Incidents](incidents.md)
- **Next:** [Changes](changes.md)
