...
keywords: [sandbox-refresh, production-support, operational-excellence]
---
...
Provide enterprise guidance on Sandbox Refresh for Salesforce production operations.
## Business Context
...
- Map Sandbox Refresh into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Sandbox Refresh activities with clear owners and timeboxes
...
- How do you apply Sandbox Refresh on an enterprise Salesforce program?
...
- **Previous:** [Production](production.md)
- **Next:** [Data Refresh](data-refresh.md)
