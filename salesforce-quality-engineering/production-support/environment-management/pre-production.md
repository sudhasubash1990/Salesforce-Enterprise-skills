...
keywords: [pre-production, production-support, operational-excellence]
---
...
Provide enterprise guidance on Pre Production for Salesforce production operations.
## Business Context
...
- Map Pre Production into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Pre Production activities with clear owners and timeboxes
...
- How do you apply Pre Production on an enterprise Salesforce program?
