...
keywords: [qa, production-support, operational-excellence]
---
...
Provide enterprise guidance on Qa for Salesforce production operations.
## Business Context
...
- Map Qa into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Qa activities with clear owners and timeboxes
...
- How do you apply Qa on an enterprise Salesforce program?
