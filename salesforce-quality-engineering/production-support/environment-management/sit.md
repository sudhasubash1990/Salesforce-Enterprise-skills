...
keywords: [sit, production-support, operational-excellence]
---
...
Provide enterprise guidance on SIT for Salesforce production operations.
## Business Context
...
- Map SIT into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute SIT activities with clear owners and timeboxes
...
- How do you apply SIT on an enterprise Salesforce program?
