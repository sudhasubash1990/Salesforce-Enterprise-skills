...
keywords: [uat, production-support, operational-excellence]
---
...
Provide enterprise guidance on UAT for Salesforce production operations.
## Business Context
...
- Map UAT into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute UAT activities with clear owners and timeboxes
...
- How do you apply UAT on an enterprise Salesforce program?
...
- **Previous:** [SIT](sit.md)
- **Next:** [Pre Production](pre-production.md)
