...
keywords: [configuration-drift, production-support, operational-excellence]
---
...
Provide enterprise guidance on Configuration Drift for Salesforce production operations.
## Business Context
...
- Map Configuration Drift into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Configuration Drift activities with clear owners and timeboxes
...
- How do you apply Configuration Drift on an enterprise Salesforce program?
...
- **Previous:** [Data Refresh](data-refresh.md)
- **Next:** [Environment Comparison](environment-comparison.md)
