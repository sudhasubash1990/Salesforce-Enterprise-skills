...
keywords: [environment-comparison, production-support, operational-excellence]
---
...
Provide enterprise guidance on Environment Comparison for Salesforce production operations.
## Business Context
...
- Map Environment Comparison into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Environment Comparison activities with clear owners and timeboxes
...
- How do you apply Environment Comparison on an enterprise Salesforce program?
...
- **Previous:** [Configuration Drift](configuration-drift.md)
- **Next:** [Deployment Coordination](deployment-coordination.md)
