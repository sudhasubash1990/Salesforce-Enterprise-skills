...
keywords: [business-validation, production-support, operational-excellence]
---
...
Provide enterprise guidance on Business Validation for Salesforce production operations.
## Business Context
...
- Map Business Validation into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Business Validation activities with clear owners and timeboxes
...
- How do you apply Business Validation on an enterprise Salesforce program?
...
- **Previous:** [Deployment Validation](deployment-validation.md)
- **Next:** [Technical Validation](technical-validation.md)
