...
keywords: [go-live-readiness, production-support, operational-excellence]
---
...
Provide enterprise guidance on Go Live Readiness for Salesforce production operations.
## Business Context
...
- Map Go Live Readiness into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Go Live Readiness activities with clear owners and timeboxes
...
- How do you apply Go Live Readiness on an enterprise Salesforce program?
...
- **Next:** [Go Live Checklist](go-live-checklist.md)
