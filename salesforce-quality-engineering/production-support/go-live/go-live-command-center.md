...
keywords: [go-live-command-center, production-support, operational-excellence]
---
...
Provide enterprise guidance on Go Live Command Center for Salesforce production operations.
## Business Context
...
- Map Go Live Command Center into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Go Live Command Center activities with clear owners and timeboxes
...
- How do you apply Go Live Command Center on an enterprise Salesforce program?
...
- **Previous:** [Go Live Checklist](go-live-checklist.md)
- **Next:** [Deployment Validation](deployment-validation.md)
