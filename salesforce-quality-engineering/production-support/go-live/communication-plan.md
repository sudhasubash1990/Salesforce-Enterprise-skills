...
keywords: [communication-plan, production-support, operational-excellence]
---
...
Provide enterprise guidance on Communication Plan for Salesforce production operations.
## Business Context
...
- Map Communication Plan into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute Communication Plan activities with clear owners and timeboxes
...
- How do you apply Communication Plan on an enterprise Salesforce program?
...
- **Previous:** [Support Readiness](support-readiness.md)
- **Next:** [Go/No-Go Meeting](go-no-go-meeting.md)
