...
keywords: [war-room-management, production-support, operational-excellence]
---
...
Provide enterprise guidance on War Room Management for Salesforce production operations.
## Business Context
...
- Map War Room Management into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Plan and execute War Room Management activities with clear owners and timeboxes
...
- How do you apply War Room Management on an enterprise Salesforce program?
...
- **Previous:** [Go/No-Go Meeting](go-no-go-meeting.md)
- **Next:** [Success Criteria](success-criteria.md)
