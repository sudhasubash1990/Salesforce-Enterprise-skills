...
tags: [production-support, sprint-9, go-live]
keywords: [go-live-checklist, production-support, operational-excellence]
---
...
Provide a structured go-live checklist covering tech, data, business, support, and rollback.
## Business Context
...
- Map Go Live Checklist into the broader incident–problem–change–release value stream where relevant.
## Roles
...
- Completed checklist with owners
- Open risks and Go/No-Go recommendation
## Activities

- Plan and execute Go Live Checklist activities with clear owners and timeboxes
...
- How do you apply Go Live Checklist on an enterprise Salesforce program?
...
- **Previous:** [Go Live Readiness](go-live-readiness.md)
- **Next:** [Go Live Command Center](go-live-command-center.md)
